...
export const ExperienceCard = () => (<div className="w-full border border-gray-200 p-60 rounded-xl mx-2 max-w-2xl">
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-xl font-semibold ml-0 mt-4">
        Your Card Title
    </p>
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-900 font-semibold text-sm ml-3">Frontend Radio</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-start w-full gap-2 pb-21">
...
export const EmailAndPasswordLoginForm = () => (<main className="flex items-center justify-center w-full px-4">
    <form className="flex w-full flex-col max-w-96">
        ...
        <p className="me-4 text-base text-gray-500/90">
...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-1 px-6">
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-sm max-w-md w-full">
        ...
        <input type="email"
               ...
               required/>
        <button
            className="shrink-0 mr-2 px-6 pr-3 text-sm bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-md active:scale-95 transition duration-300 text-white">
            Subscribe now
        </button>
    </form>
</section>)
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <div className="flex items-center gap-4 mt-6">
        ...
        <a href="#"
           className="border border-gray-300 px-7 py-0 text-gray-800 rounded-md active:scale-95 transition-all">
            Contact support
        </a>
    </div>
</div>)
...
export const TextOnlyTweetCard = () => (<div
    className="max-w-lg w-full bg-white border border-gray-200 rounded-xl p-24 shadow-sm hover:shadow-md transition-shadow duration-200">
...
export const Testimonial = () => (<div
    ...
    <a className="mx-8 md:mb-12" href="https://prebuiltui.com">
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
        ...
        <input min={1} max={4} id="guests" type="number"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-12 text-sm outline-none  max-w-16"
               placeholder="0"/>
    </div>
    ...
    <div><h1 className="text-3xl font-semibold text-center mx-auto">About our apps</h1>
        ...
        <div
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mr-6">
...
export const PrivacyFirstNotice = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4 w-full">
        <button type="button"
                className="font-medium px-8 border border-gray-500/30 py-18 rounded hover:bg-blue-500/10 active:scale-95 transition">Decline
        </button>
        <button type="button"
...
export const Notification = () => (<div
    ...
    <div className="py-25 flex justify-center flex-col pr-3">
...
export const ReceiptCard = () => (<div
    ...
    <div className="flex flex-col items-center gap-2 w-full p-4 pb-20 rounded-b-lg bg-white border-t border-gray-500/20">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-36">
    <div
...
export const SmallCtaBanner = () => (<div
    ...
    <button className="px-12 px-3 text-slate-800 bg-white rounded-full text-sm mt-4">
        Get Started
    </button>
</div>)
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        <div className="pr-6 aspect-square bg-green-100 rounded-full">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
