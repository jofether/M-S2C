    ...
    {[{
        ...
        <ul className="flex flex-col gap-2 text-sm w-full">
            {tier.features.map((f) => (<li key={f} className={`flex items-center gap-2 ${tier.featureClass}`}>
                <span className={`${tier.checkClass} block-shrink-0`}>✓</span>
...
export const TeamMemberGallery = () => (<div
    className="flex grid-cols-3 gap-6 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const MultiStepProcess = () => (<div
    className="flex block-col gap-6 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const UserBioHeader = () => (<div
    ...
    <div className="flex flex-col gap-1 flex-1 overflow-hidden">
        <div className="block flex-row items-center gap-2">
...
export const SocialFeedItem = () => (<div
    className="flex flex-col gap-16 p-5 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-3 row-span-1 flex flex-col gap-16 p-3 bg-green-50 rounded-lg border-l-4 border-green-500">
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center">
        {[{initials: "AC", bg: "bg-pink-400"}, {initials: "BK", bg: "bg-blue-400"}, {
            ...
            className={`block items-center justify-center w-10 h-10 ${a.bg} rounded-full text-white text-xs font-bold border-2 border-white flex-shrink-0`}
        >
            {a.initials}
        </div>))}
        <div
