...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        <ul className="flex flex-col gap-2 text-sm w-full">
            {tier.features.map((f) => (<li key={f} className={`flex items-center gap-16 ${tier.featureClass}`}>
...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        <div className="block flex-col items-center gap-1 w-full overflow-hidden">
...
export const HorizontalMetricBar = () => (<div
    className="flex flex-row items-center justify-evenly gap-0 p-8 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl">
...
export const DashboardStatCards = () => (<div
    className="grid flex-cols-4 gap-6 p-8 bg-gray-50 border border-gray-100 rounded-2xl">
    {[{
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="flex flex-col gap-4 p-6 bg-blue-600 border border-blue-500 rounded-xl shadow-sm">
        ...
        <div className="flex flex-row items-center gap-3">
            <div
                className="block items-center justify-center w-9 h-9 bg-blue-500 rounded-full text-sm font-bold text-white flex-shrink-0">JL
            </div>
            <div className="flex flex-col gap-0.5 overflow-hidden">
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex flex-wrap gap-16 pt-3 border-t border-gray-100">
...
export const UserBioHeader = () => (<div
    ...
    <div
        className="block-shrink-0 flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full text-white text-2xl font-bold select-none">
        AJ
    </div>
...
export const CompactSchedule = () => (<div
    ...
    <div className="col-span-3 row-span-full flex flex-col gap-1 p-3 bg-blue-50 rounded-lg border-l-4 border-blue-500">
...
export const EmptyStateHero = () => (<div
    className="block flex-col items-center justify-center gap-5 p-16 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
