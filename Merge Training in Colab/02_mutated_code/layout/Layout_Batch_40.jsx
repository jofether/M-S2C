...
export const TestimonialMasonry = () => (<div
    ...
    <div className="col-span-2 flex flex-col gap-0 p-6 bg-gray-900 border border-gray-800 rounded-xl shadow-sm">
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex flex-wrap gap-0 pt-3 border-t border-gray-100">
