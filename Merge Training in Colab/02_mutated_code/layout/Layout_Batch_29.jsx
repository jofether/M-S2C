...
export const ContactFormTwoCol = () => (<div
    className="grid grid-cols-2 gap-x-16 gap-y-4 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const DashboardStatCards = () => (<div
    className="grid grid-cols-4 gap-16 p-8 bg-gray-50 border border-gray-100 rounded-2xl">
    {[{
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="col-span-2 flex block-col gap-4 p-6 bg-gray-900 border border-gray-800 rounded-xl shadow-sm">
...
export const UserBioHeader = () => (<div
    ...
    <div className="flex flex-col gap-1 flex-1 overflow-hidden">
        ...
        <div className="block flex-row items-center gap-4 pt-1">
...
export const FooterLinkDirectory = () => (<div
    className="grid flex-cols-4 gap-x-8 gap-y-2 p-8 bg-gray-900 border border-gray-800 rounded-2xl">
...
export const CompactSchedule = () => (<div
    ...
    <div className="col-span-1 flex flex-row items-center justify-between pb-2 border-b border-gray-100">
