...
export const FeatureGridFour = () => (<div
    ...
    {[{
        ...
        desc: "Simple YAML or JSON-based configuration."
                         ...
                         className="block flex-col items-start gap-3 p-6 bg-gray-50 border border-gray-100 rounded-xl shadow-sm">
...
export const TeamMemberGallery = () => (<div
    ...
    <div className="col-span-1 flex flex-row items-center justify-between pb-4 border-b border-gray-100">
...
export const ProductFilterSidebar = () => (<div
    ...
    <div className="flex block-row items-center justify-between">
...
export const DashboardStatCards = () => (<div
    ...
    {[{
        ...
        <div key={card.title}
            ...
            <div className="block flex-row items-center justify-between gap-2">
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="col-span-1 flex flex-col gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex flex-row items-center gap-4">
            ...
            <button
                className="block flex-row items-center gap-1 text-xs text-gray-400 hover:text-blue-500 whitespace-nowrap">
                Comment 31
            </button>
            <button
