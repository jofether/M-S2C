...
export const ContactFormTwoCol = () => (<div
    ...
    <div className="col-span-2 flex block-row items-center justify-end gap-3">
        <button
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="flex flex-col gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
        ...
        <div className="flex flex-row items-center gap-3">
            <div
                className="flex items-stretch justify-center w-9 h-9 bg-green-100 rounded-full text-sm font-bold text-green-700 flex-shrink-0">SP
            </div>
            <div className="flex flex-col gap-0.5 overflow-hidden">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4">
        <div className="flex flex-row items-stretch gap-3 overflow-hidden">
            <div
