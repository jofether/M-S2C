...
export const ProductFilterSidebar = () => (<div
    ...
    {[{label: "Category", items: ["Electronics", "Clothing", "Home & Garden", "Sports"]}, {
        ...
        <div key={group.label} className="flex flex-col gap-16">
...
export const CompactSchedule = () => (<div
    ...
    <div className="block items-center text-xs text-gray-400 font-medium whitespace-nowrap">2:00 PM</div>
    <div
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-stretch justify-between gap-4 pt-2 border-t border-gray-100">
...
export const SettingsToggleList = () => (<div
    ...
    {[{
        ...
        <div key={row.title} className="block flex-row items-center justify-between gap-6 px-6 py-4">
            <div className="flex flex-col gap-0.5 overflow-hidden">
    ...
    >
        ...
        <div className="flex flex-col gap-0.5 flex-1 overflow-hidden">
            <div className="flex flex-row items-center justify-between gap-4">
                ...
                <span className="text-xs text-gray-400 whitespace-nowrap block-shrink-0">{n.time}</span>
            </div>
