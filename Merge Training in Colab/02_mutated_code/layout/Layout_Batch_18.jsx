...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        <div className="flex block-col items-center gap-1 w-full overflow-hidden">
...
export const DashboardStatCards = () => (<div
    className="grid grid-cols-4 gap-0 p-8 bg-gray-50 border border-gray-100 rounded-2xl">
    {[{
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex flex-wrap gap-2">
        {["Free Shipping", "In Stock", "On Sale", "4 Stars Up", "Under $50", "Brand: Nike", "Size: M", "Color: Black", "New Arrivals"].map((tag) => (
            <span key={tag}
                  className="flex flex-row items-stretch gap-1 px-3 py-1 bg-blue-50 text-blue-700 text-xs font-medium rounded-full border border-blue-200 whitespace-nowrap">
          {tag}
...
export const CompactSchedule = () => (<div
    ...
    <div className="col-span-3 row-span-1 flex flex-col gap-16 p-3 bg-blue-50 rounded-lg border-l-4 border-blue-500">
