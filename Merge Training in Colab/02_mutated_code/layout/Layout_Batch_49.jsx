...
export const FeatureGridFour = () => (<div
    className="flex grid-cols-2 gap-6 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
    {[{
        icon: "⚡",
        color: "bg-blue-100",
        text: "text-blue-600",
...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        checkClass: "text-green-500",
                            ...
                            className={`flex flex-col items-center gap-4 p-6 ${tier.cardClass} rounded-xl shadow-sm block-1`}>
                <span
...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        name: "Felix Wang", role: "Data Scientist", color: "bg-orange-100", text: "text-orange-700", initials: "FW"
                         ...
                         className="block flex-col items-center gap-3 p-5 bg-gray-50 border border-gray-100 rounded-xl shadow-sm">
        <div
...
export const HorizontalMetricBar = () => (<div
    ...
    },].map((stat) => (<div key={stat.label} className="flex block-col items-center gap-1">
...
export const ContactFormTwoCol = () => (<div
    className="grid grid-cols-2 gap-x-0 gap-y-4 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="flex block-col gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
...
export const EcommerceFilters = () => (<div
    className="flex block-col gap-5 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const UserBioHeader = () => (<div
    ...
    <div className="flex flex-col gap-1 block-1 overflow-hidden">
...
export const StatHeaderGroup = () => (<div
    className="block flex-row items-baseline justify-between gap-8 max-w-3xl p-4 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm">
...
export const FooterLinkDirectory = () => (<div
    ...
    },].map((col) => (<div key={col.heading} className="flex flex-col gap-0">
...
export const CompactSchedule = () => (<div
    ...
    <div className="block items-center text-xs text-gray-400 font-medium whitespace-nowrap">11:00 AM</div>
    <div
...
export const EmptyStateHero = () => (<div
    ...
    <div
        className="flex items-center justify-center w-20 h-20 bg-gray-100 rounded-full text-4xl select-none block-shrink-0">
        X
    </div>
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center justify-start gap-4 pt-2 border-t border-gray-100">
...
export const SettingsToggleList = () => (<div
    className="flex block-col gap-0 bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden divide-y divide-gray-100">
    {[{
...
export const NotificationCenter = () => (<div
    className="flex flex-col gap-16 bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden divide-y divide-gray-100">
