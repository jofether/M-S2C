...
export const TeamMemberGallery = () => (<div
    ...
    <div className="col-span-3 block flex-row items-center justify-between pb-4 border-b border-gray-100">
...
export const MultiStepProcess = () => (<div
    ...
    <div className="flex flex-row items-start justify-between gap-2">
        {[{step: "1", title: "Create Account", desc: "Sign up for free"}, {
            ...
            {idx < arr.length - 1 && (<div className="block-shrink-0 w-10 h-px bg-gray-300 self-start mt-5"/>)}
        </React.Fragment>))}
    </div>
</div>)
...
export const ProductFilterSidebar = () => (<div
    ...
    {[{label: "Category", items: ["Electronics", "Clothing", "Home & Garden", "Sports"]}, {
        ...
        <div key={group.label} className="block flex-col gap-3">
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="col-span-2 flex flex-col gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
        ...
        <div className="flex flex-row items-center gap-3">
            <div
                className="block items-center justify-center w-9 h-9 bg-blue-100 rounded-full text-sm font-bold text-blue-700 flex-shrink-0">MR
            </div>
...
export const UserBioHeader = () => (<div
    ...
    <div className="flex flex-col gap-1 flex-1 overflow-hidden">
        <div className="flex flex-row items-center gap-2">
            ...
            <span
                className="px-2 py-0.5 bg-green-100 text-green-700 text-xs font-semibold rounded-full whitespace-nowrap block-shrink-0">Pro</span>
        </div>
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4">
        <div className="flex flex-row items-center gap-3 overflow-hidden">
            <div
                className="flex items-center justify-between w-10 h-10 bg-orange-100 rounded-full font-bold text-orange-700 text-sm flex-shrink-0">
                PK
            </div>
            <div className="flex flex-col gap-0.5 overflow-hidden">
...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-3 row-span-full flex flex-col gap-1 p-3 bg-green-50 rounded-lg border-l-4 border-green-500">
...
export const EmptyStateHero = () => (<div
    className="flex flex-col items-center justify-center gap-0 p-16 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
