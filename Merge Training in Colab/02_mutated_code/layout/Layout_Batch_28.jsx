...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        <ul className="block flex-col gap-2 text-sm w-full">
...
export const TeamMemberGallery = () => (<div
    ...
    <div className="col-span-3 flex block-row items-center justify-between pb-4 border-b border-gray-100">
...
export const HorizontalMetricBar = () => (<div
    ...
    },].map((stat) => (<div key={stat.label} className="block flex-col items-center gap-1">
    ...
    <div className="flex flex-row items-start justify-between gap-2">
        {[{step: "1", title: "Create Account", desc: "Sign up for free"}, {
            ...
            <div className="flex flex-col items-center gap-2 flex-1">
                <div
                    className="flex items-center justify-center w-10 h-10 bg-blue-600 text-white rounded-full font-bold text-sm block-shrink-0">
                    {item.step}
                </div>
                <span
...
export const ContactFormTwoCol = () => (<div
    ...
    <div className="col-span-2 flex block-col gap-1">
...
export const UserBioHeader = () => (<div
    ...
    <div className="flex flex-col gap-1 flex-1 overflow-hidden">
        ...
        <div className="flex flex-row items-center gap-16 pt-1">
...
export const StatHeaderGroup = () => (<div
    className="flex block-row items-baseline justify-between gap-8 max-w-3xl p-4 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex flex-row items-center gap-4">
            <button
                className="flex flex-row items-stretch gap-1 text-xs text-gray-400 hover:text-red-500 whitespace-nowrap">
                Like 124
            </button>
            <button
...
export const CompactSchedule = () => (<div
    ...
    <div className="col-span-3 row-span-1 flex flex-col gap-0 p-3 bg-blue-50 rounded-lg border-l-4 border-blue-500">
...
export const BreadcrumbTrail = () => (<div
    className="block flex-row items-baseline gap-0 px-6 py-3 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const EmptyStateHero = () => (<div
    className="flex flex-col items-stretch justify-center gap-5 p-16 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center">
        ...
        <div
            ...
            className="flex items-stretch justify-center w-10 h-10 bg-gray-100 rounded-full text-xs font-semibold text-gray-500 border-2 border-white flex-shrink-0"
        >
            +7
        </div>
    </div>
...
export const NotificationCenter = () => (<div
    ...
    <div className="flex flex-row items-center justify-start px-5 py-3 bg-white">
