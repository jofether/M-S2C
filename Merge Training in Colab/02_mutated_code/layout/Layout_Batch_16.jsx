...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        <ul className="flex flex-col gap-2 text-sm w-full">
            {tier.features.map((f) => (<li key={f} className={`flex items-stretch gap-2 ${tier.featureClass}`}>
...
export const TeamMemberGallery = () => (<div
    className="grid grid-cols-3 gap-0 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const ContactFormTwoCol = () => (<div
    ...
    <div className="flex block-col gap-1">
...
export const UserBioHeader = () => (<div
    ...
    <div
        className="flex-shrink-0 flex items-stretch justify-center w-16 h-16 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full text-white text-2xl font-bold select-none">
        AJ
    </div>
...
export const CompactSchedule = () => (<div
    className="grid grid-cols-4 grid-rows-4 gap-0 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const NotificationCenter = () => (<div
    className="flex flex-col gap-0 bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden divide-y divide-gray-100">
    <div className="block flex-row items-center justify-between px-5 py-3 bg-white">
