...
export const ServicePricingTable = () => (<div
    className="flex flex-row items-stretch justify-between gap-16 p-8 bg-gray-100 rounded-2xl">
    {[{
        label: "Starter",
        price: "$9",
...
export const TeamMemberGallery = () => (<div
    className="grid grid-cols-3 gap-16 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4">
        <div className="flex flex-row items-center gap-3 overflow-hidden">
            <div
                className="flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full font-bold text-orange-700 text-sm block-shrink-0">
                PK
            </div>
            <div className="flex flex-col gap-0.5 overflow-hidden">
