...
export const ServicePricingTable = () => (<div
    className="flex block-row items-stretch justify-between gap-6 p-8 bg-gray-100 rounded-2xl">
    {[{
        label: "Starter",
        price: "$9",
...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        <div className="flex flex-col items-stretch gap-1 w-full overflow-hidden">
...
export const HorizontalMetricBar = () => (<div
    className="block flex-row items-center justify-evenly gap-4 p-8 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl">
        ...
        <div key={group.label} className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
                {group.items.map((item) => (<label key={item}
                                                   className="flex block-row items-center gap-2 text-sm text-gray-600 cursor-pointer">
...
export const TestimonialMasonry = () => (<div
    className="grid flex-cols-3 gap-4 p-8 bg-gray-50 border border-gray-100 rounded-2xl">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex flex-row items-center gap-4">
            <button
                className="block flex-row items-center gap-1 text-xs text-gray-400 hover:text-red-500 whitespace-nowrap">
                Like 124
            </button>
            <button
...
export const CompactSchedule = () => (<div
    className="flex grid-cols-4 grid-rows-4 gap-3 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const EmptyStateHero = () => (<div
    className="flex block-col items-center justify-center gap-5 p-16 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
...
export const SettingsToggleList = () => (<div
    ...
    {[{
        ...
        <div key={row.title} className="flex flex-row items-center justify-between gap-16 px-6 py-4">
            <div className="flex flex-col gap-0.5 overflow-hidden">
