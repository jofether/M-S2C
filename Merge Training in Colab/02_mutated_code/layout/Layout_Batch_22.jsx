...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-3 row-span-1 flex flex-col gap-0 p-3 bg-green-50 rounded-lg border-l-4 border-green-500">
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4 pt-2 border-t border-gray-100">
        ...
        <button className="flex flex-row items-center gap-0 text-xs text-blue-600 font-medium whitespace-nowrap">
            + Invite
        </button>
    </div>
</div>)
