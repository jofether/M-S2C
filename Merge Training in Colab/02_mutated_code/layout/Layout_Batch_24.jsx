...
export const TestimonialMasonry = () => (<div
    ...
    <div className="col-span-2 flex flex-col gap-16 p-6 bg-gray-900 border border-gray-800 rounded-xl shadow-sm">
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex flex-wrap gap-2">
        {["Free Shipping", "In Stock", "On Sale", "4 Stars Up", "Under $50", "Brand: Nike", "Size: M", "Color: Black", "New Arrivals"].map((tag) => (
          ...
          {tag}
                <button className="text-blue-400 hover:text-blue-700 font-bold ml-1 block-shrink-0">x</button>
        </span>))}
    </div>
...
export const CompactSchedule = () => (<div
    ...
    <div className="col-span-4 flex flex-row items-center justify-start pb-2 border-b border-gray-100">
