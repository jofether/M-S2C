...
export const TestimonialMasonry = () => (<div
    ...
    <div className="block flex-col gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
...
export const CompactSchedule = () => (<div
    className="grid flex-cols-4 grid-rows-4 gap-3 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const EmptyStateHero = () => (<div
    className="flex flex-col items-center justify-center gap-16 p-16 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
