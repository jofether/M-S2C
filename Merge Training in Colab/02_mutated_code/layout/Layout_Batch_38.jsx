...
export const TestimonialMasonry = () => (<div
    className="flex grid-cols-3 gap-4 p-8 bg-gray-50 border border-gray-100 rounded-2xl">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex flex-row items-center gap-4">
            ...
            <button
                className="flex block-row items-center gap-1 text-xs text-gray-400 hover:text-blue-500 whitespace-nowrap">
                Comment 31
            </button>
            <button
...
export const CompactSchedule = () => (<div
    ...
    <div className="flex items-stretch text-xs text-gray-400 font-medium whitespace-nowrap">2:00 PM</div>
    <div
