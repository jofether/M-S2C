...
export const ServicePricingTable = () => (<div
    className="flex flex-row items-stretch justify-between gap-0 p-8 bg-gray-100 rounded-2xl">
    {[{
        label: "Starter",
        price: "$9",
...
export const HorizontalMetricBar = () => (<div
    ...
    },].map((stat) => (<div key={stat.label} className="flex flex-col items-center gap-16">
...
export const ContactFormTwoCol = () => (<div
    ...
    <div className="col-span-2 flex flex-row items-center justify-end gap-0">
        <button
...
export const ProductFilterSidebar = () => (<div
    ...
    {[{label: "Category", items: ["Electronics", "Clothing", "Home & Garden", "Sports"]}, {
        ...
        <div key={group.label} className="flex block-col gap-3">
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="col-span-2 flex flex-col gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
        ...
        <div className="flex flex-row items-center gap-3">
            <div
                className="flex items-stretch justify-center w-9 h-9 bg-blue-100 rounded-full text-sm font-bold text-blue-700 flex-shrink-0">MR
            </div>
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex block-wrap gap-2 pt-3 border-t border-gray-100">
...
export const UserBioHeader = () => (<div
    ...
    <div
        className="flex-shrink-0 flex items-center justify-between w-16 h-16 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full text-white text-2xl font-bold select-none">
        AJ
    </div>
...
export const FooterLinkDirectory = () => (<div
    className="grid grid-cols-4 gap-x-0 gap-y-2 p-8 bg-gray-900 border border-gray-800 rounded-2xl">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-col gap-2">
        ...
        <div className="flex block-row items-center gap-2 flex-wrap">
