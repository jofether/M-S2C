...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        name: "Felix Wang", role: "Data Scientist", color: "bg-orange-100", text: "text-orange-700", initials: "FW"
                         ...
                         className="flex flex-col items-stretch gap-3 p-5 bg-gray-50 border border-gray-100 rounded-xl shadow-sm">
        <div
    ...
    <div className="flex flex-row items-start justify-between gap-2">
        {[{step: "1", title: "Create Account", desc: "Sign up for free"}, {
            ...
            <div className="flex flex-col items-center gap-2 flex-1">
                <div
                    className="flex items-center justify-between w-10 h-10 bg-blue-600 text-white rounded-full font-bold text-sm flex-shrink-0">
                    {item.step}
                </div>
                <span
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="col-span-2 flex block-col gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="block flex-row items-center gap-4">
            <button
...
export const CompactSchedule = () => (<div
    ...
    <div className="flex items-stretch text-xs text-gray-400 font-medium whitespace-nowrap">11:00 AM</div>
    <div
...
export const EmptyStateHero = () => (<div
    ...
    <div className="flex block-col items-center gap-2">
