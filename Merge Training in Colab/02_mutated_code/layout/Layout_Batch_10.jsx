...
export const MultiStepProcess = () => (<div
    className="flex flex-col gap-0 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex flex-wrap gap-2">
        {["Free Shipping", "In Stock", "On Sale", "4 Stars Up", "Under $50", "Brand: Nike", "Size: M", "Color: Black", "New Arrivals"].map((tag) => (
            <span key={tag}
                  className="flex flex-row items-center gap-16 px-3 py-1 bg-blue-50 text-blue-700 text-xs font-medium rounded-full border border-blue-200 whitespace-nowrap">
          {tag}
...
export const FooterLinkDirectory = () => (<div
    ...
    },].map((col) => (<div key={col.heading} className="flex flex-col gap-16">
...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-3 row-span-1 block flex-col gap-1 p-3 bg-purple-50 rounded-lg border-l-4 border-purple-500">
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4 pt-2 border-t border-gray-100">
        ...
        <button className="flex flex-row items-stretch gap-1 text-xs text-blue-600 font-medium whitespace-nowrap">
            + Invite
        </button>
    </div>
</div>)
