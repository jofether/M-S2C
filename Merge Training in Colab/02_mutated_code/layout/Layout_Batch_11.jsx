...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        name: "Felix Wang", role: "Data Scientist", color: "bg-orange-100", text: "text-orange-700", initials: "FW"
                         ...
                         className="flex block-col items-center gap-3 p-5 bg-gray-50 border border-gray-100 rounded-xl shadow-sm">
        <div
...
export const UserBioHeader = () => (<div
    ...
    <div className="flex flex-col gap-1 flex-1 overflow-hidden">
        <div className="flex block-row items-center gap-2">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex flex-row items-center gap-4">
            <button
                className="flex flex-row items-center gap-0 text-xs text-gray-400 hover:text-red-500 whitespace-nowrap">
                Like 124
            </button>
            <button
...
export const NotificationCenter = () => (<div
    ...
    >
        ...
        <div className="block flex-col gap-0.5 flex-1 overflow-hidden">
            <div className="flex flex-row items-center justify-between gap-4">
