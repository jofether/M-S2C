...
export const FeatureGridFour = () => (<div
    ...
    {[{
        ...
        <div className={`block items-center justify-center w-10 h-10 ${f.color} rounded-lg flex-shrink-0`}>
...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        <ul className="flex flex-col gap-2 text-sm w-full">
            {tier.features.map((f) => (<li key={f} className={`flex items-center gap-0 ${tier.featureClass}`}>
...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        <div
            className={`flex items-center justify-center w-14 h-14 ${m.color} rounded-full text-lg font-bold ${m.text} block-shrink-0`}>
            {m.initials}
        </div>
    ...
    <div className="flex flex-row items-start justify-between gap-2">
        {[{step: "1", title: "Create Account", desc: "Sign up for free"}, {
            ...
            <div className="flex flex-col items-center gap-2 flex-1">
                <div
                    className="block items-center justify-center w-10 h-10 bg-blue-600 text-white rounded-full font-bold text-sm flex-shrink-0">
                    {item.step}
                </div>
                <span
...
export const ContactFormTwoCol = () => (<div
    ...
    <div className="col-span-2 flex flex-row items-center justify-end gap-16">
        <button
...
export const EcommerceFilters = () => (<div
    className="block flex-col gap-5 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const StatHeaderGroup = () => (<div
    ...
    {[{label: "Total Users", value: "128,400", unit: "accounts"}, {
        ...
        <div key={stat.label} className="flex flex-col items-start gap-0">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4">
        ...
        <button className="text-gray-300 hover:text-gray-500 text-lg block-shrink-0">...</button>
    </div>
    <div className="flex flex-col gap-2">
        <p className="text-sm text-gray-700 leading-relaxed">
...
export const CompactSchedule = () => (<div
    ...
    <div className="block items-center text-xs text-gray-400 font-medium whitespace-nowrap">9:00 AM</div>
...
export const EmptyStateHero = () => (<div
    ...
    <div
        className="block items-center justify-center w-20 h-20 bg-gray-100 rounded-full text-4xl select-none flex-shrink-0">
        X
    </div>
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4 pt-2 border-t border-gray-100">
        ...
        <button className="flex flex-row items-center gap-16 text-xs text-blue-600 font-medium whitespace-nowrap">
            + Invite
        </button>
    </div>
</div>)
...
export const NotificationCenter = () => (<div
    ...
    >
        ...
        <div className="flex flex-col gap-0.5 block-1 overflow-hidden">
            <div className="flex flex-row items-center justify-between gap-4">
