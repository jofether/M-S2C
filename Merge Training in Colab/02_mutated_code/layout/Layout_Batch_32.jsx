...
export const FeatureGridFour = () => (<div
    ...
    {[{
        ...
        <div className={`flex items-center justify-between w-10 h-10 ${f.color} rounded-lg flex-shrink-0`}>
...
export const HorizontalMetricBar = () => (<div
    className="flex flex-row items-stretch justify-evenly gap-4 p-8 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl">
...
export const MultiStepProcess = () => (<div
    className="block flex-col gap-6 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const ContactFormTwoCol = () => (<div
    className="grid flex-cols-2 gap-x-8 gap-y-4 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div key={group.label} className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
                {group.items.map((item) => (<label key={item}
                                                   className="flex flex-row items-center gap-16 text-sm text-gray-600 cursor-pointer">
...
export const DashboardStatCards = () => (<div
    ...
    {[{
        ...
        <div key={card.title}
             className="flex flex-col gap-0 p-5 bg-white border border-gray-100 rounded-xl shadow-sm">
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="flex flex-col gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
        ...
        <div className="flex flex-row items-center gap-3">
            ...
            <div className="flex flex-col gap-16.5 overflow-hidden">
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex block-row items-center justify-between gap-4">
...
export const UserBioHeader = () => (<div
    ...
    <button
        className="block-shrink-0 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg whitespace-nowrap hover:bg-blue-700">
        Follow
    </button>
</div>)
...
export const FooterLinkDirectory = () => (<div
    className="flex grid-cols-4 gap-x-8 gap-y-2 p-8 bg-gray-900 border border-gray-800 rounded-2xl">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4">
        <div className="flex flex-row items-center gap-3 overflow-hidden">
            <div
                className="block items-center justify-center w-10 h-10 bg-orange-100 rounded-full font-bold text-orange-700 text-sm flex-shrink-0">
                PK
            </div>
            <div className="flex flex-col gap-0.5 overflow-hidden">
...
export const EmptyStateHero = () => (<div
    ...
    <div className="flex block-row items-center gap-3">
        <button
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center">
        {[{initials: "AC", bg: "bg-pink-400"}, {initials: "BK", bg: "bg-blue-400"}, {
            ...
            className={`flex items-center justify-between w-10 h-10 ${a.bg} rounded-full text-white text-xs font-bold border-2 border-white flex-shrink-0`}
        >
            {a.initials}
        </div>))}
        <div
...
export const SettingsToggleList = () => (<div
    ...
    {[{
        ...
        <div key={row.title} className="flex flex-row items-center justify-start gap-6 px-6 py-4">
            <div className="flex flex-col gap-0.5 overflow-hidden">
...
export const NotificationCenter = () => (<div
    ...
    >
        ...
        <div className="flex block-col gap-0.5 flex-1 overflow-hidden">
            <div className="flex flex-row items-center justify-between gap-4">
