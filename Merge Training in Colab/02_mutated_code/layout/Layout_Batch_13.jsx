...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        <ul className="flex flex-col gap-0 text-sm w-full">
...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        <div
            className={`block items-center justify-center w-14 h-14 ${m.color} rounded-full text-lg font-bold ${m.text} flex-shrink-0`}>
            {m.initials}
        </div>
...
export const StatHeaderGroup = () => (<div
    ...
    {[{label: "Total Users", value: "128,400", unit: "accounts"}, {
        ...
        <div key={stat.label} className="flex flex-col items-start gap-16">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex flex-row items-center gap-4">
            ...
            <button
                className="block flex-row items-center gap-1 text-xs text-gray-400 hover:text-green-500 whitespace-nowrap">
                Share
            </button>
        </div>
