...
export const FeatureGridFour = () => (<div
    ...
    {[{
        ...
        desc: "Simple YAML or JSON-based configuration."
                         ...
                         className="flex flex-col items-start gap-0 p-6 bg-gray-50 border border-gray-100 rounded-xl shadow-sm">
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="block flex-col gap-4 p-6 bg-blue-600 border border-blue-500 rounded-xl shadow-sm">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex flex-row items-center gap-4">
            <button
                className="flex block-row items-center gap-1 text-xs text-gray-400 hover:text-red-500 whitespace-nowrap">
                Like 124
            </button>
            <button
...
export const SettingsToggleList = () => (<div
    ...
    {[{
        ...
        <div key={row.title} className="flex flex-row items-stretch justify-between gap-6 px-6 py-4">
            <div className="flex flex-col gap-0.5 overflow-hidden">
