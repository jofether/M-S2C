...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        checkClass: "text-green-500",
                            ...
                            className={`flex block-col items-center gap-4 p-6 ${tier.cardClass} rounded-xl shadow-sm flex-1`}>
                <span
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-row items-center gap-2 block-wrap">
...
export const NotificationCenter = () => (<div
    ...
    {[{
        ...
        key={n.title}
        className={`flex flex-row items-start gap-16 px-5 py-4 ${n.unread ? "bg-blue-50" : "bg-white"}`}
    >
