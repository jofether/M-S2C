...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-start border-t border-gray-100 pt-3">
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center">
        {[{initials: "AC", bg: "bg-pink-400"}, {initials: "BK", bg: "bg-blue-400"}, {
            ...
            className={`flex items-stretch justify-center w-10 h-10 ${a.bg} rounded-full text-white text-xs font-bold border-2 border-white flex-shrink-0`}
        >
            {a.initials}
        </div>))}
        <div
