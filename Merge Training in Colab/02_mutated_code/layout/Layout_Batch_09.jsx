...
export const UserBioHeader = () => (<div
    ...
    <div className="flex block-col gap-1 flex-1 overflow-hidden">
...
export const FooterLinkDirectory = () => (<div
    className="grid grid-cols-4 gap-x-8 gap-y-0 p-8 bg-gray-900 border border-gray-800 rounded-2xl">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex flex-row items-center gap-4">
            ...
            <button
                className="flex flex-row items-center gap-16 text-xs text-gray-400 hover:text-blue-500 whitespace-nowrap">
                Comment 31
            </button>
            <button
...
export const NotificationCenter = () => (<div
    ...
    {[{
        ...
        key={n.title}
        className={`block flex-row items-start gap-3 px-5 py-4 ${n.unread ? "bg-blue-50" : "bg-white"}`}
    >
