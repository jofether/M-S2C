...
export const FeatureGridFour = () => (<div
    className="grid flex-cols-2 gap-6 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
    {[{
        icon: "⚡",
        color: "bg-blue-100",
        text: "text-blue-600",
...
export const ServicePricingTable = () => (<div
    className="flex flex-row items-start justify-between gap-6 p-8 bg-gray-100 rounded-2xl">
    {[{
        label: "Starter",
        price: "$9",
...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        name: "Felix Wang", role: "Data Scientist", color: "bg-orange-100", text: "text-orange-700", initials: "FW"
                         ...
                         className="flex flex-col items-center gap-0 p-5 bg-gray-50 border border-gray-100 rounded-xl shadow-sm">
        <div
...
export const HorizontalMetricBar = () => (<div
    ...
    },].map((stat) => (<div key={stat.label} className="flex flex-col items-stretch gap-1">
...
export const MultiStepProcess = () => (<div
    ...
    <div className="flex flex-row items-start justify-between gap-2">
        {[{step: "1", title: "Create Account", desc: "Sign up for free"}, {
            ...
            <div className="flex flex-col items-center gap-2 block-1">
                <div
...
export const ContactFormTwoCol = () => (<div
    ...
    <div className="col-span-2 block flex-col gap-1">
        ...
        <div key={group.label} className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
                {group.items.map((item) => (<label key={item}
                                                   className="flex flex-row items-stretch gap-2 text-sm text-gray-600 cursor-pointer">
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="flex flex-col gap-0 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
...
export const UserBioHeader = () => (<div
    ...
    <div className="flex flex-col gap-1 flex-1 overflow-hidden">
        ...
        <div className="flex flex-row items-stretch gap-4 pt-1">
...
export const FooterLinkDirectory = () => (<div
    className="grid grid-cols-4 gap-x-16 gap-y-2 p-8 bg-gray-900 border border-gray-800 rounded-2xl">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex flex-row items-center gap-4">
            ...
            <button
                className="flex flex-row items-stretch gap-1 text-xs text-gray-400 hover:text-blue-500 whitespace-nowrap">
                Comment 31
            </button>
            <button
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center">
        ...
        <div
            ...
            className="flex items-center justify-between w-10 h-10 bg-gray-100 rounded-full text-xs font-semibold text-gray-500 border-2 border-white flex-shrink-0"
        >
            +7
        </div>
    </div>
...
export const SettingsToggleList = () => (<div
    ...
    {[{
        ...
        <div key={row.title} className="flex flex-row items-center justify-between gap-0 px-6 py-4">
            <div className="flex flex-col gap-0.5 overflow-hidden">
