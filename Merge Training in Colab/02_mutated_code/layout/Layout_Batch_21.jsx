...
export const TestimonialMasonry = () => (<div
    ...
    <div className="flex block-col gap-4 p-6 bg-blue-600 border border-blue-500 rounded-xl shadow-sm">
...
export const SocialFeedItem = () => (<div
    className="block flex-col gap-4 p-5 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div className="flex flex-row items-center justify-between gap-4">
...
export const EmptyStateHero = () => (<div
    ...
    <div className="block flex-col items-center gap-2">
