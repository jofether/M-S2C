...
export const TeamMemberGallery = () => (<div
    ...
    <div className="col-span-3 flex flex-row items-stretch justify-between pb-4 border-b border-gray-100">
...
export const ContactFormTwoCol = () => (<div
    ...
    <div className="col-span-2 flex flex-row items-center justify-start gap-3">
        <button
