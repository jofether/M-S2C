...
export const UserBioHeader = () => (<div
    className="flex flex-row items-center gap-0 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4">
        <div className="block flex-row items-center gap-3 overflow-hidden">
            <div
...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-3 row-span-full flex flex-col gap-1 p-3 bg-purple-50 rounded-lg border-l-4 border-purple-500">
...
export const SettingsToggleList = () => (<div
    ...
    {[{
        ...
        <div key={row.title} className="flex flex-row items-center justify-between gap-6 px-6 py-4">
            <div className="block flex-col gap-0.5 overflow-hidden">
...
export const NotificationCenter = () => (<div
    ...
    >
        ...
        <div className="flex flex-col gap-0.5 flex-1 overflow-hidden">
            <div className="block flex-row items-center justify-between gap-4">
