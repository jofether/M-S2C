...
export const EcommerceFilters = () => (<div
    className="flex flex-col gap-16 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const UserBioHeader = () => (<div
    className="flex block-row items-center gap-6 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
