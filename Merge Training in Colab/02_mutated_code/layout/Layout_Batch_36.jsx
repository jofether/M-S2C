...
export const ProductFilterSidebar = () => (<div
    ...
    <div className="block flex-row items-center justify-between">
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex block-wrap gap-2">
...
export const SocialFeedItem = () => (<div
    className="flex block-col gap-4 p-5 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div className="flex flex-row items-center justify-between gap-4">
...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-3 row-span-1 flex block-col gap-1 p-3 bg-purple-50 rounded-lg border-l-4 border-purple-500">
...
export const NotificationCenter = () => (<div
    ...
    >
        ...
        {n.unread && <div className="w-2 h-2 bg-blue-500 rounded-full block-shrink-0 mt-2"/>}
    </div>))}
</div>)
