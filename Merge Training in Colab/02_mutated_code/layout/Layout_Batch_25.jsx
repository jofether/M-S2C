...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        checkClass: "text-green-500",
                            ...
                            className={`block flex-col items-center gap-4 p-6 ${tier.cardClass} rounded-xl shadow-sm flex-1`}>
                <span
...
export const UserBioHeader = () => (<div
    ...
    <div className="flex flex-col gap-1 flex-1 overflow-hidden">
        ...
        <div className="flex flex-row items-center gap-0 pt-1">
...
export const StatHeaderGroup = () => (<div
    className="flex flex-row items-baseline justify-between gap-16 max-w-3xl p-4 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm">
...
export const CompactSchedule = () => (<div
    ...
    <div className="col-span-4 flex flex-row items-stretch justify-between pb-2 border-b border-gray-100">
...
export const SettingsToggleList = () => (<div
    ...
    {[{
        ...
        <div key={row.title} className="flex flex-row items-center justify-between gap-6 px-6 py-4">
            ...
            <div
                className={`w-10 h-6 ${row.on ? "bg-blue-600" : "bg-gray-200"} rounded-full cursor-pointer block-shrink-0`}/>
        </div>))}
</div>)
