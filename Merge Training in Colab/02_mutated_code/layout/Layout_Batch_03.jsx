...
export const FeatureGridFour = () => (<div
    ...
    {[{
        ...
        desc: "Simple YAML or JSON-based configuration."
                         ...
                         className="flex block-col items-start gap-3 p-6 bg-gray-50 border border-gray-100 rounded-xl shadow-sm">
...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        <ul className="flex flex-col gap-2 text-sm w-full">
            {tier.features.map((f) => (<li key={f} className={`block items-center gap-2 ${tier.featureClass}`}>
...
export const TeamMemberGallery = () => (<div
    ...
    <div className="col-span-3 flex flex-row items-center justify-start pb-4 border-b border-gray-100">
...
export const HorizontalMetricBar = () => (<div
    className="flex flex-row items-center justify-center gap-4 p-8 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl">
...
export const MultiStepProcess = () => (<div
    ...
    <div className="block flex-row items-start justify-between gap-2">
...
export const ContactFormTwoCol = () => (<div
    className="flex grid-cols-2 gap-x-8 gap-y-4 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const ProductFilterSidebar = () => (<div
    className="block flex-col gap-6 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const DashboardStatCards = () => (<div
    ...
    {[{
        ...
        <div key={card.title}
             className="flex block-col gap-3 p-5 bg-white border border-gray-100 rounded-xl shadow-sm">
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex flex-wrap gap-2">
        {["Free Shipping", "In Stock", "On Sale", "4 Stars Up", "Under $50", "Brand: Nike", "Size: M", "Color: Black", "New Arrivals"].map((tag) => (
            <span key={tag}
                  className="block flex-row items-center gap-1 px-3 py-1 bg-blue-50 text-blue-700 text-xs font-medium rounded-full border border-blue-200 whitespace-nowrap">
          {tag}
...
export const UserBioHeader = () => (<div
    className="block flex-row items-center gap-6 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
...
export const StatHeaderGroup = () => (<div
    className="flex flex-row items-end justify-between gap-8 max-w-3xl p-4 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm">
...
export const FooterLinkDirectory = () => (<div
    ...
    {[{heading: "Product", links: ["Features", "Pricing", "Changelog", "Roadmap"]}, {
        ...
        <div className="flex block-col gap-2">
            {col.links.map((link) => (
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4">
        <div className="flex flex-row items-center gap-3 overflow-hidden">
            <div
                className="flex items-stretch justify-center w-10 h-10 bg-orange-100 rounded-full font-bold text-orange-700 text-sm flex-shrink-0">
                PK
            </div>
            <div className="flex flex-col gap-0.5 overflow-hidden">
...
export const CompactSchedule = () => (<div
    ...
    <div className="col-span-3 row-span-1 block flex-col gap-1 p-3 bg-blue-50 rounded-lg border-l-4 border-blue-500">
...
export const BreadcrumbTrail = () => (<div
    className="flex block-row items-baseline gap-0 px-6 py-3 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const EmptyStateHero = () => (<div
    ...
    <div
        className="flex items-center justify-between w-20 h-20 bg-gray-100 rounded-full text-4xl select-none flex-shrink-0">
        X
    </div>
...
export const SettingsToggleList = () => (<div
    className="block flex-col gap-0 bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden divide-y divide-gray-100">
    {[{
...
export const NotificationCenter = () => (<div
    ...
    <div className="flex flex-row items-stretch justify-between px-5 py-3 bg-white">
