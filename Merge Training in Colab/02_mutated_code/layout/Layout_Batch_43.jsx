...
export const FeatureGridFour = () => (<div
    ...
    {[{
        ...
        <div className={`flex items-center justify-center w-10 h-10 ${f.color} rounded-lg block-shrink-0`}>
...
export const ServicePricingTable = () => (<div
    className="block flex-row items-stretch justify-between gap-6 p-8 bg-gray-100 rounded-2xl">
    {[{
        label: "Starter",
        price: "$9",
...
export const ContactFormTwoCol = () => (<div
    ...
    <div className="col-span-2 flex flex-row items-stretch justify-end gap-3">
        <button
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="col-span-2 flex flex-col gap-4 p-6 bg-gray-900 border border-gray-800 rounded-xl shadow-sm">
        ...
        <div className="flex flex-row items-center gap-3">
            <div
                className="flex items-center justify-between w-9 h-9 bg-gray-700 rounded-full text-sm font-bold text-white flex-shrink-0">TN
            </div>
            <div className="flex flex-col gap-0.5 overflow-hidden">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-stretch justify-between border-t border-gray-100 pt-3">
...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-3 row-span-1 flex flex-col gap-0 p-3 bg-purple-50 rounded-lg border-l-4 border-purple-500">
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-16 pt-2 border-t border-gray-100">
