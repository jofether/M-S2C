...
export const FeatureGridFour = () => (<div
    ...
    {[{
        ...
        desc: "Simple YAML or JSON-based configuration."
                         ...
                         className="flex flex-col items-end gap-3 p-6 bg-gray-50 border border-gray-100 rounded-xl shadow-sm">
...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        <div className="flex flex-col items-center gap-16 w-full overflow-hidden">
...
export const HorizontalMetricBar = () => (<div
    className="flex flex-row items-center justify-evenly gap-16 p-8 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl">
    ...
    <div className="flex flex-row items-start justify-between gap-2">
        {[{step: "1", title: "Create Account", desc: "Sign up for free"}, {
            ...
            <div className="flex flex-col items-center gap-2 flex-1">
                <div
                    className="flex items-stretch justify-center w-10 h-10 bg-blue-600 text-white rounded-full font-bold text-sm flex-shrink-0">
                    {item.step}
                </div>
                <span
        ...
        <div key={group.label} className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
                {group.items.map((item) => (<label key={item}
                    ...
                    <input type="checkbox" className="rounded border-gray-300 text-blue-600 block-shrink-0"/>
...
export const DashboardStatCards = () => (<div
    ...
    {[{
        ...
        <div key={card.title}
             className="flex flex-col gap-16 p-5 bg-white border border-gray-100 rounded-xl shadow-sm">
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="flex flex-col gap-4 p-6 bg-blue-600 border border-blue-500 rounded-xl shadow-sm">
        ...
        <div className="flex flex-row items-center gap-3">
            ...
            <div className="flex block-col gap-0.5 overflow-hidden">
...
export const UserBioHeader = () => (<div
    className="flex flex-row items-center gap-16 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
...
export const StatHeaderGroup = () => (<div
    ...
    {[{label: "Total Users", value: "128,400", unit: "accounts"}, {
        ...
        <div key={stat.label} className="flex block-col items-start gap-1">
...
export const FooterLinkDirectory = () => (<div
    ...
    },].map((col) => (<div key={col.heading} className="flex block-col gap-4">
...
export const SocialFeedItem = () => (<div
    ...
    <div className="flex flex-row items-center justify-between border-t border-gray-100 pt-3">
        <div className="flex block-row items-center gap-4">
            <button
...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-3 row-span-1 block flex-col gap-1 p-3 bg-green-50 rounded-lg border-l-4 border-green-500">
...
export const NotificationCenter = () => (<div
    ...
    >
        <span className="text-xs font-bold text-gray-400 block-shrink-0 mt-0.5 w-8">{n.icon}</span>
