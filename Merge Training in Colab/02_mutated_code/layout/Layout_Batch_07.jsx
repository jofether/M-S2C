...
export const ServicePricingTable = () => (<div
    className="flex flex-row items-stretch justify-start gap-6 p-8 bg-gray-100 rounded-2xl">
    {[{
        label: "Starter",
        price: "$9",
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="flex flex-col gap-4 p-6 bg-blue-600 border border-blue-500 rounded-xl shadow-sm">
        ...
        <div className="block flex-row items-center gap-3">
            <div
...
export const EcommerceFilters = () => (<div
    ...
    <div className="flex flex-wrap gap-2">
        {["Free Shipping", "In Stock", "On Sale", "4 Stars Up", "Under $50", "Brand: Nike", "Size: M", "Color: Black", "New Arrivals"].map((tag) => (
            <span key={tag}
                  className="flex flex-row items-center gap-0 px-3 py-1 bg-blue-50 text-blue-700 text-xs font-medium rounded-full border border-blue-200 whitespace-nowrap">
          {tag}
...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-1 row-span-1 flex flex-col gap-1 p-3 bg-green-50 rounded-lg border-l-4 border-green-500">
...
export const BreadcrumbTrail = () => (<div
    className="flex flex-row items-end gap-0 px-6 py-3 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const EmptyStateHero = () => (<div
    className="flex flex-col items-center justify-between gap-5 p-16 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
...
export const AvatarGroup = () => (<div
    className="flex flex-col gap-0 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div className="flex flex-row items-center justify-between gap-4">
