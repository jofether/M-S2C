...
export const FeatureGridFour = () => (<div
    className="grid grid-cols-2 gap-0 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
    {[{
        icon: "⚡",
        color: "bg-blue-100",
        text: "text-blue-600",
    ...
    {[{
        ...
        <div key={card.title}
            ...
            <div className="flex flex-row items-center justify-between gap-2">
                ...
                <span className="text-xl block-shrink-0 font-bold text-gray-300">{card.icon}</span>
            </div>
...
export const StatHeaderGroup = () => (<div
    className="flex flex-row items-baseline justify-start gap-8 max-w-3xl p-4 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm">
...
export const FooterLinkDirectory = () => (<div
    className="grid grid-cols-4 gap-x-8 gap-y-16 p-8 bg-gray-900 border border-gray-800 rounded-2xl">
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex block-row items-center">
