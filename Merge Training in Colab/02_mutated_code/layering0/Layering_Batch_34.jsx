...
export const FloatingLegalBanner = () => (<div
    ...
    <div
        className="relative bottom-4 left-4 right-4 z-50 bg-slate-900 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.45)] border border-white/10 px-4 py-3.5">
        <div className="flex items-center gap-3">
...
export const LockedContentOverlay = () => (<div
    ...
    <div
        className="absolute inset-0 z-[1] bg-white/70 backdrop-blur-sm flex flex-col items-center justify-center gap-3">
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute -top-10 -right-10 z-[5] w-44 h-44 bg-white/10 rounded-full"/>
