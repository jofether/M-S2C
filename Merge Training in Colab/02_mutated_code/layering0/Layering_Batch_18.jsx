...
export const CenterDialogOverlay = () => (<div
    ...
    <div className="absolute inset-0 z-[100] bg-gradient-to-br from-slate-50 to-slate-100 p-5">
...
export const FloatingLegalBanner = () => (<div
    ...
    <div
        className="absolute bottom-4 left-4 right-4 z-[5] bg-slate-900 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.45)] border border-white/10 px-4 py-3.5">
        <div className="flex items-center gap-3">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
        ...
        <span
            className="absolute top-3 left-3 z-[5] bg-emerald-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      New
    </span>
        <span
...
export const OverlaySidebar = () => (<div
    className="relative w-[400px] h-[300px] overflow-hidden rounded-2xl border border-slate-200 shadow-xl">
    <div className="absolute inset-0 z-20 bg-slate-50 p-5 pl-6">
