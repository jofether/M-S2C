...
export const CenterDialogOverlay = () => (<div
    ...
    <div className="static inset-0 z-10 bg-slate-900/60"/>
    <div
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-0 w-11 h-11 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            AR
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    ...
    <span
        className="absolute top-3 left-3 z-0 bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded whitespace-nowrap">
      LIVE
    </span>
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="relative z-30 flex flex-col gap-3 p-5 w-40 bg-white border border-gray-200 rounded-2xl shadow-sm">
...
export const FloatingActionDisplay = () => (<div
    ...
    <div
        className="absolute bottom-2 right-5 z-[-10] w-12 h-12 bg-indigo-600 rounded-full shadow-lg border-2 border-white flex items-center justify-center">
...
export const OverlaySidebar = () => (<div
    ...
    <div
        className="static top-0 left-0 h-full w-64 z-40 bg-slate-900 border-r border-slate-700 shadow-2xl flex flex-col py-5">
