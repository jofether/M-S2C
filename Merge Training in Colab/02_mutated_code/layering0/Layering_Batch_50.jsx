...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-[999] bg-gradient-to-br from-indigo-600 via-violet-600 to-pink-600"/>
...
export const OverlaySidebar = () => (<div
    ...
    <div
        className="absolute top-0 left-0 h-full w-64 z-[999] bg-slate-900 border-r border-slate-700 shadow-2xl flex flex-col py-5">
