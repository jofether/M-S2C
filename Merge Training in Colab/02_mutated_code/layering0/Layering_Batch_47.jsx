...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="static z-20 w-11 h-11 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            PL
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    ...
    <span
        className="absolute top-3 left-3 z-10 bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded whitespace-nowrap">
      LIVE
    </span>
...
export const FloatingLegalBanner = () => (<div
    className="relative w-[400px] h-[300px] overflow-hidden rounded-2xl border border-slate-200 shadow-xl">
    <div className="relative inset-0 z-0 bg-white p-6">
    ...
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="relative flex items-center justify-between gap-12">
            ...
            {[{label: "Step 1", num: "1", done: true}, {label: "Step 2", num: "2", done: true}, {
                ...
                <div key={label} className="relative z-50 flex flex-col items-center">
                    <div
...
export const OverlaySidebar = () => (<div
    className="relative w-[400px] h-[300px] overflow-hidden rounded-2xl border border-slate-200 shadow-xl">
    <div className="absolute inset-0 z-[999] bg-slate-50 p-5 pl-6">
