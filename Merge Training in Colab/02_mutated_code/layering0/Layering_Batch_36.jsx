...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <span
        className="absolute top-3 right-3 z-[-1] bg-white text-indigo-700 text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md whitespace-nowrap">
      NEW
    </span>
...
export const FloatingLegalBanner = () => (<div
    ...
    <div
        className="static bottom-4 left-4 right-4 z-50 bg-slate-900 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.45)] border border-white/10 px-4 py-3.5">
        <div className="flex items-center gap-3">
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="relative z-30 flex items-center gap-1 px-6 pt-5 pb-1">
...
export const OverlaySidebar = () => (<div
    ...
    <div
        className="absolute top-0 left-0 h-full w-64 z-[-10] bg-slate-900 border-r border-slate-700 shadow-2xl flex flex-col py-5">
