...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="relative z-[100] w-11 h-11 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            JM
        </div>
        <div
...
export const FloatingActionDisplay = () => (<div
    ...
    <div className="absolute inset-0 z-[100] p-5">
