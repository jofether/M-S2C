...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        className="absolute top-full left-0 mt-2 z-[100] w-48 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-0 w-11 h-11 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            PL
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute bottom-0 inset-x-0 z-[-10] bg-gradient-to-t from-black/90 to-transparent px-4 pb-3 pt-8">
...
export const FloatingLegalBanner = () => (<div
    ...
    <div
        className="absolute bottom-0 inset-x-0 z-[-1] h-28 bg-gradient-to-t from-slate-900/30 to-transparent pointer-events-none"/>
    <div
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    <div
        className="relative z-0 flex items-center gap-2 px-4 py-2.5 bg-white border-2 border-indigo-400 rounded-xl shadow-sm">
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    <div className="absolute inset-0 z-[-1] bg-gradient-to-r from-slate-800 to-slate-700"/>
...
export const OverlaySidebar = () => (<div
    className="relative w-[400px] h-[300px] overflow-hidden rounded-2xl border border-slate-200 shadow-xl">
    <div className="relative inset-0 z-0 bg-slate-50 p-5 pl-6">
