...
export const CenterDialogOverlay = () => (<div
    ...
    <div className="relative inset-0 z-10 bg-slate-900/60"/>
    <div
...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    ...
    <div
        className="absolute top-0 left-0 right-0 z-[-1] flex items-center gap-3 bg-gray-900 text-white px-4 py-3 rounded-2xl shadow-2xl">
...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute bottom-0 inset-x-0 z-[5] bg-gradient-to-t from-black/80 to-transparent px-4 pt-8 pb-4">
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute bottom-0 inset-x-0 z-[1] bg-gradient-to-t from-black/90 to-transparent px-4 pb-3 pt-8">
...
export const FloatingLegalBanner = () => (<div
    ...
    <div
        className="absolute bottom-4 left-4 right-4 z-[-10] bg-slate-900 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.45)] border border-white/10 px-4 py-3.5">
        <div className="flex items-center gap-3">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      Featured
        ...
        <span
            className="absolute top-[106px] right-3 z-[999] bg-indigo-600 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Top
    </span>
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute -bottom-8 -left-8 z-[-1] w-28 h-28 bg-white/10 rounded-full"/>
...
export const OverlaySidebar = () => (<div
    className="relative w-[400px] h-[300px] overflow-hidden rounded-2xl border border-slate-200 shadow-xl">
    <div className="static inset-0 z-0 bg-slate-50 p-5 pl-6">
