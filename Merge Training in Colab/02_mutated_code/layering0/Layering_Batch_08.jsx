...
export const CenterDialogOverlay = () => (<div
    ...
    <div className="absolute inset-0 z-[-10] bg-gradient-to-br from-slate-50 to-slate-100 p-5">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-0 w-11 h-11 rounded-full border-2 border-white bg-rose-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            KT
        </div>
        <div
...
export const FloatingLegalBanner = () => (<div
    ...
    <div
        className="absolute bottom-0 inset-x-0 z-[999] h-28 bg-gradient-to-t from-slate-900/30 to-transparent pointer-events-none"/>
    <div
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
        ...
        <span
            className="absolute top-3 left-3 z-[999] bg-emerald-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      New
    </span>
        <span
...
export const OverlaySidebar = () => (<div
    className="absolute w-[400px] h-[300px] overflow-hidden rounded-2xl border border-slate-200 shadow-xl">
