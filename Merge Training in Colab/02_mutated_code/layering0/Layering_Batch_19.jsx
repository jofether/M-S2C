...
export const CenterDialogOverlay = () => (<div
    ...
    <div
        className="static top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-72 bg-white rounded-2xl shadow-2xl overflow-hidden">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-0 w-11 h-11 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-600 text-xs font-bold shadow-md">
            +4
        </div>
    </div>
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute bottom-0 inset-x-0 z-[999] bg-gradient-to-t from-black/90 to-transparent px-4 pb-3 pt-8">
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="absolute top-0 bottom-0 left-0 w-1 z-[-1] bg-indigo-500"/>
...
export const OverlaySidebar = () => (<div
    ...
    <div
        className="absolute top-0 left-0 h-full w-64 z-[5] bg-slate-900 border-r border-slate-700 shadow-2xl flex flex-col py-5">
