...
export const CenterDialogOverlay = () => (<div
    ...
    <div className="absolute inset-0 z-[5] bg-gradient-to-br from-slate-50 to-slate-100 p-5">
...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <span
        className="absolute top-3 right-3 z-40 bg-white text-indigo-700 text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md whitespace-nowrap">
      NEW
    </span>
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="static bottom-0 inset-x-0 z-20 bg-gradient-to-t from-black/90 to-transparent px-4 pb-3 pt-8">
...
export const FloatingLegalBanner = () => (<div
    ...
    <div
        className="absolute bottom-0 inset-x-0 z-0 h-28 bg-gradient-to-t from-slate-900/30 to-transparent pointer-events-none"/>
    <div
