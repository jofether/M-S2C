...
export const CenterDialogOverlay = () => (<div
    ...
    <div className="static inset-0 z-0 bg-gradient-to-br from-slate-50 to-slate-100 p-5">
...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    <div
        className="absolute top-8 left-0 right-0 z-0 flex items-center gap-3 bg-blue-600 text-white px-4 py-2.5 rounded-2xl shadow-md opacity-70">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="static z-50 w-11 h-11 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            JM
        </div>
        <div
...
export const FloatingLegalBanner = () => (<div
    className="relative w-[400px] h-[300px] overflow-hidden rounded-2xl border border-slate-200 shadow-xl">
    <div className="absolute inset-0 z-[-1] bg-white p-6">
...
export const FloatingActionDisplay = () => (<div
    ...
    <div
        className="absolute bottom-2 right-5 z-20 w-12 h-12 bg-indigo-600 rounded-full shadow-lg border-2 border-white flex items-center justify-center">
...
export const LockedContentOverlay = () => (<div
    ...
    <div
        className="absolute inset-0 z-[999] bg-white/70 backdrop-blur-sm flex flex-col items-center justify-center gap-3">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
        ...
        <span
            className="absolute top-3 left-3 z-20 bg-emerald-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      New
    </span>
        <span
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="relative z-[-1] p-10 flex flex-col items-center text-center gap-5">
...
export const OverlaySidebar = () => (<div
    className="static w-[400px] h-[300px] overflow-hidden rounded-2xl border border-slate-200 shadow-xl">
