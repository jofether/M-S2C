...
export const CenterDialogOverlay = () => (<div
    ...
    <div className="absolute inset-0 z-[100] bg-slate-900/60"/>
    <div
...
export const FloatingLegalBanner = () => (<div
    ...
    <div
        className="relative bottom-0 inset-x-0 z-10 h-28 bg-gradient-to-t from-slate-900/30 to-transparent pointer-events-none"/>
    <div
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="relative z-[999] flex flex-col gap-3 p-5 w-44 bg-indigo-600 border-2 border-indigo-400 rounded-2xl shadow-2xl scale-105">
        <div className="flex items-center justify-between">
...
export const LockedContentOverlay = () => (<div
    ...
    <div className="relative z-50 bg-white p-5">
