...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    <div
        className="absolute top-8 left-0 right-0 z-[999] flex items-center gap-3 bg-blue-600 text-white px-4 py-2.5 rounded-2xl shadow-md opacity-70">
...
export const FloatingLegalBanner = () => (<div
    ...
    <div
        className="absolute bottom-4 left-4 right-4 z-0 bg-slate-900 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.45)] border border-white/10 px-4 py-3.5">
        <div className="flex items-center gap-3">
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute z-10 p-10 flex flex-col items-center text-center gap-5">
...
export const OverlaySidebar = () => (<div
    ...
    <div
        className="relative top-0 left-0 h-full w-64 z-40 bg-slate-900 border-r border-slate-700 shadow-2xl flex flex-col py-5">
