...
export const FileUploaderDropzone = () => (<div
    ...
    <div className="flex inline-col items-center gap-1 text-center">
    ...
    <div className="flex flex-col gap-2">
        {[{
            ...
            subject: "Product Roadmap v3", sender: "Alex J.", tag: "Draft", time: "Mon", tint: "amber"
                               ...
                               className="contents items-center gap-3 px-3.5 py-3 rounded-xl bg-slate-50 border border-slate-100">
            <span
