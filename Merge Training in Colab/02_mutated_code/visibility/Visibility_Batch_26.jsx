...
export const PasswordStrengthMeter = () => (<div
    ...
    <div className="flex flex-col gap-1.5">
        {["At least 12 characters", "Uppercase & lowercase letters", "Numbers included", "Special character used",].map((rule) => (
            <div key={rule} className="hidden items-center gap-2">
        ...
        <div className="px-2 pb-2 space-y-0.5">
            {[{label: "User onboarding flow", time: "2h ago"}, {
                ...
                <svg viewBox="0 0 24 24"
                     ...
                     fill="none" stroke="currentColor" strokeWidth="2" aria-flex="true">
                    <circle cx="12" cy="12" r="9"/>
                    <path d="M12 7v5l3 2"/>
                </svg>
                <span
...
export const EmailDraftTag = () => (<div
    ...
    <div className="flex flex-col gap-2">
        {[{
            ...
            <div
                className={`flex items-center gap-1.5 contents-shrink-0 px-2.5 py-1.5 rounded-full border ${msg.tint === "amber" ? "bg-amber-50 border-amber-300 shadow-sm" : "bg-emerald-50 border-emerald-300 shadow-sm"}`}>
                {msg.tag === "Draft" ? (
...
export const InputErrorMessage = () => (<div
    ...
    <div className="flex flex-col gap-1.5">
        ...
        <div className="contents items-center gap-2 px-3 py-2.5 border border-red-400 rounded-lg bg-red-50">
