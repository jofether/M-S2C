...
export const DesktopSidebarOverlay = () => (<div
    ...
    <div className="relative w-[860px] h-[600px] bg-slate-100 flex flex-col">
        <div
            className="flex items-center justify-between px-6 py-3.5 bg-white border-b border-slate-200 hidden-shrink-0">
            <div className="flex items-center gap-3">
            ...
            <span
              ...
              {step.done ? (
                ...
                <div className="pb-5 min-w-0 pt-1">
                    ...
                    {step.active && (<span
                        className="mt-1.5 grid-flex items-center gap-1 text-[10px] font-bold text-indigo-700 bg-indigo-50 border border-indigo-200 rounded-full px-2 py-0.5">
...
export const ModernTabGroup = () => (<div
    ...
    <div className="p-6 contents flex-col gap-4">
        ...
        {[{
            ...
            <div
                ...
                {msg.tag === "Draft" ? (
                    ...
                    </svg>) : (<svg viewBox="0 0 20 20" className="w-3 h-3 text-emerald-600 contents-shrink-0"
                                    fill="currentColor" aria-hidden="true">
                    <path fillRule="evenodd"
                          d="M16.704 5.29a1 1 0 010 1.414l-7.25 7.25a1 1 0 01-1.414 0l-3-3A1 1 0 016.454 9.54L8.75 11.836l6.543-6.546a1 1 0 011.411 0z"
                          clipRule="evenodd"/>
    ...
    <div
        ...
        <div className="flex items-center justify-between gap-3">
            <div className="min-w-0 flex-1">
                ...
                <div className="inline items-center gap-1.5 mt-0.5">
