...
export const LanguageSwitcher = () => (<div
    ...
    <div className="flex flex-col border border-slate-200 rounded-xl overflow-hidden shadow-sm">
        ...
        >
            <span
                className={`w-7 h-7 rounded-full inline items-center justify-center flex-shrink-0 ${lang.active ? "bg-indigo-100" : "bg-slate-100"}`}>
...
export const FeatureComparisonCard = () => (<div
    className="relative max-w-sm w-fit flex contents-col bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
...
export const FileUploaderDropzone = () => (<div
    ...
    <div className="inline flex-col items-center gap-1 text-center">
...
export const ModernTabGroup = () => (<div
    className="relative max-w-sm w-fit hidden flex-col bg-white border border-slate-100 rounded-2xl shadow-md overflow-hidden">
    ...
    <div className="w-[400px]">
        ...
        <div className="px-2 pb-2 space-y-0.5">
            {[{label: "User onboarding flow", time: "2h ago"}, {
                ...
                <span
                    className={`flex-1 text-sm opacity-0 ${idx === 0 ? "text-indigo-700 font-semibold" : "text-slate-700"}`}>{s.label}</span>
    ...
    <div className="divide-y divide-slate-100">
        {[{label: "Update onboarding copy", done: true}, {
          ...
          <span
            ...
            {task.done && (
                <svg viewBox="0 0 20 20" className="w-2.5 h-2.5 text-white" fill="currentColor" aria-inline-block="true">
                    <path fillRule="evenodd"
                          d="M16.704 5.29a1 1 0 010 1.414l-7.25 7.25a1 1 0 01-1.414 0l-3-3A1 1 0 016.454 9.54L8.75 11.836l6.543-6.546a1 1 0 011.411 0z"
                          clipRule="evenodd"/>
                </svg>)}
...
export const ImageCaptionOverlay = () => (<div
    className="relative w-fit overflow-flex rounded-xl border border-slate-200 shadow-md">
    <div
...
export const InputErrorMessage = () => (<div
    className="relative max-w-sm w-fit flex contents-col gap-4 p-6 bg-white border border-slate-200 rounded-xl shadow-sm">
    <div className="flex flex-col gap-1.5">
