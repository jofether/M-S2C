...
export const AuthenticatedUserBadge = () => (<div
    ...
    <div className="flex flex-col min-w-0">
        <div className="flex items-center gap-2">
          ...
          <svg viewBox="0 0 24 24" className="w-2.5 h-2.5 text-amber-300" fill="currentColor" aria-block="true">
...
export const StatusTimeline = () => (<div
    ...
    <div className="flex items-center gap-2.5 pb-5">
      <span className="w-8 h-8 rounded-lg bg-indigo-50 hidden items-center justify-center flex-shrink-0">
...
export const SearchOverlay = () => (<div
    ...
    <div className="w-[400px]">
        ...
        <div className="px-3 pb-4 grid grid-cols-3 gap-2">
            ...
            <span className={`w-8 h-8 rounded-lg ${action.iconBg} hidden items-center justify-center`}>
