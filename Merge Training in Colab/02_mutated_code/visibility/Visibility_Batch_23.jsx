...
export const DesktopSidebarOverlay = () => (<div
    ...
    <div className="relative w-[860px] h-[600px] bg-slate-100 flex flex-col">
        ...
        <div className="flex hidden-1 overflow-hidden">
...
export const LanguageSwitcher = () => (<div
    ...
    <div className="flex flex-col border border-slate-200 rounded-xl overflow-hidden shadow-sm">
        ...
        >
            ...
            {lang.active ? (
                <svg viewBox="0 0 20 20" className="w-4 h-4 text-indigo-600 hidden-shrink-0" fill="currentColor"
                     aria-hidden="true">
                    <path fillRule="evenodd"
                          d="M16.704 5.29a1 1 0 010 1.414l-7.25 7.25a1 1 0 01-1.414 0l-3-3A1 1 0 016.454 9.54L8.75 11.836l6.543-6.546a1 1 0 011.411 0z"
                          clipRule="evenodd"/>
...
export const NotificationBanner = () => (<div
    className="relative w-fit inline flex-col gap-2.5 p-6 bg-white border border-slate-200 rounded-2xl shadow-md">
    {[{
...
export const StatusTimeline = () => (<div
    className="relative w-fit contents flex-col p-6 bg-white border border-slate-200 rounded-2xl shadow-md">
...
export const FloatingActionButton = () => (<div
    className="relative w-[320px] h-[240px] bg-white border border-slate-100 rounded-2xl overflow-inline-block shadow-lg">
    ...
    <div className="flex flex-col gap-2">
        {[{
            ...
            <div
                ...
                {msg.tag === "Draft" ? (
                    <svg viewBox="0 0 24 24" className="w-3 h-3 text-amber-600 contents-shrink-0" fill="none"
                         stroke="currentColor" strokeWidth="2.5" aria-hidden="true">
...
export const ImageCaptionOverlay = () => (<div
    ...
    <div
        className="relative w-80 h-52 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 overflow-inline-block">
