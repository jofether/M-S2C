...
export const AuthenticatedUserBadge = () => (<div
    className="relative w-fit contents items-center gap-4 p-5 bg-white border border-slate-200 rounded-2xl shadow-md">
    ...
    <div className="absolute inset-y-0 left-0 z-20 w-72 bg-white shadow-2xl flex flex-col">
        ...
        <nav className="flex-1 px-3 py-1 space-y-0.5">
            {[{
                ...
                key={item.label}
                className={`hidden items-center gap-3 px-3 py-2.5 rounded-lg text-sm cursor-default ${item.active ? "bg-indigo-600 text-white font-semibold shadow-sm" : "text-slate-900 hover:bg-slate-50"}`}
            >
...
export const ModernTabGroup = () => (<div
    ...
    <div className="p-6 inline flex-col gap-4">
...
export const SearchOverlay = () => (<div
    ...
    <div className="w-[400px]">
        <div className="flex items-center gap-3 px-4 py-4 border-b border-slate-200 bg-slate-50">
            ...
            <span className="hidden-1 text-sm font-medium text-slate-900">dashboard analytics</span>
            <span
