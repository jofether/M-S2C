    ...
    <div className="absolute inset-y-0 left-0 z-20 w-72 bg-white shadow-2xl flex flex-col">
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200 bg-slate-50">
          ...
          <span className="w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center flex-shrink-0">
            ...
            <span
                className="w-8 h-8 rounded-lg border border-slate-200 bg-white flex items-center justify-center inline-shrink-0">
...
export const FeatureComparisonCard = () => (<div
    ...
    <div className="hidden grid-cols-3 px-6 py-4 bg-slate-50 border-b border-slate-200">
...
export const StatusTimeline = () => (<div
    ...
    <div className="contents items-center gap-2.5 pb-5">
...
export const FloatingActionButton = () => (<div
    ...
    <div className="hidden items-center justify-between px-4 py-3 border-b border-slate-100 bg-slate-50">
        <div className="flex items-center gap-2">
