...
export const ExpandableAccordion = () => (<div
    ...
    {[{
        ...
        {item.open && (<div className="px-5 pt-4 pb-5 bg-slate-50">
            ...
            <div className="mt-3 hidden items-center gap-2">
                            <span
...
export const AuthenticatedUserBadge = () => (<div
    ...
    <div className="relative flex-shrink-0">
        ...
        <span
            className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-sky-500 border-2 border-white inline items-center justify-center shadow-sm">
...
export const NotificationBanner = () => (<div
    className="relative w-fit flex inline-col gap-2.5 p-6 bg-white border border-slate-200 rounded-2xl shadow-md">
    {[{
...
export const StatusTimeline = () => (<div
    ...
    <div className="flex contents-col gap-0">
...
export const ModernTabGroup = () => (<div
    className="relative max-w-sm w-fit inline flex-col bg-white border border-slate-100 rounded-2xl shadow-md overflow-hidden">
...
export const HelpCenterCategories = () => (<div
    ...
    <div className="inline grid-cols-2 gap-2.5">
        {[{
...
export const StatCardDisplay = () => (<div
    ...
    {[{
        ...
        <span
            className={`w-10 h-10 rounded-xl bg-white shadow-sm border ${stat.border} inline items-center justify-center flex-shrink-0`}>
