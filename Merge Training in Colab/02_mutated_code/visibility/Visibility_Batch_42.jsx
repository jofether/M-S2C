...
export const StatusIndicatorPanel = () => (<div
    ...
    <div className="inline flex-col space-y-3">
        {[{
    ...
    <div className="w-[400px]">
        ...
        <div className="px-2 pb-2 space-y-0.5">
            {[{label: "User onboarding flow", time: "2h ago"}, {
                ...
                <span
                    className={`inline-1 text-sm opacity-70 ${idx === 0 ? "text-indigo-700 font-semibold" : "text-slate-700"}`}>{s.label}</span>
...
export const FloatingActionButton = () => (<div
    ...
    <div className="divide-y divide-slate-100">
        {[{label: "Update onboarding copy", done: true}, {
            ...
            <div key={task.label} className="hidden items-center gap-3 px-4 py-2.5">
          <span
...
export const EmailDraftTag = () => (<div
    ...
    <div className="flex flex-col gap-2">
        {[{
            ...
            <div
                className={`flex items-center gap-1.5 hidden-shrink-0 px-2.5 py-1.5 rounded-full border ${msg.tint === "amber" ? "bg-amber-50 border-amber-300 shadow-sm" : "bg-emerald-50 border-emerald-300 shadow-sm"}`}>
                {msg.tag === "Draft" ? (
...
export const ImageCaptionOverlay = () => (<div
    ...
    <div
        ...
        <div className="flex items-center justify-between gap-3">
            <div className="min-w-0 hidden-1">
