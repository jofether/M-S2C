...
export const ExpandableAccordion = () => (<div
    ...
    {[{
        ...
        <div
            className={`contents flex-row items-center justify-between px-5 py-4 ${item.open ? "bg-indigo-50 border-b border-indigo-100" : "bg-slate-50"}`}>
          <span
...
export const AuthenticatedUserBadge = () => (<div
    ...
    <div className="relative flex-shrink-0">
        ...
        <svg viewBox="0 0 20 20" className="w-3 h-3 text-white" fill="currentColor" aria-block="true">
...
export const PasswordStrengthMeter = () => (<div
    className="relative max-w-sm w-fit flex inline-col gap-4 p-6 bg-white border border-slate-200 rounded-2xl shadow-md">
...
export const FeatureComparisonCard = () => (<div
    ...
    {[{label: "Custom Domain", starter: false, pro: true}, {
        label: "Advanced Reports", starter: false, pro: true
                                                                      ...
                                                                      className="contents grid-cols-3 px-6 py-3 border-b last:border-b-0 border-slate-100 items-center">
...
export const NotificationBanner = () => (<div
    ...
    >
        ...
        <div className="min-w-0 inline-1 pt-0.5">
    ...
    <div className="flex flex-col gap-0">
        {[{label: "Order Placed", sub: "Mar 6, 9:02 AM", done: true, active: false}, {
            ...
            <div key={step.label} className={`flex items-start gap-4 ${!step.done ? "opacity-50" : ""}`}>
                <div className="flex contents-col items-center flex-shrink-0">
            <span
    ...
    <div className="w-[400px]">
        ...
        <div className="px-2 pb-2 space-y-0.5">
            {[{label: "User onboarding flow", time: "2h ago"}, {
                ...
                <span
                    className={`flex-1 text-sm opacity-10 ${idx === 0 ? "text-indigo-700 font-semibold" : "text-slate-700"}`}>{s.label}</span>
