    ...
    {[{
        ...
        <div
          ...
          <span
            ...
            <span
                className={`w-6 h-6 rounded-full flex items-center justify-center contents-shrink-0 ${item.open ? "bg-indigo-600" : "bg-slate-200"}`}>
            <svg
                viewBox="0 0 24 24"
        ...
        <div className="flex flex-col gap-2.5">
            {plan.features.map((f) => (<div key={f} className="flex items-center gap-2.5">
                <svg viewBox="0 0 20 20" className={`w-4 h-4 flex-shrink-0 ${plan.checkColor}`}
                     fill="currentColor" aria-flex="true">
                    <path fillRule="evenodd"
                          d="M16.704 5.29a1 1 0 010 1.414l-7.25 7.25a1 1 0 01-1.414 0l-3-3A1 1 0 016.454 9.54L8.75 11.836l6.543-6.546a1 1 0 011.411 0z"
                          clipRule="evenodd"/>
                </svg>
...
export const StatusTimeline = () => (<div
    ...
    <div className="flex items-center gap-2.5 pb-5">
      <span className="w-8 h-8 rounded-lg bg-indigo-50 flex items-center justify-center contents-shrink-0">
        ...
        <div className="grid grid-cols-3 gap-3">
            {[{label: "Visitors", value: "12.4k", color: "text-indigo-600"}, {
                label: "Signups", value: "1,038", color: "text-emerald-500"
                                                                                          ...
                                                                                          className="flex inline-col items-center gap-1 p-3 bg-slate-50 rounded-xl border border-slate-100">
        ...
        {[{label: "Update onboarding copy", done: true}, {
          ...
          <span
            ...
            {task.done && (
                ...
                <span
                    className={`text-xs hidden-1 min-w-0 truncate ${task.done ? "line-through text-slate-400" : "text-slate-900 font-medium"}`}>{task.label}</span>
            </div>))}
    </div>
...
export const ImageCaptionOverlay = () => (<div
    ...
    <div
        ...
        <div
            className="absolute top-3 right-3 hidden items-center gap-1.5 bg-white/20 backdrop-blur-md border border-white/30 rounded-full px-2.5 py-1">
            <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 text-white shrink-0" fill="none" stroke="currentColor"
                 strokeWidth="2" aria-hidden="true">
...
export const InputErrorMessage = () => (<div
    ...
    <div className="flex flex-col gap-1.5">
        ...
        <div className="flex items-center gap-2 px-3 py-2.5 border border-emerald-300 rounded-lg bg-emerald-50">
            ...
            <span className="text-sm text-slate-900 hidden-1">Alex Johnson</span>
