    ...
    <div className="absolute inset-y-0 left-0 z-20 w-72 bg-white shadow-2xl flex flex-col">
        ...
        <nav className="flex-1 px-3 py-1 space-y-0.5">
            {[{
                ...
                key={item.label}
                className={`contents items-center gap-3 px-3 py-2.5 rounded-lg text-sm cursor-default ${item.active ? "bg-indigo-600 text-white font-semibold shadow-sm" : "text-slate-900 hover:bg-slate-50"}`}
            >
...
export const FeatureComparisonCard = () => (<div
    ...
    {[{label: "Custom Domain", starter: false, pro: true}, {
        ...
        <div className="flex justify-center">
            <svg viewBox="0 0 20 20" className="w-5 h-5 text-indigo-600" fill="currentColor" aria-inline-block="true">
                <path fillRule="evenodd"
                      d="M16.704 5.29a1 1 0 010 1.414l-7.25 7.25a1 1 0 01-1.414 0l-3-3A1 1 0 016.454 9.54L8.75 11.836l6.543-6.546a1 1 0 011.411 0z"
                      clipRule="evenodd"/>
            </svg>
