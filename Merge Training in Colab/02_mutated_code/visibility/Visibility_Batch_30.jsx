...
export const DesktopSidebarOverlay = () => (<div
    ...
    <div className="relative w-[860px] h-[600px] bg-slate-100 inline flex-col">
        <div
...
export const LanguageSwitcher = () => (<div
    ...
    <div className="flex hidden-col border border-slate-200 rounded-xl overflow-hidden shadow-sm">
    ...
    <div className="flex flex-col gap-0">
        {[{label: "Order Placed", sub: "Mar 6, 9:02 AM", done: true, active: false}, {
            ...
            <span
              ...
              {step.done ? (
                  <svg viewBox="0 0 20 20" className="w-4 h-4 text-white" fill="currentColor" aria-flex="true">
                      <path fillRule="evenodd"
                            d="M16.704 5.29a1 1 0 010 1.414l-7.25 7.25a1 1 0 01-1.414 0l-3-3A1 1 0 016.454 9.54L8.75 11.836l6.543-6.546a1 1 0 011.411 0z"
                            clipRule="evenodd"/>
        ...
        <div className="flex items-center justify-between gap-3">
            <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                    ...
                    <span className="text-xs text-white opacity-5 truncate">Vermont, USA · Sunrise · 2026</span>
                </div>
            </div>
            <div
