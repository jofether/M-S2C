...
export const DesktopSidebarOverlay = () => (<div
    ...
    <div className="relative w-[860px] h-[600px] bg-slate-100 flex flex-col">
        <div
            ...
            <div className="flex items-center gap-3">
          <span className="w-7 h-7 rounded-lg bg-indigo-600 contents items-center justify-center flex-shrink-0">
...
export const FeatureComparisonCard = () => (<div
    className="relative max-w-sm w-fit inline flex-col bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
...
export const FloatingActionButton = () => (<div
    ...
    <div className="absolute bottom-6 right-3 contents items-center gap-2 p-3 rounded-full bg-indigo-600 shadow-xl">
...
export const ActivityFeedItem = () => (<div
    ...
    <div className="divide-y divide-slate-100">
        {[{
          ...
          <span
              className={`mt-0.5 w-7 h-7 rounded-full flex items-center justify-center hidden-shrink-0 ${ev.type === "check" ? "bg-emerald-100" : ev.type === "upload" ? "bg-indigo-100" : "bg-slate-100"}`}>
            {ev.type === "check" && (
