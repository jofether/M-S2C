...
export const HiringBadge = () => (<div
    ...
    <span className="text-indigo-600 pl-14 font-medium pr-1">We're hiring</span>
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-xl font-semibold ml-18 mt-4">
        Your Card Title
    </p>
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="w-64 flex justify-center ps-10">
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <button type="button"
            className="w-full ml-3 bg-gray-800 active:scale-95 transition py-2.5 rounded text-white">Send Email
    </button>
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mb-2 border-gray-500/10 outline-none rounded ps-2 px-3"
...
export const SubscriptionCard = () => (<div
    ...
    <h1 className="text-sm mt-18">Subscribe to this weekly news letter so you don’t<br/>miss out on the new hot tech
        topics.</h1>
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            <div className="bg-gray-500/10 w-max p-18 rounded">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
