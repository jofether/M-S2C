...
export const SuccessAlertLightFill = () => (<div
    ...
    <div className="flex items-center">
        ...
        <p className="text-sm ml-18">Success! Your task is fully completed.</p>
    </div>
...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pt-3 text-sm rounded border border-gray-300/60">
...
export const HiringBadge = () => (<div
    ...
    <span className="text-indigo-600 pl-2 font-medium pb-1">We're hiring</span>
...
export const SimpleCardWithButton = () => (<div
    className="ps-4 bg-white border border-gray-200 hover:-translate-y-1 transition duration-300 rounded-lg shadow shadow-black/10 max-w-80">
...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 py-2">
        <div className="flex items-center justify-between gap-3">
            <div className="bg-white pr-2 rounded border border-gray-500/30">
                <img className="h-9"
    ...
    <div className="flex items-start justify-between p-3">
        <div>
            <div className="flex items-center space-x-2">
                ...
                <p className="bg-green-500/20 px-0 py-0.5 rounded-full text-xs text-green-600 border border-green-500/30">Admin</p>
            </div>
            <p>Content Creator</p>
        </div>
...
export const CreateNewProjectForm = () => (<form
    ...
    <div className="flex items-center justify-between">
        <button type="submit" className="my-3 bg-indigo-500 ps-2 px-5 rounded text-white font-medium">Post</button>
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <button type="button"
            className="w-full me-3 bg-gray-800 active:scale-95 transition py-2.5 rounded text-white">Send Email
    </button>
...
export const OtpVerificationForm = () => (<div
    ...
    <button type="button"
            className="ml-8 w-full max-w-80 h-11 rounded-full text-white text-sm bg-indigo-500 hover:opacity-90 transition-opacity">
        Verify Email
    </button>
</div>)
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        ...
        <button type="button"
                className="px-60 py-2 bg-indigo-500 hover:bg-indigo-600 active:scale-95 transition-all text-white rounded">
            Upload File
        </button>
    </div>
</div>)
...
export const PopUpConfirmationModal = () => (<div
    className="flex flex-col items-center bg-white shadow-md rounded-xl py-6 pt-5 md:w-[460px] w-[370px] border border-gray-200">
...
export const SubscriptionCard = () => (<div
    ...
    <h1 className="text-xl font-semibold mt-0 text-gray-800">Subscribe for updates</h1>
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="css"
               className="cursor-pointer rounded py-18 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">CSS</label>
    </div>
    <div className="flex items-center">
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            <button className="bg-slate-100 text-slate-600 py-10">
                Add to cart
            </button>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <p className="text-gray-500 ms-2">Nostrud amet eu ullamco nisi aute in ad minim nostrud adipisicing velit
