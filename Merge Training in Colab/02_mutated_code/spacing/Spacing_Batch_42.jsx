...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pl-27 text-sm rounded border border-gray-300/60">
...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full ps-1 pr-3 text-sm text-slate-500">
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white pe-2 px-4 border border-gray-200 rounded-lg">
...
export const DownloadButton1 = () => (<button type="button"
                                              className="flex items-center justify-between text-gray-800/80 text-sm h-10 w-36 pt-4 bg-white border active:scale-95 transition border-gray-500/30">
    Download
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-sm/6 me-2 ml-2 mb-2">
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="font-medium mt-15">Kelvin John</p>
    ...
    <div
        ...
        <div className="flex items-center w-full justify-between">
            ...
            <div className="flex items-center gap-2">
                <p>$800.00</p>
                <p className="bg-red-500/20 px-3 py-0 rounded border border-red-500/30 text-red-600">Overdue</p>
            </div>
        </div>
    </div>
</div>)
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        ...
        <button type="button"
                className="font-medium px-1 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 transition active:scale-95">Settings
        </button>
    </div>
    <button type="button"
...
export const TeamMemberCard3 = () => (<div
    ...
    <div className="flex items-center divide-x divide-gray-500/30">
        <button type="button" className="flex items-center justify-center gap-2 w-1/2 py-24">
...
export const CreateNewProjectForm = () => (<form
    className="bg-white text-gray-500 max-w-[340px] mx-4 py-6 text-left text-sm rounded-lg border border-gray-300/60">
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border mt-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-18 px-4"
...
export const UploadAreaWithTitle = () => (<div
    ...
    <label htmlFor="fileInput"
           className="border-2 border-dotted border-gray-400 pe-8 mt-6 flex flex-col items-center gap-4 cursor-pointer hover:border-blue-500 transition">
...
export const ModernSignUpForm = () => (<form
    className="bg-white text-gray-500 w-full max-w-[340px] mx-4 md:p-6 p-4 py-1 text-left text-sm rounded-lg shadow-[0px_0px_10px_0px] shadow-black/10">
...
export const PopUpConfirmationModal = () => (<div
    className="flex flex-col items-center bg-white shadow-md rounded-xl py-60 px-5 md:w-[460px] w-[370px] border border-gray-200">
...
export const SubscriptionCard = () => (<div
    ...
    <input type="email" placeholder="Enter your email id"
           className="text-sm border border-gray-500/30 max-w-80 w-full px-18 h-10 outline-none rounded mt-4"/>
    <button type="button"
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="react"
               className="cursor-pointer rounded py-2 px-0 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">React</label>
    </div>
</div>)
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            <button className="bg-slate-800 text-white px-2">
                Buy now
            </button>
        </div>
    </div>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            <input
                className="px-2 px-3 w-full outline-none focus:border-indigo-500/60 transition max-w-64 border border-gray-500/30 rounded-md"
