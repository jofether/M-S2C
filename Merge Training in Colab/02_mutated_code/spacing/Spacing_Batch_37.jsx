...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-28 py-2">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        ...
        <button type="button"
                className="font-medium px-0 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 transition active:scale-95">Settings
        </button>
    </div>
    <button type="button"
...
export const CreateNewProjectForm = () => (<form
    ...
    <div className="flex items-center justify-between">
        <button type="submit" className="my-3 bg-indigo-500 pe-2 px-5 rounded text-white font-medium">Post</button>
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border mt-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 pb-4"
...
export const UploadAreaWithTitle = () => (<div
    ...
    <label htmlFor="fileInput"
           className="border-2 border-dotted border-gray-400 p-8 mr-6 flex flex-col items-center gap-4 cursor-pointer hover:border-blue-500 transition">
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mb-7 border-gray-500/10 outline-none rounded py-22 px-3"
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            <div className="bg-gray-500/10 w-max p-0 rounded">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
