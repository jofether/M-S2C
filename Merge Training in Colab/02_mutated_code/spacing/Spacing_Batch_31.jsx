...
export const Notification = () => (<div
    ...
    <div className="ps-2 flex justify-center flex-col pr-3">
...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full p-7 pr-3 text-sm text-slate-500">
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-0 ml-2 px-6 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 ps-2">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        ...
        <button type="button"
                className="font-medium py-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 transition active:scale-95">Settings
        </button>
    </div>
    <button type="button"
...
export const CreateNewProjectForm = () => (<form
    className="bg-white text-gray-500 max-w-[340px] mx-0 p-6 text-left text-sm rounded-lg border border-gray-300/60">
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <h2 className="text-2xl font-semibold mx-6 text-center text-gray-800">Forget Password?</h2>
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        <button type="button"
                className="pt-9 py-2 border border-gray-500/50 bg-white hover:bg-blue-100/30 active:scale-95 transition-all text-gray-500 rounded">
            Cancel
        </button>
        <button type="button"
...
export const ModernSignUpForm = () => (<form
    ...
    <p className="text-center mr-4">Already have an account? <a href="#" className="text-blue-500 underline">Log
        In</a></p>
</form>)
...
export const SubscriptionCard = () => (<div
    ...
    <h1 className="text-sm mt-0">Subscribe to this weekly news letter so you don’t<br/>miss out on the new hot tech
        topics.</h1>
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="html"
               className="cursor-pointer rounded py-2 px-1 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">HTML</label>
    </div>
    <div className="flex items-center">
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <p className="text-gray-500 mt-0">Nostrud amet eu ullamco nisi aute in ad minim nostrud adipisicing velit
