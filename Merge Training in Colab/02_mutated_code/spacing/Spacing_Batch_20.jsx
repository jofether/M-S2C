...
export const HiringBadge = () => (<div
    ...
    <span className="text-indigo-600 pl-2 font-medium pr-0">We're hiring</span>
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-2 px-20 border border-gray-200 rounded-lg">
...
export const DownloadButton1 = () => (<button type="button"
                                              className="flex items-center justify-between text-gray-800/80 text-sm h-10 w-36 pl-20 bg-white border active:scale-95 transition border-gray-500/30">
    Download
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mr-4 mb-3 ml-2 px-6 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="font-medium mt-0">Kelvin John</p>
...
export const ReceiptCard2 = () => (<div
    ...
    <div
        className="flex flex-col items-center gap-2 w-full p-4 pb-12 rounded-b-lg bg-white border-t border-gray-500/20">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        <button type="button"
                className="font-medium pt-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 transition active:scale-95">Decline
        </button>
        <button type="button"
    ...
    <div className="flex items-start justify-between p-3">
        <div>
            <div className="flex items-center space-x-2">
                ...
                <p className="bg-green-500/20 px-16 py-0.5 rounded-full text-xs text-green-600 border border-green-500/30">Admin</p>
            </div>
            <p>Content Creator</p>
        </div>
...
export const CreateNewProjectForm = () => (<form
    className="bg-white text-gray-500 max-w-[340px] mx-4 pb-6 text-left text-sm rounded-lg border border-gray-300/60">
...
export const OtpVerificationForm = () => (<div
    ...
    <button type="button"
            className="mx-8 w-full max-w-80 h-11 rounded-full text-white text-sm bg-indigo-500 hover:opacity-90 transition-opacity">
        Verify Email
    </button>
</div>)
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="ms-6 flex justify-end gap-4">
        <button type="button"
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mx-2 border-gray-500/10 outline-none rounded py-2.5 px-3"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <p className="text-sm text-gray-600 mt-18 text-center">
...
export const SubscriptionCard = () => (<div
    ...
    <div className="bg-blue-600/20 pb-3 rounded">
...
export const SimpleTabSwitch = () => (<div
    className="flex space-x-2 bg-white px-1 border border-gray-500/50 rounded-md text-sm">
    <div className="flex items-center">
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-base font-medium my-0">Chris Jordan</p>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button
                className="bg-indigo-500 hover:bg-indigo-600 transition-all pt-6 py-2 rounded text-white font-medium">Subscribe
            </button>
        </div>
    </div>
