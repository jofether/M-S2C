...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-sm/6 mt-2 ml-12 mb-2">
...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full pb-4 py-2">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 w-full py-2 mt-20 rounded text-white font-medium active:scale-95 transition">Accept
    </button>
</div>)
...
export const CreateNewProjectForm = () => (<form
    className="bg-white text-gray-500 max-w-[340px] mx-4 p-54 text-left text-sm rounded-lg border border-gray-300/60">
...
export const OtpVerificationForm = () => (<div
    ...
    <div className="grid grid-cols-6 gap-2 sm:gap-3 w-11/12 mt-0">
...
export const PopUpConfirmationModal = () => (<div
    ...
    <div className="flex items-center justify-center px-4 bg-red-100 rounded-full">
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            <button className="bg-slate-100 text-slate-600 px-2">
                Add to cart
            </button>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            <input
                className="py-2 pt-3 w-full outline-none focus:border-indigo-500/60 transition max-w-64 border border-gray-500/30 rounded-md"
