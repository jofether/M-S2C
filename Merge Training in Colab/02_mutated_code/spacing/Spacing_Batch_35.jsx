...
export const Notification = () => (<div
    ...
    <div className="pl-2 flex justify-center flex-col pr-3">
...
export const HiringBadge = () => (<div
    ...
    <a href="#" className="flex items-center gap-1 px-1">
        See open positions
        <svg className="mt-10" width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-10 px-4 border border-gray-200 rounded-lg">
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="font-medium mt-30">Kelvin John</p>
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        <button type="button"
                className="font-medium py-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 transition active:scale-95">Decline
        </button>
        <button type="button"
    ...
    <div className="flex items-start justify-between p-3">
        <div>
            <div className="flex items-center space-x-2">
                ...
                <p className="bg-green-500/20 py-2 py-0.5 rounded-full text-xs text-green-600 border border-green-500/30">Admin</p>
            </div>
            <p>Content Creator</p>
        </div>
...
export const CreateNewProjectForm = () => (<form
    ...
    <div className="flex items-center justify-between">
        <button type="submit" className="my-24 bg-indigo-500 py-2 px-5 rounded text-white font-medium">Post</button>
...
export const ForgotPasswordFromDark = () => (<div
    className="bg-white text-gray-500 max-w-96 mx-4 md:p-6 p-20 text-left text-sm rounded shadow-[0px_0px_10px_0px] shadow-black/10">
...
export const OtpVerificationForm = () => (<div
    className="flex flex-col items-center md:max-w-[423px] w-[380px] bg-white rounded-2xl shadow-lg pe-6 sm:p-10">
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-9 bg-indigo-500/5 mb-7 border-gray-500/10 outline-none rounded py-2.5 px-3"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <p className="text-sm text-gray-600 mx-2 text-center">
...
export const SubscriptionCard = () => (<div
    className="flex flex-col items-start bg-white text-gray-500 shadow-[0px_1px_4px_0px] shadow-black/20 rounded-xl px-6">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="react"
               className="cursor-pointer rounded py-20 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">React</label>
    </div>
</div>)
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            <input
                className="py-2 px-27 w-full outline-none focus:border-indigo-500/60 transition max-w-64 border border-gray-500/30 rounded-md"
