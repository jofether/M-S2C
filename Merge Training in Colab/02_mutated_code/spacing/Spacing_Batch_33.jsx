...
export const SuccessAlertLightFill = () => (<div
    ...
    <div className="flex items-center">
        ...
        <p className="text-sm my-2">Success! Your task is fully completed.</p>
    </div>
...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x py-3 text-sm rounded border border-gray-300/60">
...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full p-1 pr-18 text-sm text-slate-500">
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-2 py-4 border border-gray-200 rounded-lg">
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-20 px-6 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)

export const UserProfileCardRounded2 = () => (<div
    className="bg-white rounded-2xl pe-4 overflow-hidden border border-gray-200 hover:-translate-y-1 transition duration-300">
    ...
    <div
        ...
        <div className="flex items-center w-full justify-between">
            ...
            <div className="flex items-center gap-2">
                <p>$800.00</p>
                <p className="bg-red-500/20 py-3 py-0.5 rounded border border-red-500/30 text-red-600">Overdue</p>
            </div>
        </div>
    </div>
</div>)
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 w-full ps-2 mt-4 rounded text-white font-medium active:scale-95 transition">Accept
    </button>
</div>)
...
export const TeamMemberCard3 = () => (<div
    ...
    <div className="flex items-center divide-x divide-gray-500/30">
        ...
        <button type="button" className="flex items-center justify-center gap-2 w-1/2 ps-3">
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 px-18"
...
export const OtpVerificationForm = () => (<div
    ...
    <button type="button"
            className="mt-0 w-full max-w-80 h-11 rounded-full text-white text-sm bg-indigo-500 hover:opacity-90 transition-opacity">
        Verify Email
    </button>
</div>)
...
export const ModernSignUpForm = () => (<form
    ...
    <h2 className="text-2xl font-bold ml-6 text-center text-gray-800">Sign Up</h2>
...
export const PopUpConfirmationModal = () => (<div
    className="flex flex-col items-center bg-white shadow-md rounded-xl py-6 px-35 md:w-[460px] w-[370px] border border-gray-200">
...
export const SubscriptionCard = () => (<div
    ...
    <h1 className="text-sm ms-3">Subscribe to this weekly news letter so you don’t<br/>miss out on the new hot tech
        topics.</h1>
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="react"
               className="cursor-pointer rounded py-12 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">React</label>
    </div>
</div>)
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            <button className="bg-slate-800 text-white py-20">
                Buy now
            </button>
        </div>
    </div>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button
                className="bg-indigo-500 hover:bg-indigo-600 transition-all px-6 pl-2 rounded text-white font-medium">Subscribe
            </button>
        </div>
    </div>
