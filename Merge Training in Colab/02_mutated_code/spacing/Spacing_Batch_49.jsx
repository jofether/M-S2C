...
export const Notification = () => (<div
    ...
    <div className="py-15 flex justify-center flex-col pr-3">
...
export const HiringBadge = () => (<div
    ...
    <span className="text-indigo-600 pl-0 font-medium pr-1">We're hiring</span>
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-sm/6 mt-2 ml-2 mb-12">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        ...
        <button type="button"
                className="font-medium pb-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 transition active:scale-95">Settings
        </button>
    </div>
    <button type="button"
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 pb-3"
...
export const ForgotPasswordFromDark = () => (<div
    className="bg-white text-gray-500 max-w-96 mx-4 md:p-54 p-4 text-left text-sm rounded shadow-[0px_0px_10px_0px] shadow-black/10">
...
export const ModernSignUpForm = () => (<form
    ...
    <h2 className="text-2xl font-bold mx-6 text-center text-gray-800">Sign Up</h2>
...
export const PopUpConfirmationModal = () => (<div
    ...
    <h2 className="text-gray-900 font-semibold mt-32 text-xl">Are you sure?</h2>
...
export const SubscriptionCard = () => (<div
    ...
    <h1 className="text-xl font-semibold mt-36 text-gray-800">Subscribe for updates</h1>
...
export const SimpleTabSwitch = () => (<div
    className="flex space-x-2 bg-white p-7 border border-gray-500/50 rounded-md text-sm">
    <div className="flex items-center">
