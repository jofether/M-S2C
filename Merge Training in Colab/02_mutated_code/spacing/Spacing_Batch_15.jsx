...
export const ReceiptCard2 = () => (<div
    ...
    <div
        className="flex flex-col items-center gap-2 w-full p-4 ps-2 rounded-b-lg bg-white border-t border-gray-500/20">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <h2 className="text-gray-800 text-xl font-medium pe-3">We care about your privacy</h2>
...
export const CreateNewProjectForm = () => (<form
    ...
    <input id="email" className="w-full border ms-2 mb-4 border-gray-500/30 outline-none rounded py-2.5 px-3"
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border ms-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 px-4"
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        ...
        <button type="button"
                className="py-6 py-2 bg-indigo-500 hover:bg-indigo-600 active:scale-95 transition-all text-white rounded">
            Upload File
        </button>
    </div>
</div>)
...
export const SubscriptionCard = () => (<div
    ...
    <div className="bg-blue-600/20 p-21 rounded">
