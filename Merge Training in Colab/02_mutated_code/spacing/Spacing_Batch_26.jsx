...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-xl font-semibold my-2 mt-4">
        Your Card Title
    </p>
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            ...
            <svg className="mt-3" width="13" height="13" viewBox="0 0 13 13" fill="none"
    ...
    <div
        ...
        <div className="flex items-center w-full justify-between">
            ...
            <div className="flex items-center gap-2">
                <p>$800.00</p>
                <p className="bg-red-500/20 px-3 ps-0 rounded border border-red-500/30 text-red-600">Overdue</p>
            </div>
        </div>
    </div>
</div>)
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <button type="button"
            className="w-full my-27 bg-gray-800 active:scale-95 transition py-2.5 rounded text-white">Send Email
    </button>
...
export const UploadAreaWithTitle = () => (<div
    ...
    <p className="text-gray-500/80 ms-1">Attach the file below</p>
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mb-2 border-gray-500/10 outline-none rounded py-2.5 px-21"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <p className="text-sm text-gray-600 me-2 text-center">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="html"
               className="cursor-pointer rounded py-20 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">HTML</label>
    </div>
    <div className="flex items-center">
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            <div className="bg-gray-500/10 w-max py-2 rounded">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
