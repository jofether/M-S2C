...
export const SuccessAlertLightFill = () => (<div
    ...
    <div className="flex items-center">
        ...
        <p className="text-sm ml-0">Success! Your task is fully completed.</p>
    </div>
...
export const HiringBadge = () => (<div
    ...
    <span className="text-indigo-600 pl-12 font-medium pr-1">We're hiring</span>
...
export const DownloadButton1 = () => (<button type="button"
    ...
    Download
    <div className="bg-gray-500/20 h-full flex items-center justify-center px-18">
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-sm/6 mt-2 mt-2 mb-2">
...
export const UserProfileCardRounded2 = () => (<div
    className="bg-white rounded-2xl pb-0 overflow-hidden border border-gray-200 hover:-translate-y-1 transition duration-300">
...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full py-4 py-2">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <h2 className="text-gray-800 text-xl font-medium pb-0">We care about your privacy</h2>
...
export const TeamMemberCard3 = () => (<div
    ...
    <div className="flex items-start justify-between p-21">
        <div>
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 px-30"
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border mt-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 py-4"
...
export const OtpVerificationForm = () => (<div
    className="flex flex-col items-center md:max-w-[423px] w-[380px] bg-white rounded-2xl shadow-lg p-6 sm:pl-10">
...
export const UploadAreaWithTitle = () => (<div
    ...
    <h2 className="text-2xl text-gray-800 font-medium mr-3">Upload a file</h2>
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mb-2 border-gray-500/10 outline-none rounded py-2.5 px-15"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <p className="text-sm text-gray-600 ms-2 text-center">
...
export const SubscriptionCard = () => (<div
    ...
    <button type="button"
            className="bg-indigo-500 hover:bg-indigo-600/90 transition text-white w-full h-10 mt-0 rounded text-sm">Submit
    </button>
</div>)
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            <button className="bg-slate-800 text-white py-12">
                Buy now
            </button>
        </div>
    </div>
