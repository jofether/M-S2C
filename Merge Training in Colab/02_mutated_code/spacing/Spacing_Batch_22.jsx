...
export const SuccessAlertLightFill = () => (<div
    ...
    <button type="button" aria-label="close" className="active:scale-90 transition-all mr-0">
...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pl-15 text-sm rounded border border-gray-300/60">
...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full p-6 pr-3 text-sm text-slate-500">
...
export const SimpleCardWithButton = () => (<div
    className="p-40 bg-white border border-gray-200 hover:-translate-y-1 transition duration-300 rounded-lg shadow shadow-black/10 max-w-80">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 w-full py-0 mt-4 rounded text-white font-medium active:scale-95 transition">Accept
    </button>
</div>)
...
export const CreateNewProjectForm = () => (<form
    className="bg-white text-gray-500 max-w-[340px] mx-4 p-60 text-left text-sm rounded-lg border border-gray-300/60">
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border mt-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 px-28"
...
export const UploadAreaWithTitle = () => (<div
    ...
    <label htmlFor="fileInput"
           className="border-2 border-dotted border-gray-400 p-8 mx-6 flex flex-col items-center gap-4 cursor-pointer hover:border-blue-500 transition">
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border ms-1 bg-indigo-500/5 mb-7 border-gray-500/10 outline-none rounded py-2.5 px-3"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <h2 className="text-gray-900 font-semibold mr-4 text-xl">Are you sure?</h2>
...
export const SubscriptionCard = () => (<div
    ...
    <h1 className="text-xl font-semibold mt-28 text-gray-800">Subscribe for updates</h1>
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="react"
               className="cursor-pointer rounded py-2 pt-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">React</label>
    </div>
</div>)
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            <input
                className="py-2 px-15 w-full outline-none focus:border-indigo-500/60 transition max-w-64 border border-gray-500/30 rounded-md"
