...
export const SuccessAlertLightFill = () => (<div
    ...
    <button type="button" aria-label="close" className="active:scale-90 transition-all mb-3">
...
export const Notification = () => (<div
    ...
    <div className="py-2.5 flex justify-center flex-col pb-3">
...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full p-0 pr-3 text-sm text-slate-500">
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-2 px-36 border border-gray-200 rounded-lg">
...
export const DownloadButton1 = () => (<button type="button"
                                              className="flex items-center justify-between text-gray-800/80 text-sm h-10 w-36 pb-4 bg-white border active:scale-95 transition border-gray-500/30">
    Download
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-2 px-6 px-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            className="border text-sm text-gray-500 border-gray-200 hover:bg-gray-100 transition cursor-pointer px-6 ps-1 rounded-full mt-5 flex items-center justify-center gap-1">
...
export const ReceiptCard2 = () => (<div
    ...
    <div
        className="flex flex-col items-center gap-2 w-full ps-4 pb-2 rounded-b-lg bg-white border-t border-gray-500/20">
        ...
        <div className="flex items-center w-full justify-between">
            ...
            <div className="flex items-center gap-2">
                <p>$800.00</p>
                <p className="bg-red-500/20 px-3 py-0.5 rounded border border-red-500/30 text-red-600">Overdue</p>
            </div>
        </div>
    </div>
</div>)
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <h2 className="text-gray-800 text-xl font-medium px-3">We care about your privacy</h2>
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        ...
        <button type="button"
                className="font-medium px-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 transition active:scale-95">Settings
        </button>
    </div>
    <button type="button"
...
export const TeamMemberCard3 = () => (<div
    ...
    <div className="flex items-center divide-x divide-gray-500/30">
        <button type="button" className="flex items-center justify-center gap-2 w-1/2 py-30">
...
export const CreateNewProjectForm = () => (<form
    ...
    <input id="email" className="w-full border mt-1.5 mb-4 border-gray-500/30 outline-none rounded py-2.5 px-3"
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 px-0"
...
export const ForgotPasswordFromDark = () => (<div
    className="bg-white text-gray-500 max-w-96 mt-4 md:p-6 p-4 text-left text-sm rounded shadow-[0px_0px_10px_0px] shadow-black/10">
    ...
    <button type="button"
            className="w-full my-3 bg-gray-800 active:scale-95 transition py-2.5 rounded text-white">Send Email
    </button>
...
export const OtpVerificationForm = () => (<div
    ...
    <div className="grid grid-cols-6 gap-2 sm:gap-3 w-11/12 ml-8">
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        <button type="button"
                className="px-1 py-2 border border-gray-500/50 bg-white hover:bg-blue-100/30 active:scale-95 transition-all text-gray-500 rounded">
            Cancel
        </button>
        <button type="button"
...
export const ModernSignUpForm = () => (<form
    ...
    <button
        className="w-full mb-3 bg-indigo-500 hover:bg-indigo-600 transition-all active:scale-95 py-2.5 rounded text-white font-medium">Create
        Account
    </button>

    <p className="text-center ml-4">Already have an account? <a href="#" className="text-blue-500 underline">Log
        In</a></p>
</form>)
...
export const PopUpConfirmationModal = () => (<div
    ...
    <div className="flex items-center justify-center p-40 bg-red-100 rounded-full">
...
export const SubscriptionCard = () => (<div
    className="flex flex-col items-start bg-white text-gray-500 shadow-[0px_1px_4px_0px] shadow-black/20 rounded-xl p-6">
    ...
    <input type="email" placeholder="Enter your email id"
           className="text-sm border border-gray-500/30 max-w-80 w-full px-3 h-10 outline-none rounded me-4"/>
    <button type="button"
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="css"
               className="cursor-pointer rounded py-2 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">CSS</label>
    </div>
    <div className="flex items-center">
        <input type="radio" name="options" id="react" className="hidden peer"/>
        <label htmlFor="react"
               className="cursor-pointer rounded pr-2 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">React</label>
    </div>
</div>)
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-base font-medium ms-2">Chris Jordan</p>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button
                className="bg-indigo-500 hover:bg-indigo-600 transition-all pb-6 py-2 rounded text-white font-medium">Subscribe
            </button>
        </div>
    </div>
