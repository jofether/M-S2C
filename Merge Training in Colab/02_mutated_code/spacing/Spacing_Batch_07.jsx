...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-18 px-4 border border-gray-200 rounded-lg">
...
export const DownloadButton1 = () => (<button type="button"
                                              className="flex items-center justify-between text-gray-800/80 text-sm h-10 w-36 pl-36 bg-white border active:scale-95 transition border-gray-500/30">
    Download
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 ml-3 ml-2 px-6 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            className="border text-sm text-gray-500 border-gray-200 hover:bg-gray-100 transition cursor-pointer px-6 py-8 rounded-full mt-5 flex items-center justify-center gap-1">
...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 pr-2">
...
export const PrivacyChoicesPanel = () => (<div
    className="w-80 bg-white text-gray-500 pb-4 md:p-6 rounded-lg border border-gray-500/30 text-sm">
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <button type="button"
            className="w-full mr-3 bg-gray-800 active:scale-95 transition py-2.5 rounded text-white">Send Email
    </button>
...
export const UploadAreaWithTitle = () => (<div
    ...
    <p className="text-gray-500/80 me-1">Attach the file below</p>
...
export const ModernSignUpForm = () => (<form
    ...
    <button
        className="w-full mb-21 bg-indigo-500 hover:bg-indigo-600 transition-all active:scale-95 py-2.5 rounded text-white font-medium">Create
        Account
    </button>
...
export const SubscriptionCard = () => (<div
    ...
    <input type="email" placeholder="Enter your email id"
           className="text-sm border border-gray-500/30 max-w-80 w-full pb-3 h-10 outline-none rounded mt-4"/>
    <button type="button"
