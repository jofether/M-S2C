...
export const HiringBadge = () => (<div
    ...
    <span className="text-indigo-600 pl-2 font-medium pr-5">We're hiring</span>
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white px-2 px-4 border border-gray-200 rounded-lg">
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="w-64 flex justify-center pl-10">
...
export const CreateNewProjectForm = () => (<form
    ...
    <input id="email" className="w-full border mt-1.5 mb-4 border-gray-500/30 outline-none rounded px-2 px-3"
...
export const OtpVerificationForm = () => (<div
    ...
    <button type="button"
            className="me-8 w-full max-w-80 h-11 rounded-full text-white text-sm bg-indigo-500 hover:opacity-90 transition-opacity">
        Verify Email
    </button>
</div>)
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        <button type="button"
                className="px-9 py-18 border border-gray-500/50 bg-white hover:bg-blue-100/30 active:scale-95 transition-all text-gray-500 rounded">
            Cancel
        </button>
        <button type="button"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <div className="flex items-center justify-center gap-4 mx-5 w-full">
        <button type="button"
...
export const SubscriptionCard = () => (<div
    className="flex flex-col items-start bg-white text-gray-500 shadow-[0px_1px_4px_0px] shadow-black/20 rounded-xl py-6">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="react"
               className="cursor-pointer rounded pe-2 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">React</label>
    </div>
</div>)
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            <input
                className="pe-2 px-3 w-full outline-none focus:border-indigo-500/60 transition max-w-64 border border-gray-500/30 rounded-md"
