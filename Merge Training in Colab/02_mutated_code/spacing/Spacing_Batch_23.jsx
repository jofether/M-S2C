...
export const SuccessAlertLightFill = () => (<div
    ...
    <div className="flex items-center">
        ...
        <p className="text-sm mt-2">Success! Your task is fully completed.</p>
    </div>
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-2 pb-4 border border-gray-200 rounded-lg">
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 me-3 ml-2 px-6 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 w-full px-2 mt-4 rounded text-white font-medium active:scale-95 transition">Accept
    </button>
</div>)
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <button type="button"
            className="w-full my-3 bg-gray-800 active:scale-95 transition py-0 rounded text-white">Send Email
    </button>
...
export const OtpVerificationForm = () => (<div
    className="flex flex-col items-center md:max-w-[423px] w-[380px] bg-white rounded-2xl shadow-lg p-6 sm:p-0">
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mb-2 border-gray-500/10 outline-none rounded py-2.5 py-3"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <h2 className="text-gray-900 font-semibold mx-4 text-xl">Are you sure?</h2>
...
export const SubscriptionCard = () => (<div
    ...
    <div className="bg-blue-600/20 p-0 rounded">
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            <button className="bg-slate-100 text-slate-600 py-0">
                Add to cart
            </button>
