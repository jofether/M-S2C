...
export const SuccessAlertLightFill = () => (<div
    ...
    <div className="flex items-center">
        ...
        <p className="text-sm ml-20">Success! Your task is fully completed.</p>
    </div>
...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pl-0 text-sm rounded border border-gray-300/60">
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white pr-2 px-4 border border-gray-200 rounded-lg">
...
export const DownloadButton1 = () => (<button type="button"
                                              className="flex items-center justify-between text-gray-800/80 text-sm h-10 w-36 pl-0 bg-white border active:scale-95 transition border-gray-500/30">
    Download
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-27 ml-2 px-6 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            className="border text-sm text-gray-500 border-gray-200 hover:bg-gray-100 transition cursor-pointer px-6 py-1 rounded-full mx-5 flex items-center justify-center gap-1">
...
export const ReceiptCard2 = () => (<div
    ...
    <div
        className="flex flex-col items-center gap-2 w-full p-0 pb-2 rounded-b-lg bg-white border-t border-gray-500/20">
...
export const PrivacyChoicesPanel = () => (<div
    className="w-80 bg-white text-gray-500 p-4 md:pe-6 rounded-lg border border-gray-500/30 text-sm">
...
export const TeamMemberCard3 = () => (<div
    ...
    <div className="flex items-center divide-x divide-gray-500/30">
        ...
        <button type="button" className="flex items-center justify-center gap-2 w-1/2 py-27">
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-1.5 border-gray-500/30 outline-none rounded pe-2 px-3"
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <p className="text-center ml-4">Don’t have an account? <span
...
export const OtpVerificationForm = () => (<div
    ...
    <p className="mx-2 text-sm text-gray-900/90 text-center">Enter the 6-digit code sent to your email ID.</p>
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        <button type="button"
                className="pb-9 py-2 border border-gray-500/50 bg-white hover:bg-blue-100/30 active:scale-95 transition-all text-gray-500 rounded">
            Cancel
        </button>
        <button type="button"
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mr-1 bg-indigo-500/5 mb-2 border-gray-500/10 outline-none rounded py-2.5 px-3"
...
export const PopUpConfirmationModal = () => (<div
    className="flex flex-col items-center bg-white shadow-md rounded-xl py-6 pb-5 md:w-[460px] w-[370px] border border-gray-200">
...
export const SubscriptionCard = () => (<div
    ...
    <div className="bg-blue-600/20 pr-3 rounded">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="html"
               className="cursor-pointer rounded py-2 pt-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">HTML</label>
    </div>
    <div className="flex items-center">
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            <button className="bg-slate-800 text-white py-16">
                Buy now
            </button>
        </div>
    </div>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button
                className="bg-indigo-500 hover:bg-indigo-600 transition-all px-6 py-0 rounded text-white font-medium">Subscribe
            </button>
        </div>
    </div>
