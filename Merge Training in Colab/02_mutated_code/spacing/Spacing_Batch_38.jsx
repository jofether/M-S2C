...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full p-9 pr-3 text-sm text-slate-500">
...
export const DownloadButton1 = () => (<button type="button"
    ...
    Download
    <div className="bg-gray-500/20 h-full flex items-center justify-center px-24">
...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 pe-2">
...
export const OtpVerificationForm = () => (<div
    ...
    <p className="mr-2 text-sm text-gray-900/90 text-center">Enter the 6-digit code sent to your email ID.</p>
...
export const ModernSignUpForm = () => (<form
    className="bg-white text-gray-500 w-full max-w-[340px] mx-0 md:p-6 p-4 py-8 text-left text-sm rounded-lg shadow-[0px_0px_10px_0px] shadow-black/10">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="css"
               className="cursor-pointer rounded px-2 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">CSS</label>
    </div>
    <div className="flex items-center">
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button
                className="bg-indigo-500 hover:bg-indigo-600 transition-all px-6 py-16 rounded text-white font-medium">Subscribe
            </button>
        </div>
    </div>
