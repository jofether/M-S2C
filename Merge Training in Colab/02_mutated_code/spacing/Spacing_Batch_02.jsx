...
export const SuccessAlertLightFill = () => (<div
    ...
    <button type="button" aria-label="close" className="active:scale-90 transition-all mr-27">
...
export const Notification = () => (<div
    ...
    <div className="pe-2 flex justify-center flex-col pr-3">
...
export const HiringBadge = () => (<div
    ...
    <a href="#" className="flex items-center gap-1 px-1">
        See open positions
        <svg className="me-1" width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-sm/6 mt-2 ml-2 mb-18">
...
export const ReceiptCard2 = () => (<div
    ...
    <div
        className="flex flex-col items-center gap-2 w-full p-4 pb-0 rounded-b-lg bg-white border-t border-gray-500/20">
...
export const PrivacyChoicesPanel = () => (<div
    className="w-80 bg-white text-gray-500 p-4 md:pt-6 rounded-lg border border-gray-500/30 text-sm">
...
export const CreateNewProjectForm = () => (<form
    ...
    <input id="email" className="w-full border mt-1.5 mb-4 border-gray-500/30 outline-none rounded pe-2 px-3"
...
export const ForgotPasswordFromDark = () => (<div
    className="bg-white text-gray-500 max-w-96 my-4 md:p-6 p-4 text-left text-sm rounded shadow-[0px_0px_10px_0px] shadow-black/10">
...
export const OtpVerificationForm = () => (<div
    className="flex flex-col items-center md:max-w-[423px] w-[380px] bg-white rounded-2xl shadow-lg pb-6 sm:p-10">
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border me-1 bg-indigo-500/5 mb-2 border-gray-500/10 outline-none rounded py-2.5 px-3"
...
export const SubscriptionCard = () => (<div
    className="flex flex-col items-start bg-white text-gray-500 shadow-[0px_1px_4px_0px] shadow-black/20 rounded-xl pb-6">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="html"
               className="cursor-pointer rounded px-2 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">HTML</label>
    </div>
    <div className="flex items-center">
