...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-sm/6 mt-2 mb-2 mb-2">
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            className="border text-sm text-gray-500 border-gray-200 hover:bg-gray-100 transition cursor-pointer px-6 py-1 rounded-full mr-5 flex items-center justify-center gap-1">
...
export const CreateNewProjectForm = () => (<form
    ...
    <div className="flex items-center justify-between">
        <button type="submit" className="my-3 bg-indigo-500 py-2 px-35 rounded text-white font-medium">Post</button>
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border mt-5 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 px-4"
...
export const ModernSignUpForm = () => (<form
    className="bg-white text-gray-500 w-full max-w-[340px] mx-4 md:p-6 p-4 px-8 text-left text-sm rounded-lg shadow-[0px_0px_10px_0px] shadow-black/10">
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            <div className="bg-gray-500/10 w-max pr-2 rounded">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
