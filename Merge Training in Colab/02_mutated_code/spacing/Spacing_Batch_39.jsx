...
export const Notification = () => (<div
    ...
    <div className="py-0 flex justify-center flex-col pr-3">
...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full pb-1 pr-3 text-sm text-slate-500">
...
export const SimpleCardWithButton = () => (<div
    className="p-0 bg-white border border-gray-200 hover:-translate-y-1 transition duration-300 rounded-lg shadow shadow-black/10 max-w-80">
    ...
    <div
        ...
        <div className="flex items-center w-full justify-between">
            ...
            <div className="flex items-center gap-2">
                <p>$800.00</p>
                <p className="bg-red-500/20 px-0 py-0.5 rounded border border-red-500/30 text-red-600">Overdue</p>
            </div>
        </div>
    </div>
</div>)
...
export const PrivacyChoicesPanel = () => (<div
    className="w-80 bg-white text-gray-500 pr-4 md:p-6 rounded-lg border border-gray-500/30 text-sm">
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-1.5 border-gray-500/30 outline-none rounded py-12 px-3"
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border ml-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 px-4"
...
export const UploadAreaWithTitle = () => (<div
    ...
    <label htmlFor="fileInput"
           className="border-2 border-dotted border-gray-400 ps-8 mt-6 flex flex-col items-center gap-4 cursor-pointer hover:border-blue-500 transition">
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mb-56 border-gray-500/10 outline-none rounded py-2.5 px-3"
...
export const PopUpConfirmationModal = () => (<div
    className="flex flex-col items-center bg-white shadow-md rounded-xl ps-6 px-5 md:w-[460px] w-[370px] border border-gray-200">
...
export const SubscriptionCard = () => (<div
    ...
    <div className="bg-blue-600/20 pe-3 rounded">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="react"
               className="cursor-pointer rounded py-2 py-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">React</label>
    </div>
</div>)
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            <button className="bg-slate-100 text-slate-600 ps-2">
                Add to cart
            </button>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button
                className="bg-indigo-500 hover:bg-indigo-600 transition-all px-6 pe-2 rounded text-white font-medium">Subscribe
            </button>
        </div>
    </div>
