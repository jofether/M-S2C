...
export const SuccessAlertLightFill = () => (<div
    ...
    <button type="button" aria-label="close" className="active:scale-90 transition-all mt-3">
...
export const Notification = () => (<div
    ...
    <div className="px-2 flex justify-center flex-col pr-3">
...
export const DownloadButton1 = () => (<button type="button"
    ...
    Download
    <div className="bg-gray-500/20 h-full flex items-center justify-center pb-3">
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mx-3 ml-2 px-6 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="w-64 flex justify-center pe-10">
...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 px-2">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        <button type="button"
                className="font-medium px-8 border border-gray-500/30 py-0 rounded hover:bg-blue-500/10 transition active:scale-95">Decline
        </button>
        <button type="button"
    ...
    <div className="flex items-start justify-between p-3">
        <div>
            <div className="flex items-center space-x-2">
                ...
                <p className="bg-green-500/20 pb-2 py-0.5 rounded-full text-xs text-green-600 border border-green-500/30">Admin</p>
            </div>
            <p>Content Creator</p>
        </div>
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border ml-2 border-gray-500/30 outline-none rounded py-2.5 px-3"
...
export const ForgotPasswordFromDark = () => (<div
    className="bg-white text-gray-500 max-w-96 mx-32 md:p-6 p-4 text-left text-sm rounded shadow-[0px_0px_10px_0px] shadow-black/10">
...
export const OtpVerificationForm = () => (<div
    ...
    <button type="button"
            className="ms-8 w-full max-w-80 h-11 rounded-full text-white text-sm bg-indigo-500 hover:opacity-90 transition-opacity">
        Verify Email
    </button>
</div>)
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        <button type="button"
                className="px-0 py-2 border border-gray-500/50 bg-white hover:bg-blue-100/30 active:scale-95 transition-all text-gray-500 rounded">
            Cancel
        </button>
        <button type="button"
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mb-2 border-gray-500/10 outline-none rounded px-2 px-3"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <h2 className="text-gray-900 font-semibold mt-20 text-xl">Are you sure?</h2>
...
export const SubscriptionCard = () => (<div
    ...
    <h1 className="text-sm mt-30">Subscribe to this weekly news letter so you don’t<br/>miss out on the new hot tech
        topics.</h1>
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="html"
               className="cursor-pointer rounded py-12 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">HTML</label>
    </div>
    <div className="flex items-center">
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <p className="text-gray-500 ml-2">Nostrud amet eu ullamco nisi aute in ad minim nostrud adipisicing velit
