...
export const SuccessAlertLightFill = () => (<div
    ...
    <div className="flex items-center">
        ...
        <p className="text-sm ml-14">Success! Your task is fully completed.</p>
    </div>
...
export const HiringBadge = () => (<div
    ...
    <a href="#" className="flex items-center gap-1 px-5">
        See open positions
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-2 py-6 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 py-14">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <h2 className="text-gray-800 text-xl font-medium pb-15">We care about your privacy</h2>
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 px-24"
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <h2 className="text-2xl font-semibold me-6 text-center text-gray-800">Forget Password?</h2>
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        ...
        <button type="button"
                className="px-6 pe-2 bg-indigo-500 hover:bg-indigo-600 active:scale-95 transition-all text-white rounded">
            Upload File
        </button>
    </div>
</div>)
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mb-7 border-gray-500/10 outline-none rounded py-12 px-3"
...
export const SubscriptionCard = () => (<div
    ...
    <div className="bg-blue-600/20 p-24 rounded">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="react"
               className="cursor-pointer rounded py-0 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">React</label>
    </div>
</div>)
