...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full p-10 pr-3 text-sm text-slate-500">
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-20 px-4 border border-gray-200 rounded-lg">
...
export const DownloadButton1 = () => (<button type="button"
                                              className="flex items-center justify-between text-gray-800/80 text-sm h-10 w-36 pl-40 bg-white border active:scale-95 transition border-gray-500/30">
    Download
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-sm/6 mt-2 ml-2 mx-2">
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            ...
            <svg className="mr-0" width="13" height="13" viewBox="0 0 13 13" fill="none"
...
export const PrivacyChoicesPanel = () => (<div
    className="w-80 bg-white text-gray-500 p-40 md:p-6 rounded-lg border border-gray-500/30 text-sm">
...
export const TeamMemberCard3 = () => (<div
    ...
    <div className="flex items-center divide-x divide-gray-500/30">
        ...
        <button type="button" className="flex items-center justify-center gap-2 w-1/2 py-0">
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-14 border-gray-500/30 outline-none rounded py-2.5 px-3"
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <button type="button"
            className="w-full my-3 bg-gray-800 active:scale-95 transition py-12 rounded text-white">Send Email
    </button>
...
export const PopUpConfirmationModal = () => (<div
    ...
    <div className="flex items-center justify-center p-28 bg-red-100 rounded-full">
...
export const SubscriptionCard = () => (<div
    ...
    <h1 className="text-sm mr-3">Subscribe to this weekly news letter so you don’t<br/>miss out on the new hot tech
        topics.</h1>
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="react"
               className="cursor-pointer rounded py-2 px-1 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">React</label>
    </div>
</div>)
