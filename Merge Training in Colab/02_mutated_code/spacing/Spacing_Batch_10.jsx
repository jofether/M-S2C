...
export const HiringBadge = () => (<div
    ...
    <span className="text-indigo-600 pb-2 font-medium pr-1">We're hiring</span>
    ...
    <div
        ...
        <div className="flex items-center w-full justify-between">
            ...
            <div className="flex items-center gap-2">
                <p>$800.00</p>
                <p className="bg-red-500/20 px-3 py-2 rounded border border-red-500/30 text-red-600">Overdue</p>
            </div>
        </div>
    </div>
</div>)
    ...
    <div className="flex items-start justify-between p-3">
        <div>
            <div className="flex items-center space-x-2">
                ...
                <p className="bg-green-500/20 px-2 py-4 rounded-full text-xs text-green-600 border border-green-500/30">Admin</p>
            </div>
            <p>Content Creator</p>
        </div>
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 py-3"
...
export const ForgotPasswordFromDark = () => (<div
    className="bg-white text-gray-500 max-w-96 mx-4 md:pt-6 p-4 text-left text-sm rounded shadow-[0px_0px_10px_0px] shadow-black/10">
...
export const OtpVerificationForm = () => (<div
    ...
    <button type="button"
            className="mt-1 w-full max-w-80 h-11 rounded-full text-white text-sm bg-indigo-500 hover:opacity-90 transition-opacity">
        Verify Email
    </button>
</div>)
...
export const PopUpConfirmationModal = () => (<div
    ...
    <div className="flex items-center justify-center gap-4 mt-40 w-full">
        <button type="button"
...
export const SubscriptionCard = () => (<div
    ...
    <div className="bg-blue-600/20 p-15 rounded">
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            <button className="bg-slate-100 text-slate-600 pr-2">
                Add to cart
            </button>
