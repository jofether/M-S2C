...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pl-30 text-sm rounded border border-gray-300/60">
...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full p-1 pr-21 text-sm text-slate-500">
...
export const DownloadButton1 = () => (<button type="button"
    ...
    Download
    <div className="bg-gray-500/20 h-full flex items-center justify-center px-30">
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-xl font-semibold mt-2 mt-4">
        Your Card Title
    </p>
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            className="border text-sm text-gray-500 border-gray-200 hover:bg-gray-100 transition cursor-pointer px-6 py-0 rounded-full mt-5 flex items-center justify-center gap-1">
...
export const ReceiptCard2 = () => (<div
    ...
    <div
        className="flex flex-col items-center gap-2 w-full pe-4 pb-2 rounded-b-lg bg-white border-t border-gray-500/20">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 w-full py-2 mt-0 rounded text-white font-medium active:scale-95 transition">Accept
    </button>
</div>)
    ...
    <div className="flex items-start justify-between p-3">
        <div>
            <div className="flex items-center space-x-2">
                ...
                <p className="bg-green-500/20 px-2 py-2 rounded-full text-xs text-green-600 border border-green-500/30">Admin</p>
            </div>
            <p>Content Creator</p>
        </div>
...
export const CreateNewProjectForm = () => (<form
    className="bg-white text-gray-500 max-w-[340px] mx-4 pe-6 text-left text-sm rounded-lg border border-gray-300/60">
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <p className="text-center mt-0">Don’t have an account? <span
...
export const OtpVerificationForm = () => (<div
    ...
    <div className="grid grid-cols-6 gap-2 sm:gap-3 w-11/12 me-8">
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        ...
        <button type="button"
                className="px-6 pl-2 bg-indigo-500 hover:bg-indigo-600 active:scale-95 transition-all text-white rounded">
            Upload File
        </button>
    </div>
</div>)
...
export const PopUpConfirmationModal = () => (<div
    className="flex flex-col items-center bg-white shadow-md rounded-xl py-6 px-0 md:w-[460px] w-[370px] border border-gray-200">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="css"
               className="cursor-pointer rounded py-10 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">CSS</label>
    </div>
    <div className="flex items-center">
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            <input
                className="pl-2 px-3 w-full outline-none focus:border-indigo-500/60 transition max-w-64 border border-gray-500/30 rounded-md"
