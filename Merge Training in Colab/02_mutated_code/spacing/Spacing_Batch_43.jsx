...
export const Notification = () => (<div
    ...
    <div className="py-2.5 flex justify-center flex-col pt-3">
...
export const HiringBadge = () => (<div
    ...
    <a href="#" className="flex items-center gap-1 px-1">
        See open positions
        <svg className="mt-6" width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-16 px-4 border border-gray-200 rounded-lg">
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-xl font-semibold ml-2 mt-40">
        Your Card Title
    </p>
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            className="border text-sm text-gray-500 border-gray-200 hover:bg-gray-100 transition cursor-pointer px-0 py-1 rounded-full mt-5 flex items-center justify-center gap-1">
...
export const ReceiptCard2 = () => (<div
    ...
    <div
        className="flex flex-col items-center gap-2 w-full p-4 pb-16 rounded-b-lg bg-white border-t border-gray-500/20">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        <button type="button"
                className="font-medium pb-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 transition active:scale-95">Decline
        </button>
        <button type="button"
...
export const TeamMemberCard3 = () => (<div
    ...
    <div className="flex items-center divide-x divide-gray-500/30">
        ...
        <button type="button" className="flex items-center justify-center gap-2 w-1/2 py-21">
...
export const CreateNewProjectForm = () => (<form
    ...
    <textarea rows="3" id="content"
              className="w-full resize-none border mt-1.5 border-gray-500/30 outline-none rounded py-0 px-3"
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border mt-9 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 px-4"
...
export const OtpVerificationForm = () => (<div
    ...
    <p className="me-2 text-sm text-gray-900/90 text-center">Enter the 6-digit code sent to your email ID.</p>
...
export const ModernSignUpForm = () => (<form
    ...
    <p className="text-center mt-28">Already have an account? <a href="#" className="text-blue-500 underline">Log
        In</a></p>
</form>)
...
export const SubscriptionCard = () => (<div
    className="flex flex-col items-start bg-white text-gray-500 shadow-[0px_1px_4px_0px] shadow-black/20 rounded-xl p-36">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="css"
               className="cursor-pointer rounded py-2 pt-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">CSS</label>
    </div>
    <div className="flex items-center">
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            <button className="bg-slate-100 text-slate-600 py-12">
                Add to cart
            </button>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <p className="text-gray-500 me-2">Nostrud amet eu ullamco nisi aute in ad minim nostrud adipisicing velit
