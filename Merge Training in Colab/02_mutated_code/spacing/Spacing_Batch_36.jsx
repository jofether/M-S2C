...
export const SuccessAlertLightFill = () => (<div
    ...
    <button type="button" aria-label="close" className="active:scale-90 transition-all mr-24">
...
export const HiringBadge = () => (<div
    ...
    <span className="text-indigo-600 pl-2 font-medium pt-1">We're hiring</span>
...
export const DownloadButton1 = () => (<button type="button"
    ...
    Download
    <div className="bg-gray-500/20 h-full flex items-center justify-center py-3">
...
export const SimpleCardWithButton = () => (<div
    className="pr-4 bg-white border border-gray-200 hover:-translate-y-1 transition duration-300 rounded-lg shadow shadow-black/10 max-w-80">
...
export const ReceiptCard2 = () => (<div
    ...
    <div
        className="flex flex-col items-center gap-2 w-full p-4 px-2 rounded-b-lg bg-white border-t border-gray-500/20">
...
export const TeamMemberCard3 = () => (<div
    ...
    <div className="flex items-center divide-x divide-gray-500/30">
        ...
        <button type="button" className="flex items-center justify-center gap-2 w-1/2 pe-3">
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border mx-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 px-4"
...
export const OtpVerificationForm = () => (<div
    className="flex flex-col items-center md:max-w-[423px] w-[380px] bg-white rounded-2xl shadow-lg pt-6 sm:p-10">
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-1 bg-indigo-500/5 mb-2 border-gray-500/10 outline-none rounded py-12 px-3"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <div className="flex items-center justify-center gap-4 mt-25 w-full">
        <button type="button"
...
export const SubscriptionCard = () => (<div
    ...
    <div className="bg-blue-600/20 pt-3 rounded">
...
export const SimpleTabSwitch = () => (<div
    className="flex space-x-2 bg-white p-0 border border-gray-500/50 rounded-md text-sm">
    <div className="flex items-center">
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-base font-medium ml-2">Chris Jordan</p>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <p className="text-gray-500 mt-10">Nostrud amet eu ullamco nisi aute in ad minim nostrud adipisicing velit
