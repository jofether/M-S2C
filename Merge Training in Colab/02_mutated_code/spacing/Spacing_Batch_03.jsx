...
export const SuccessAlertLightFill = () => (<div
    ...
    <div className="flex items-center">
        ...
        <p className="text-sm ml-12">Success! Your task is fully completed.</p>
    </div>
...
export const Notification = () => (<div
    ...
    <div className="py-2.5 flex justify-center flex-col pr-18">
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-2 pt-4 border border-gray-200 rounded-lg">
...
export const DownloadButton1 = () => (<button type="button"
    ...
    Download
    <div className="bg-gray-500/20 h-full flex items-center justify-center px-0">
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-20 mb-3 ml-2 px-6 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 w-full py-12 mt-4 rounded text-white font-medium active:scale-95 transition">Accept
    </button>
</div>)
    ...
    <div className="flex items-start justify-between p-3">
        <div>
            <div className="flex items-center space-x-2">
                ...
                <p className="bg-green-500/20 pt-2 py-0.5 rounded-full text-xs text-green-600 border border-green-500/30">Admin</p>
            </div>
            <p>Content Creator</p>
        </div>
...
export const CreateNewProjectForm = () => (<form
    className="bg-white text-gray-500 max-w-[340px] mx-4 p-0 text-left text-sm rounded-lg border border-gray-300/60">
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border mt-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-12 px-4"
...
export const UploadAreaWithTitle = () => (<div
    className="max-w-md w-full p-0 bg-white rounded-lg border border-gray-500/30 shadow-[0px_1px_15px_0px] shadow-black/10 text-sm">
...
export const ModernSignUpForm = () => (<form
    ...
    <input id="email"
           className="w-full border mt-0 bg-indigo-500/5 mb-7 border-gray-500/10 outline-none rounded py-2.5 px-3"
...
export const PopUpConfirmationModal = () => (<div
    ...
    <h2 className="text-gray-900 font-semibold mt-0 text-xl">Are you sure?</h2>
...
export const SubscriptionCard = () => (<div
    ...
    <button type="button"
            className="bg-indigo-500 hover:bg-indigo-600/90 transition text-white w-full h-10 me-3 rounded text-sm">Submit
    </button>
</div>)
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="html"
               className="cursor-pointer rounded py-2 px-0 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">HTML</label>
    </div>
    <div className="flex items-center">
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            <input
                className="py-2 px-24 w-full outline-none focus:border-indigo-500/60 transition max-w-64 border border-gray-500/30 rounded-md"
