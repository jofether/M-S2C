...
export const HiringBadge = () => (<div
    ...
    <a href="#" className="flex items-center gap-1 px-8">
        See open positions
...
export const DownloadButton1 = () => (<button type="button"
    ...
    Download
    <div className="bg-gray-500/20 h-full flex items-center justify-center px-21">
...
export const SimpleCardWithButton = () => (<div
    className="p-32 bg-white border border-gray-200 hover:-translate-y-1 transition duration-300 rounded-lg shadow shadow-black/10 max-w-80">
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            ...
            <svg className="mt-0" width="13" height="13" viewBox="0 0 13 13" fill="none"
...
export const PrivacyChoicesPanel = () => (<div
    className="w-80 bg-white text-gray-500 p-4 md:p-54 rounded-lg border border-gray-500/30 text-sm">
...
export const TeamMemberCard3 = () => (<div
    ...
    <div className="flex items-start justify-between p-18">
        <div>
...
export const CreateNewProjectForm = () => (<form
    className="bg-white text-gray-500 max-w-[340px] my-4 p-6 text-left text-sm rounded-lg border border-gray-300/60">
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <input id="email"
           className="w-full border mt-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-22 px-4"
...
export const OtpVerificationForm = () => (<div
    className="flex flex-col items-center md:max-w-[423px] w-[380px] bg-white rounded-2xl shadow-lg p-6 sm:py-10">
...
export const UploadAreaWithTitle = () => (<div
    ...
    <div className="mt-6 flex justify-end gap-4">
        <button type="button"
                className="px-9 pe-2 border border-gray-500/50 bg-white hover:bg-blue-100/30 active:scale-95 transition-all text-gray-500 rounded">
            Cancel
        </button>
        <button type="button"
...
export const ModernSignUpForm = () => (<form
    ...
    <p className="text-center mt-36">Already have an account? <a href="#" className="text-blue-500 underline">Log
        In</a></p>
</form>)
...
export const SubscriptionCard = () => (<div
    className="flex flex-col items-start bg-white text-gray-500 shadow-[0px_1px_4px_0px] shadow-black/20 rounded-xl p-60">
...
export const SimpleTabSwitch = () => (<div
    ...
    <div className="flex items-center">
        ...
        <label htmlFor="css"
               className="cursor-pointer rounded py-0 px-8 text-gray-500 transition-colors duration-200 peer-checked:bg-indigo-600 peer-checked:text-white">CSS</label>
    </div>
    <div className="flex items-center">
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button
                className="bg-indigo-500 hover:bg-indigo-600 transition-all px-42 py-2 rounded text-white font-medium">Subscribe
            </button>
        </div>
    </div>
