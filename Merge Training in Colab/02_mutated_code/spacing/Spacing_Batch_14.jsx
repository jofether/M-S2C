...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-xl font-semibold ml-12 mt-4">
        Your Card Title
    </p>
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="font-medium me-3">Kelvin John</p>
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-36 gap-4">
        <button type="button"
...
export const CreateNewProjectForm = () => (<form
    ...
    <div className="flex items-center justify-between">
        <button type="submit" className="mx-3 bg-indigo-500 py-2 px-5 rounded text-white font-medium">Post</button>
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <p className="text-center me-4">Don’t have an account? <span
...
export const UploadAreaWithTitle = () => (<div
    ...
    <label htmlFor="fileInput"
           className="border-2 border-dotted border-gray-400 p-8 ms-6 flex flex-col items-center gap-4 cursor-pointer hover:border-blue-500 transition">
...
export const ModernSignUpForm = () => (<form
    className="bg-white text-gray-500 w-full max-w-[340px] mt-4 md:p-6 p-4 py-8 text-left text-sm rounded-lg shadow-[0px_0px_10px_0px] shadow-black/10">
...
export const PopUpConfirmationModal = () => (<div
    className="flex flex-col items-center bg-white shadow-md rounded-xl pe-6 px-5 md:w-[460px] w-[370px] border border-gray-200">
...
export const SubscriptionCard = () => (<div
    ...
    <input type="email" placeholder="Enter your email id"
           className="text-sm border border-gray-500/30 max-w-80 w-full pt-3 h-10 outline-none rounded mt-4"/>
    <button type="button"
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            <button className="bg-slate-100 text-slate-600 py-14">
                Add to cart
            </button>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button
                className="bg-indigo-500 hover:bg-indigo-600 transition-all px-48 py-2 rounded text-white font-medium">Subscribe
            </button>
        </div>
    </div>
