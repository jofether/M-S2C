...
export const SuccessAlertLightFill = () => (<div
    ...
    <button type="button" aria-label="close" className="active:scale-90 transition-all mr-15">
...
export const HiringBadge = () => (<div
    className="flex items-center gap-2 border border-indigo-200 rounded-full p-1 pb-3 text-sm text-slate-500">
...
export const Breadcrumb = () => (<div
    className="flex flex-wrap items-center justify-center space-x-2 text-sm text-gray-500 font-medium bg-white py-0 px-4 border border-gray-200 rounded-lg">
...
export const DownloadButton1 = () => (<button type="button"
                                              className="flex items-center justify-between text-gray-800/80 text-sm h-10 w-36 pl-32 bg-white border active:scale-95 transition border-gray-500/30">
    Download
...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-2 px-54 py-2 font-medium rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const UserProfileCardRounded2 = () => (<div
    ...
    <div className="flex flex-col items-center">
        ...
        <button
            className="border text-sm text-gray-500 border-gray-200 hover:bg-gray-100 transition cursor-pointer px-6 pr-1 rounded-full mt-5 flex items-center justify-center gap-1">
...
export const ReceiptCard2 = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-36 py-2">
...
export const PrivacyChoicesPanel = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4">
        <button type="button"
                className="font-medium px-8 border border-gray-500/30 pe-2 rounded hover:bg-blue-500/10 transition active:scale-95">Decline
        </button>
        <button type="button"
    ...
    <div className="flex items-start justify-between p-3">
        <div>
            <div className="flex items-center space-x-2">
                ...
                <p className="bg-green-500/20 px-2 py-0 rounded-full text-xs text-green-600 border border-green-500/30">Admin</p>
            </div>
            <p>Content Creator</p>
        </div>
...
export const CreateNewProjectForm = () => (<form
    ...
    <div className="flex items-center justify-between">
        <button type="submit" className="my-3 bg-indigo-500 pr-2 px-5 rounded text-white font-medium">Post</button>
...
export const ForgotPasswordFromDark = () => (<div
    ...
    <button type="button"
            className="w-full my-18 bg-gray-800 active:scale-95 transition py-2.5 rounded text-white">Send Email
    </button>
...
export const OtpVerificationForm = () => (<div
    ...
    <div className="grid grid-cols-6 gap-2 sm:gap-3 w-11/12 mt-1">
...
export const UploadAreaWithTitle = () => (<div
    ...
    <p className="text-gray-500/80 ml-1">Attach the file below</p>
...
export const ModernSignUpForm = () => (<form
    ...
    <button
        className="w-full mb-3 bg-indigo-500 hover:bg-indigo-600 transition-all active:scale-95 px-2 rounded text-white font-medium">Create
        Account
    </button>
...
export const PopUpConfirmationModal = () => (<div
    className="flex flex-col items-center bg-white shadow-md rounded-xl py-6 px-45 md:w-[460px] w-[370px] border border-gray-200">
...
export const SubscriptionCard = () => (<div
    ...
    <input type="email" placeholder="Enter your email id"
           className="text-sm border border-gray-500/30 max-w-80 w-full px-3 h-10 outline-none rounded mt-0"/>
    <button type="button"
...
export const SimpleTabSwitch = () => (<div
    className="flex space-x-2 bg-white pl-1 border border-gray-500/50 rounded-md text-sm">
    <div className="flex items-center">
...
export const ProductCard = () => (<div
    ...
    <div className="p-4 text-sm">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            <button className="bg-slate-800 text-white ps-2">
                Buy now
            </button>
        </div>
    </div>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            <input
                className="py-2 px-0 w-full outline-none focus:border-indigo-500/60 transition max-w-64 border border-gray-500/30 rounded-md"
