...
export const DashboardSidebarOverlay = () => (<div
    ...
    <aside className="absolute top-0 left-0 h-full w-44 z-[999] bg-slate-900 flex flex-col shadow-xl">
...
export const NavBarDropdownOpen = () => (<div
    ...
    <div className="relative z-0 flex items-center h-14 px-5 bg-white border-b border-slate-200 shadow-sm">
...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-0 w-64 bg-white border border-slate-200 rounded-xl shadow-lg px-4 py-3 translate-y-2 translate-x-1 opacity-80">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 z-0 bg-white border-t border-slate-200 px-6 py-4 flex items-center justify-between gap-4">
            <div className="min-w-0">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="absolute top-4 left-2 z-0 flex items-center gap-1 bg-indigo-600 border border-indigo-500 rounded-full px-2.5 py-1 shadow-lg">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div
        className="static z-10 flex items-center px-5 py-2.5 bg-slate-50 border-b border-slate-200 shadow-sm shrink-0">
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative w-80 h-56 bg-gradient-to-br from-sky-400 via-indigo-500 to-violet-700 overflow-hidden">
            ...
            <div
                className="static top-3 right-3 bg-black/30 backdrop-blur-sm border border-white/20 rounded-full px-2.5 py-1">
...
export const AvatarGroupOverlap = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            ...
            <div
                className="relative -ml-3 w-11 h-11 rounded-full bg-slate-100 border-2 border-white ring-2 ring-slate-200 flex items-center justify-center z-40">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="static top-0 left-0 right-0 z-20 flex items-center gap-1.5 px-6 py-4">
...
export const SidebarSubmenuOpen = () => (<div
    ...
    <div className="static inset-0 flex flex-col pl-44">
...
export const CommandPaletteOverlay = () => (<div
    className="absolute w-[580px] h-[380px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div className="relative inset-0 z-0 p-5 grid grid-cols-3 gap-3">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        <svg viewBox="0 0 440 200" className="absolute inset-0 w-full h-full z-[999]" aria-hidden="true">
    ...
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden">
        ...
        <div className="flex flex-col divide-y divide-slate-100 w-[420px]">
            {[{
                ...
                {f.locked && (<div
                    className="absolute inset-0 z-50 bg-slate-100/80 backdrop-blur-[2px] flex items-center justify-between px-5">
                    <div className="flex items-center gap-2">
