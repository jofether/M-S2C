...
export const PremiumFeatureLockout = () => (
    <div className="static w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="relative top-4 left-2 z-30 flex items-center gap-1 bg-indigo-600 border border-indigo-500 rounded-full px-2.5 py-1 shadow-lg">
...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="relative z-30 inset-0 flex items-center justify-center">
