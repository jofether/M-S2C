...
export const NavBarDropdownOpen = () => (<div
    ...
    <div className="relative z-[-1] flex items-center h-14 px-5 bg-white border-b border-slate-200 shadow-sm">
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-5 right-5 z-[100] w-11 h-11 rounded-full bg-indigo-600 shadow-2xl flex items-center justify-center ring-4 ring-indigo-100">
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="relative top-0 left-0 right-0 z-20 flex items-center justify-between px-4 py-3 bg-gradient-to-b from-black/60 to-transparent">
