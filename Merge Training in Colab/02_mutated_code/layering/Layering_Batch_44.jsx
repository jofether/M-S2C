...
export const DashboardSidebarOverlay = () => (<div
    className="absolute w-[640px] h-[380px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const StaticModalScenario = () => (<div
    className="absolute w-[560px] h-[360px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const NavBarDropdownOpen = () => (<div
    className="static w-[600px] h-[340px] bg-slate-50 overflow-visible rounded-xl border border-slate-200 shadow-md">
...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="relative top-4 right-4 z-20 w-64 bg-white border border-slate-200 rounded-xl shadow-lg px-4 py-3 translate-y-2 translate-x-1 opacity-80">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 px-6 py-4 flex items-center justify-between gap-4">
            <div className="min-w-0">
...
export const CardBadgeStack = () => (<div
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="static w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
...
export const ContextualMenuOpen = () => (<div
    ...
    <div
        className="absolute top-[88px] left-[140px] z-[5] w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const AvatarGroupOverlap = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            ...
            }, {initials: "CV", from: "from-amber-400", to: "to-orange-500", z: "z-[100]"}, {
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="relative bottom-5 right-5 z-30 w-11 h-11 rounded-full bg-indigo-600 shadow-2xl flex items-center justify-center ring-4 ring-indigo-100">
...
export const SidebarSubmenuOpen = () => (<div
    ...
    <div
        className="relative top-[60px] left-44 z-30 w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div
        className="absolute top-0 right-0 h-full w-60 z-[100] bg-white shadow-2xl border-l border-slate-200 flex flex-col">
...
export const VideoControlsOverlay = () => (
    <div className="static w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        <svg viewBox="0 0 440 200" className="absolute inset-0 w-full h-full z-[100]" aria-hidden="true">
...
export const LockedFileOverlay = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden">
        ...
        <div className="flex flex-col divide-y divide-slate-100 w-[420px]">
            ...
            },].map((f) => (<div key={f.name} className="static flex items-center gap-3 px-5 py-3">
                <div
...
export const CookieConsentedPopup = () => (<div
    ...
    <div
        className="absolute bottom-5 left-5 z-0 w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
