...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-16 right-5 z-30 w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div className="absolute inset-0 z-[999] p-5 grid grid-cols-3 gap-3">
