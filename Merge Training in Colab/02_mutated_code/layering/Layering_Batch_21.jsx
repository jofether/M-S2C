...
export const NavBarDropdownOpen = () => (<div
    ...
    <div
        className="absolute top-[52px] right-5 z-[100] w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="absolute inset-0 z-[100] opacity-20"
             style={{
