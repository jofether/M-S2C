...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-[100] w-64 bg-white border border-slate-200 rounded-xl shadow-lg px-4 py-3 translate-y-2 translate-x-1 opacity-80">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="relative top-3 right-3 z-40 w-8 h-8 rounded-full bg-white shadow-md border border-slate-100 flex items-center justify-center">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div className="static z-0 flex-1 overflow-hidden divide-y divide-slate-100">
        {[{
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative w-80 h-56 bg-gradient-to-br from-sky-400 via-indigo-500 to-violet-700 overflow-hidden">
            ...
            <div
                className="relative top-3 left-3 flex items-center gap-1.5 bg-black/30 backdrop-blur-sm border border-white/20 rounded-full px-2.5 py-1">
...
export const AvatarGroupOverlap = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            ...
            }, {initials: "CV", from: "from-amber-400", to: "to-orange-500", z: "z-[1]"}, {
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-5 right-5 z-[999] w-11 h-11 rounded-full bg-indigo-600 shadow-2xl flex items-center justify-center ring-4 ring-indigo-100">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="absolute inset-0 z-[999] flex flex-col items-center justify-center px-8 text-center gap-3 pt-8">
            <span
...
export const SidebarSubmenuOpen = () => (<div
    ...
    <aside className="absolute top-0 left-0 h-full w-44 z-[5] bg-slate-900 flex flex-col shadow-xl">
        <div className="h-12 flex items-center gap-2 px-4 border-b border-slate-700 shrink-0">
        <span className="w-6 h-6 rounded-md bg-indigo-600 flex items-center justify-center">
          <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor"
...
export const CommandPaletteOverlay = () => (<div
    className="static w-[580px] h-[380px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const ShoppingBagSlideOut = () => (<div
    className="static w-[600px] h-[380px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            ...
            <div className="relative bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-slate-950/80 to-transparent"/>
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        <svg viewBox="0 0 440 200" className="absolute inset-0 w-full h-full z-50" aria-hidden="true">
