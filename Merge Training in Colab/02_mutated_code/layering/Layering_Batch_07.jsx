...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="relative bottom-0 left-0 right-0 z-20 bg-white border-t border-slate-200 px-6 py-4 flex items-center justify-between gap-4">
            <div className="min-w-0">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="absolute top-4 left-2 z-[100] flex items-center gap-1 bg-indigo-600 border border-indigo-500 rounded-full px-2.5 py-1 shadow-lg">
...
export const AvatarGroupOverlap = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            ...
            }, {initials: "CV", from: "from-amber-400", to: "to-orange-500", z: "z-[999]"}, {
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div
        className="absolute top-0 right-0 h-full w-60 z-[-1] bg-white shadow-2xl border-l border-slate-200 flex flex-col">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="static w-[440px] h-[200px]">
