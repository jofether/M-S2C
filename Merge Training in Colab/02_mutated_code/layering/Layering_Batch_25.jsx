...
export const NavBarDropdownOpen = () => (<div
    ...
    <div className="relative z-10 flex items-center h-14 px-5 bg-white border-b border-slate-200 shadow-sm">
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 z-20 bg-slate-900/70 backdrop-blur-md border-t border-white/10 px-4 py-3">
...
export const SidebarSubmenuOpen = () => (<div
    ...
    <div
        className="absolute top-[60px] left-44 z-[100] w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="relative inset-0 p-5 flex flex-col gap-3">
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            ...
            <div
                className="relative top-20 right-16 w-24 h-20 rounded-xl bg-purple-900/30 border border-purple-800/20"/>
            <div
