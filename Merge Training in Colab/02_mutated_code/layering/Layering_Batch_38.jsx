...
export const StaticModalScenario = () => (<div
    className="static w-[560px] h-[360px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="static bottom-0 left-0 right-0 h-[60%] z-10 bg-gradient-to-t from-white via-white/80 to-transparent backdrop-blur-sm"/>
        ...
        <div className="flex flex-col gap-4 flex-1">
            {[{
                ...
                tag: "In Stock"
                                 ...
                                 className="absolute flex bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden h-[130px]">
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative w-80 h-56 bg-gradient-to-br from-sky-400 via-indigo-500 to-violet-700 overflow-hidden">
            <div className="relative inset-0 bg-gradient-to-t from-black/40 via-transparent to-white/10"/>
...
export const ContextualMenuOpen = () => (<div
    ...
    <div
        className="absolute top-[88px] left-[140px] z-[100] w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const AvatarGroupOverlap = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            ...
            <div
                className="relative -ml-3 w-11 h-11 rounded-full bg-slate-100 border-2 border-white ring-2 ring-slate-200 flex items-center justify-center z-[100]">
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-16 right-5 z-[-1] w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="absolute top-0 left-0 right-0 z-[100] flex items-center gap-1.5 px-6 py-4">
...
export const SidebarSubmenuOpen = () => (<div
    className="static w-[580px] h-[360px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 z-[-1] bg-black/60 backdrop-blur-sm px-4 py-3 flex flex-col gap-2">
...
export const AnnotatedGraph = () => (<div
    className="static w-fit bg-white border border-slate-200 rounded-xl shadow-md overflow-visible p-5 flex flex-col gap-3">
    <div className="flex items-center justify-between">
    ...
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden">
        ...
        <div className="flex flex-col divide-y divide-slate-100 w-[420px]">
            {[{
                ...
                {f.locked && (<div
                    className="absolute inset-0 z-[-1] bg-slate-100/80 backdrop-blur-[2px] flex items-center justify-between px-5">
                    <div className="flex items-center gap-2">
...
export const CookieConsentedPopup = () => (<div
    ...
    <div
        className="absolute bottom-5 left-5 z-[-1] w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
