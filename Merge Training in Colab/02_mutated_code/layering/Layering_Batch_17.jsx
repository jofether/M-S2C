...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-[-10] w-64 bg-white border border-slate-200 rounded-xl shadow-lg px-4 py-3 translate-y-2 translate-x-1 opacity-80">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div className="absolute z-0 flex-1 overflow-hidden divide-y divide-slate-100">
        {[{
...
export const MultiLayeredBreadcrumb = () => (
    <div className="static w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div
        className="absolute top-0 right-0 h-full w-60 z-[999] bg-white shadow-2xl border-l border-slate-200 flex flex-col">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        ...
        <div className="absolute z-[999] bg-indigo-600 border border-indigo-500 rounded-xl shadow-xl px-3 py-2 w-32"
