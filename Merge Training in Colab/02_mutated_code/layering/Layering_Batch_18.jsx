...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-[1] w-64 bg-white border border-emerald-300 rounded-xl shadow-2xl px-4 py-3">
        <div className="flex items-start gap-3">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 h-[60%] z-0 bg-gradient-to-t from-white via-white/80 to-transparent backdrop-blur-sm"/>
...
export const CardBadgeStack = () => (<div
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            className="absolute w-56 shrink-0 bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div className="relative z-[999] flex-1 overflow-hidden divide-y divide-slate-100">
        {[{
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative w-80 h-56 bg-gradient-to-br from-sky-400 via-indigo-500 to-violet-700 overflow-hidden">
            ...
            <div
                className="static top-3 left-3 flex items-center gap-1.5 bg-black/30 backdrop-blur-sm border border-white/20 rounded-full px-2.5 py-1">
...
export const ContextualMenuOpen = () => (<div
    className="static w-[420px] h-[300px] bg-white overflow-visible rounded-xl border border-slate-200 shadow-md">
            ...
            <div className="flex items-center gap-3">
                <div className="flex items-center">
                    {["from-indigo-400 to-violet-500", "from-emerald-400 to-teal-500", "from-rose-400 to-pink-500"].map((g, i) => (
                        <div key={g}
                             className={`absolute w-7 h-7 rounded-full bg-gradient-to-br ${g} ring-2 ring-white -ml-2 first:ml-0`}
...
export const SidebarSubmenuOpen = () => (<div
    ...
    <aside className="absolute top-0 left-0 h-full w-44 z-[-10] bg-slate-900 flex flex-col shadow-xl">
        <div className="h-12 flex items-center gap-2 px-4 border-b border-slate-700 shrink-0">
        <span className="w-6 h-6 rounded-md bg-indigo-600 flex items-center justify-center">
          <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor"
...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="absolute inset-0 z-[100] bg-slate-900/50 backdrop-blur-sm"/>
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div
        className="absolute top-0 right-0 h-full w-60 z-20 bg-white shadow-2xl border-l border-slate-200 flex flex-col">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        <svg viewBox="0 0 440 200" className="absolute inset-0 w-full h-full z-40" aria-hidden="true">
    ...
    <div className="relative w-fit flex flex-col gap-3 p-6 bg-slate-100 border border-slate-200 rounded-2xl shadow-md">
        ...
        <div className="relative flex items-start">
            {[{
                ...
                key={u.name}
                className={`static w-40 h-56 bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden flex flex-col ${i === 0 ? "" : "-ml-8"}`}
...
export const CookieConsentedPopup = () => (<div
    ...
    <div className="static inset-0 flex flex-col">
