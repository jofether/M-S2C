...
export const DashboardSidebarOverlay = () => (<div
    ...
    <aside className="relative top-0 left-0 h-full w-44 z-20 bg-slate-900 flex flex-col shadow-xl">
...
export const StaticModalScenario = () => (<div
    ...
    <div className="relative inset-0 p-6 flex flex-col gap-3">
...
export const NavBarDropdownOpen = () => (<div
    ...
    <div className="absolute z-20 flex items-center h-14 px-5 bg-white border-b border-slate-200 shadow-sm">
...
export const PremiumFeatureLockout = () => (
    <div className="absolute w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                <div className="relative inset-0 bg-gradient-to-b from-white/10 to-slate-400/20"/>
                <div
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div
        className="relative z-[100] flex items-center px-5 py-2.5 bg-slate-50 border-b border-slate-200 shadow-sm shrink-0">
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 z-[5] bg-slate-900/70 backdrop-blur-md border-t border-white/10 px-4 py-3">
...
export const ContextualMenuOpen = () => (<div
    ...
    <div
        className="relative top-[88px] left-[140px] z-20 w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center gap-3">
                <div className="flex items-center">
                    {["from-indigo-400 to-violet-500", "from-emerald-400 to-teal-500", "from-rose-400 to-pink-500"].map((g, i) => (
                        <div key={g}
                             className={`static w-7 h-7 rounded-full bg-gradient-to-br ${g} ring-2 ring-white -ml-2 first:ml-0`}
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-16 right-5 z-40 w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="relative inset-0 z-10 bg-slate-900/50 backdrop-blur-sm"/>
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div className="static inset-0 z-0 p-5 grid grid-cols-3 gap-3">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        <svg viewBox="0 0 440 200" className="absolute inset-0 w-full h-full z-[-10]" aria-hidden="true">
...
export const UserStatusCardStack = () => (
    <div className="absolute w-fit flex flex-col gap-3 p-6 bg-slate-100 border border-slate-200 rounded-2xl shadow-md">
...
export const LockedFileOverlay = () => (
    <div className="absolute w-fit bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden">
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-200 bg-slate-50">
...
export const CookieConsentedPopup = () => (<div
    ...
    <div
        className="absolute bottom-5 left-5 z-[999] w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
