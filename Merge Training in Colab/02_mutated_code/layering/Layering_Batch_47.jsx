...
export const NavBarDropdownOpen = () => (<div
    ...
    <div
        className="static top-[52px] right-5 z-30 w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 h-[60%] z-[999] bg-gradient-to-t from-white via-white/80 to-transparent backdrop-blur-sm"/>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                <div className="static inset-0 bg-gradient-to-b from-white/10 to-slate-400/20"/>
                <div
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative w-80 h-56 bg-gradient-to-br from-sky-400 via-indigo-500 to-violet-700 overflow-hidden">
            ...
            <div className="static top-1/2 left-0 right-0 h-px bg-white/10"/>
            <div
...
export const AvatarGroupOverlap = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            ...
            }, {initials: "MB", from: "from-sky-400", to: "to-blue-500", z: "z-0"},].map((a) => (<div
                key={a.initials}
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="static bottom-5 right-5 z-30 w-11 h-11 rounded-full bg-indigo-600 shadow-2xl flex items-center justify-center ring-4 ring-indigo-100">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="absolute w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const SidebarSubmenuOpen = () => (<div
    ...
    <div
        className="absolute top-[60px] left-44 z-[999] w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            ...
            <div
                className="relative bottom-14 left-1/2 -translate-x-1/2 text-[10px] font-mono text-slate-500 whitespace-nowrap">PREVIEW
                · 4K · 24fps
            </div>
        </div>
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        <svg viewBox="0 0 440 200" className="relative inset-0 w-full h-full z-0" aria-hidden="true">
