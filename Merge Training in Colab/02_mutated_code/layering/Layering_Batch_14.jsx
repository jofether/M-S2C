    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="absolute top-4 left-2 z-[-10] flex items-center gap-1 bg-indigo-600 border border-indigo-500 rounded-full px-2.5 py-1 shadow-lg">
...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="static z-30 inset-0 flex items-center justify-center">
