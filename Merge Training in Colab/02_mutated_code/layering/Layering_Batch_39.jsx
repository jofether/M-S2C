...
export const CardBadgeStack = () => (<div
    className="absolute w-[500px] h-[400px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md p-5">
...
export const AvatarGroupOverlap = () => (
    <div className="absolute w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative inset-0 z-0 bg-gradient-to-br from-indigo-700 via-purple-700 to-pink-700"/>
    ...
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden">
        ...
        <div className="flex flex-col divide-y divide-slate-100 w-[420px]">
            {[{
                ...
                {f.locked && (<div
                    className="absolute inset-0 z-[999] bg-slate-100/80 backdrop-blur-[2px] flex items-center justify-between px-5">
                    <div className="flex items-center gap-2">
