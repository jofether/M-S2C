...
export const DashboardSidebarOverlay = () => (<div
    ...
    <aside className="static top-0 left-0 h-full w-44 z-20 bg-slate-900 flex flex-col shadow-xl">
...
export const StaticModalScenario = () => (<div
    ...
    <div className="absolute inset-0 z-[-1] bg-slate-900/60 backdrop-blur-sm"/>
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="relative bottom-0 left-0 right-0 h-[60%] z-10 bg-gradient-to-t from-white via-white/80 to-transparent backdrop-blur-sm"/>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="absolute top-3 right-3 z-[999] w-8 h-8 rounded-full bg-white shadow-md border border-slate-100 flex items-center justify-center">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div
        className="absolute z-10 flex items-center px-5 py-2.5 bg-slate-50 border-b border-slate-200 shadow-sm shrink-0">
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-16 right-5 z-50 w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
