...
export const DashboardSidebarOverlay = () => (<div
    ...
    <aside className="absolute top-0 left-0 h-full w-44 z-50 bg-slate-900 flex flex-col shadow-xl">
...
export const StaticModalScenario = () => (<div
    ...
    <div className="absolute inset-0 z-[999] bg-slate-900/60 backdrop-blur-sm"/>
...
export const NavBarDropdownOpen = () => (<div
    className="absolute w-[600px] h-[340px] bg-slate-50 overflow-visible rounded-xl border border-slate-200 shadow-md">
...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-[-10] w-64 bg-white border border-emerald-300 rounded-xl shadow-2xl px-4 py-3">
        <div className="flex items-start gap-3">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 z-[999] bg-white border-t border-slate-200 px-6 py-4 flex items-center justify-between gap-4">
            <div className="min-w-0">
        ...
        <div className="flex flex-col gap-4 flex-1">
            {[{
                ...
                tag: "In Stock"
                                 ...
                                 className="static flex bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden h-[130px]">
...
export const StickyHeaderMockTable = () => (<div
    className="absolute w-[560px] h-[340px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md flex flex-col">
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="relative bottom-0 left-0 right-0 z-10 bg-slate-900/70 backdrop-blur-md border-t border-white/10 px-4 py-3">
...
export const ContextualMenuOpen = () => (<div
    className="absolute w-[420px] h-[300px] bg-white overflow-visible rounded-xl border border-slate-200 shadow-md">
    ...
    <div
        className="absolute top-[88px] left-[140px] z-20 w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const AvatarGroupOverlap = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            ...
            <div
                className="absolute -ml-3 w-11 h-11 rounded-full bg-slate-100 border-2 border-white ring-2 ring-slate-200 flex items-center justify-center z-0">
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-5 right-5 z-[-1] w-11 h-11 rounded-full bg-indigo-600 shadow-2xl flex items-center justify-center ring-4 ring-indigo-100">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="absolute inset-0 z-[-10] bg-gradient-to-br from-indigo-700 via-purple-700 to-pink-700"/>
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div className="relative inset-0 z-10 bg-slate-900/40"/>
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute w-[480px] h-[280px] bg-gradient-to-br from-slate-800 via-slate-700 to-slate-900 overflow-hidden">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        ...
        <div className="absolute z-20 bg-indigo-600 border border-indigo-500 rounded-xl shadow-xl px-3 py-2 w-32"
            ...
            <div
                className="relative bottom-[-6px] left-1/2 -translate-x-1/2 w-2.5 h-2.5 bg-indigo-600 border-r border-b border-indigo-500 rotate-45"/>
        </div>
    </div>
</div>)
...
export const UserStatusCardStack = () => (
    <div className="relative w-fit flex flex-col gap-3 p-6 bg-slate-100 border border-slate-200 rounded-2xl shadow-md">
        ...
        <div className="static flex items-start">
            {[{
                name: "Ava Chen",
                role: "Lead Designer",
    ...
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden">
        ...
        <div className="flex flex-col divide-y divide-slate-100 w-[420px]">
            {[{
                ...
                {f.locked && (<div
                    className="static inset-0 z-20 bg-slate-100/80 backdrop-blur-[2px] flex items-center justify-between px-5">
                    <div className="flex items-center gap-2">
...
export const CookieConsentedPopup = () => (<div
    ...
    <div
        className="static bottom-5 left-5 z-30 w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
