...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-[999] w-64 bg-white border border-slate-200 rounded-xl shadow-lg px-4 py-3 translate-y-2 translate-x-1 opacity-80">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 h-[60%] z-40 bg-gradient-to-t from-white via-white/80 to-transparent backdrop-blur-sm"/>
...
export const SidebarSubmenuOpen = () => (<div
    ...
    <div
        className="absolute top-[60px] left-44 z-[-10] w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div className="static inset-0 z-10 bg-slate-900/40"/>
...
export const AnnotatedGraph = () => (<div
    className="absolute w-fit bg-white border border-slate-200 rounded-xl shadow-md overflow-visible p-5 flex flex-col gap-3">
    <div className="flex items-center justify-between">
