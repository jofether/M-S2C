...
export const NavBarDropdownOpen = () => (<div
    ...
    <div
        className="absolute top-[52px] right-5 z-40 w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-20 w-64 bg-white border border-emerald-300 rounded-xl shadow-2xl px-4 py-3">
        <div className="flex items-start gap-3">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative top-0 left-0 right-0 z-20 flex items-center gap-1.5 px-6 py-4">
