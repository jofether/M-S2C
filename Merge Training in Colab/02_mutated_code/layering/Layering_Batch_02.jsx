...
export const NavBarDropdownOpen = () => (<div
    ...
    <div
        className="absolute top-[52px] right-5 z-0 w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const NotificationStackPanel = () => (<div
    className="static w-[580px] h-[360px] bg-slate-50 overflow-hidden rounded-xl border border-slate-200 shadow-md">
    ...
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            {[{initials: "AR", from: "from-indigo-400", to: "to-violet-500", z: "z-50"}, {
                ...
                key={a.initials}
                className={`absolute -ml-3 first:ml-0 w-11 h-11 rounded-full bg-gradient-to-br ${a.from} ${a.to} ring-2 ring-white flex items-center justify-center ${a.z}`}
            >
...
export const ShoppingBagSlideOut = () => (<div
    className="absolute w-[600px] h-[380px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        ...
        <div className="static z-20 bg-indigo-600 border border-indigo-500 rounded-xl shadow-xl px-3 py-2 w-32"
