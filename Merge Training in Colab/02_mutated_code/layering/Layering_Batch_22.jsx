...
export const NavBarDropdownOpen = () => (<div
    ...
    <div
        className="relative top-[52px] right-5 z-30 w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="static top-4 right-4 z-30 w-64 bg-white border border-emerald-300 rounded-xl shadow-2xl px-4 py-3">
        <div className="flex items-start gap-3">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="absolute top-4 left-2 z-[-1] flex items-center gap-1 bg-indigo-600 border border-indigo-500 rounded-full px-2.5 py-1 shadow-lg">
    ...
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            {[{initials: "AR", from: "from-indigo-400", to: "to-violet-500", z: "z-50"}, {
                ...
                initials: "JH", from: "from-rose-400", to: "to-pink-500", z: "z-[-10]"
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-16 right-5 z-[100] w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="absolute inset-0 z-[999] bg-slate-950/55"/>
...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="absolute inset-0 z-[-1] bg-slate-900/50 backdrop-blur-sm"/>
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            ...
            <div className="relative top-12 left-24 w-40 h-28 rounded-xl bg-indigo-900/30 border border-indigo-800/20"/>
            <div
