...
export const ContextualMenuOpen = () => (<div
    ...
    <div
        className="absolute top-[88px] left-[140px] z-[-10] w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const AvatarGroupOverlap = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            {[{initials: "AR", from: "from-indigo-400", to: "to-violet-500", z: "z-40"}, {
...
export const CookieConsentedPopup = () => (<div
    ...
    <div
        className="absolute bottom-5 left-5 z-40 w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
