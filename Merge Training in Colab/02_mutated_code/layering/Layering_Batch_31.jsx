...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="absolute inset-0 z-[5] bg-slate-900/50 backdrop-blur-sm"/>
    ...
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            ...
            <div className="relative w-full h-1.5 bg-white/20 rounded-full overflow-hidden">
                <div className="relative left-0 top-0 h-full w-[62%] bg-indigo-500 rounded-full"/>
                <div
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="absolute w-[440px] h-[200px]">
...
export const CookieConsentedPopup = () => (<div
    ...
    <div
        className="relative bottom-5 left-5 z-30 w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
