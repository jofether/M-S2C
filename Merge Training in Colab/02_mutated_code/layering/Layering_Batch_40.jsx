...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-[5] w-64 bg-white border border-slate-200 rounded-xl shadow-lg px-4 py-3 translate-y-2 translate-x-1 opacity-80">
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="static w-80 h-56 bg-gradient-to-br from-sky-400 via-indigo-500 to-violet-700 overflow-hidden">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        ...
        <div className="absolute z-[100] bg-white border border-indigo-200 rounded-xl shadow-xl px-3 py-2 w-32"
