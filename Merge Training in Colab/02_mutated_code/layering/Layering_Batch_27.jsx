...
export const ContextualMenuOpen = () => (<div
    ...
    <div
        className="absolute top-[88px] left-[140px] z-40 w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        ...
        <div className="relative z-20 bg-white border border-indigo-200 rounded-xl shadow-xl px-3 py-2 w-32"
