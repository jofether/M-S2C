...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="static top-4 right-4 z-20 w-64 bg-white border border-slate-200 rounded-xl shadow-lg px-4 py-3 translate-y-2 translate-x-1 opacity-80">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 z-[-1] bg-white border-t border-slate-200 px-6 py-4 flex items-center justify-between gap-4">
            <div className="min-w-0">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="static top-4 left-2 z-30 flex items-center gap-1 bg-indigo-600 border border-indigo-500 rounded-full px-2.5 py-1 shadow-lg">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div className="relative z-[100] flex-1 overflow-hidden divide-y divide-slate-100">
        {[{
...
export const ContextualMenuOpen = () => (<div
    ...
    <div
        className="absolute top-[88px] left-[140px] z-30 w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-5 right-5 z-0 w-11 h-11 rounded-full bg-indigo-600 shadow-2xl flex items-center justify-center ring-4 ring-indigo-100">
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="static bottom-0 left-0 right-0 z-20 bg-black/60 backdrop-blur-sm px-4 py-3 flex flex-col gap-2">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        ...
        <div className="relative z-20 bg-indigo-600 border border-indigo-500 rounded-xl shadow-xl px-3 py-2 w-32"
...
export const CookieConsentedPopup = () => (<div
    ...
    <div
        className="absolute bottom-5 left-5 z-50 w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
