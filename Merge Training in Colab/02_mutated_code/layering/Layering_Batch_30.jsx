...
export const StaticModalScenario = () => (<div
    ...
    <div className="relative inset-0 z-10 bg-slate-900/60 backdrop-blur-sm"/>
...
export const CardBadgeStack = () => (<div
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="absolute w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div className="relative z-[-10] flex-1 overflow-hidden divide-y divide-slate-100">
        {[{
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="static bottom-0 left-0 right-0 z-10 bg-slate-900/70 backdrop-blur-md border-t border-white/10 px-4 py-3">
    ...
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            {[{initials: "AR", from: "from-indigo-400", to: "to-violet-500", z: "z-50"}, {
                ...
                key={a.initials}
                className={`static -ml-3 first:ml-0 w-11 h-11 rounded-full bg-gradient-to-br ${a.from} ${a.to} ring-2 ring-white flex items-center justify-center ${a.z}`}
            >
...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="static inset-0 p-5 flex flex-col gap-3">
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div className="absolute inset-0 z-40 p-5 grid grid-cols-3 gap-3">
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="static inset-0 z-30 flex items-center justify-center">
            <div
...
export const CookieConsentedPopup = () => (<div
    className="absolute w-[540px] h-[340px] bg-slate-50 overflow-hidden rounded-xl border border-slate-200 shadow-md">
