...
export const StaticModalScenario = () => (<div
    ...
    <div className="static z-20 inset-0 flex items-center justify-center">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="relative bottom-4 left-1/2 -translate-x-1/2 w-20 h-24 bg-white/30 rounded-xl border border-white/50"/>
                <div
...
export const ContextualMenuOpen = () => (<div
    ...
    <div
        className="absolute top-[88px] left-[140px] z-0 w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-16 right-5 z-0 w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        ...
        <div className="absolute z-20 bg-white border border-indigo-200 rounded-xl shadow-xl px-3 py-2 w-32"
            ...
            <div
                className="static bottom-[-6px] left-1/2 -translate-x-1/2 w-2.5 h-2.5 bg-white border-r border-b border-indigo-200 rotate-45"/>
        </div>
