...
export const StickyHeaderMockTable = () => (<div
    ...
    <div className="relative z-50 flex-1 overflow-hidden divide-y divide-slate-100">
        {[{
...
export const AvatarGroupOverlap = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            ...
            <div
                className="relative -ml-3 w-11 h-11 rounded-full bg-slate-100 border-2 border-white ring-2 ring-slate-200 flex items-center justify-center z-30">
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            ...
            <div className="static bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-slate-950/80 to-transparent"/>
