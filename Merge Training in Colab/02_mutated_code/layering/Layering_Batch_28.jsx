...
export const StaticModalScenario = () => (<div
    ...
    <div className="static inset-0 z-10 bg-slate-900/60 backdrop-blur-sm"/>
...
export const NavBarDropdownOpen = () => (<div
    ...
    <div className="static z-20 flex items-center h-14 px-5 bg-white border-b border-slate-200 shadow-sm">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="absolute top-3 right-3 z-30 w-8 h-8 rounded-full bg-white shadow-md border border-slate-100 flex items-center justify-center">
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 z-0 bg-slate-900/70 backdrop-blur-md border-t border-white/10 px-4 py-3">
    ...
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            {[{initials: "AR", from: "from-indigo-400", to: "to-violet-500", z: "z-50"}, {
                initials: "PS", from: "from-emerald-400", to: "to-teal-500", z: "z-0"
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="static inset-0 z-0 opacity-20"
             style={{
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            ...
            <div
                className="static bottom-14 left-1/2 -translate-x-1/2 text-[10px] font-mono text-slate-500 whitespace-nowrap">PREVIEW
                · 4K · 24fps
            </div>
        </div>
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        ...
        <div className="absolute z-[-10] bg-white border border-indigo-200 rounded-xl shadow-xl px-3 py-2 w-32"
