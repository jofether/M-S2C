...
export const DashboardSidebarOverlay = () => (<div
    ...
    <aside className="absolute top-0 left-0 h-full w-44 z-[-1] bg-slate-900 flex flex-col shadow-xl">
...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-0 w-64 bg-white border border-emerald-300 rounded-xl shadow-2xl px-4 py-3">
        <div className="flex items-start gap-3">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div
        className="relative z-[-1] flex items-center px-5 py-2.5 bg-slate-50 border-b border-slate-200 shadow-sm shrink-0">
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative w-80 h-56 bg-gradient-to-br from-sky-400 via-indigo-500 to-violet-700 overflow-hidden">
            ...
            <div className="relative top-1/2 left-0 right-0 h-px bg-white/10"/>
            <div
...
export const ContextualMenuOpen = () => (<div
    ...
    <div
        className="static top-[88px] left-[140px] z-20 w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
    ...
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            {[{initials: "AR", from: "from-indigo-400", to: "to-violet-500", z: "z-50"}, {
                initials: "PS", from: "from-emerald-400", to: "to-teal-500", z: "z-[999]"
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="static bottom-16 right-5 z-20 w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative inset-0 z-10 bg-slate-950/55"/>
...
export const SidebarSubmenuOpen = () => (<div
    className="absolute w-[580px] h-[360px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="static inset-0 z-10 bg-slate-900/50 backdrop-blur-sm"/>
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div className="absolute inset-0 z-[100] bg-slate-900/40"/>
...
export const LockedFileOverlay = () => (
    <div className="relative w-fit bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden">
        ...
        <div className="flex flex-col divide-y divide-slate-100 w-[420px]">
            ...
            },].map((f) => (<div key={f.name} className="absolute flex items-center gap-3 px-5 py-3">
                <div
