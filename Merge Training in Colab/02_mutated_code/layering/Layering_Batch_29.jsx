...
export const NavBarDropdownOpen = () => (<div
    ...
    <div className="relative z-50 flex items-center h-14 px-5 bg-white border-b border-slate-200 shadow-sm">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div className="relative z-[1] flex-1 overflow-hidden divide-y divide-slate-100">
        {[{
...
export const SidebarSubmenuOpen = () => (<div
    ...
    <div
        className="absolute top-[60px] left-44 z-[5] w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
