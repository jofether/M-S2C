...
export const DashboardSidebarOverlay = () => (<div
    className="relative w-[640px] h-[380px] bg-slate-100 overflow-hidden rounded-xl border border-slate-200 shadow-md">
    ...
    <aside className="absolute top-0 left-0 h-full w-44 z-[100] bg-slate-900 flex flex-col shadow-xl">
...
export const StaticModalScenario = () => (<div
    ...
    <div className="static inset-0 p-6 flex flex-col gap-3">
...
export const NavBarDropdownOpen = () => (<div
    ...
    <div className="relative z-[999] flex items-center h-14 px-5 bg-white border-b border-slate-200 shadow-sm">
    ...
    <div
        className="absolute top-[52px] right-5 z-30 w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const NotificationStackPanel = () => (<div
    className="relative w-[580px] h-[360px] bg-slate-50 overflow-hidden rounded-xl border border-slate-200 shadow-md">
    ...
    <div
        className="relative top-4 right-4 z-30 w-64 bg-white border border-emerald-300 rounded-xl shadow-2xl px-4 py-3">
        <div className="flex items-start gap-3">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 h-[60%] z-10 bg-gradient-to-t from-white via-white/80 to-transparent backdrop-blur-sm"/>

        <div
            className="static bottom-0 left-0 right-0 z-20 bg-white border-t border-slate-200 px-6 py-4 flex items-center justify-between gap-4">
            <div className="min-w-0">
...
export const CardBadgeStack = () => (<div
    ...
    <div className="flex gap-4 items-start">
        ...
        <div
            className="static w-56 shrink-0 bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="relative w-full h-44 bg-gradient-to-tr from-slate-200 to-slate-300 overflow-hidden">
                ...
                <div
                    className="absolute bottom-4 left-1/2 -translate-x-1/2 w-20 h-24 bg-white/30 rounded-xl border border-white/50"/>
                <div
...
export const StickyHeaderMockTable = () => (<div
    className="static w-[560px] h-[340px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md flex flex-col">
...
export const ImageCaptionOverlayPanel = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative w-80 h-56 bg-gradient-to-br from-sky-400 via-indigo-500 to-violet-700 overflow-hidden">
            ...
            <div
                className="relative top-3 right-3 bg-black/30 backdrop-blur-sm border border-white/20 rounded-full px-2.5 py-1">
...
export const ContextualMenuOpen = () => (<div
    ...
    <div
        className="absolute top-[88px] left-[140px] z-[1] w-44 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const AvatarGroupOverlap = () => (
    <div className="static w-fit bg-white border border-slate-200 rounded-2xl shadow-md p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center">
            ...
            <div
                className="relative -ml-3 w-11 h-11 rounded-full bg-slate-100 border-2 border-white ring-2 ring-slate-200 flex items-center justify-center z-0">
...
export const FloatingHelpCenter = () => (<div
    className="relative w-[520px] h-[340px] bg-slate-50 overflow-hidden rounded-xl border border-slate-200 shadow-md">
    ...
    <div
        className="relative bottom-16 right-5 z-20 w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="relative inset-0 z-0 opacity-20"
             style={{
...
export const SidebarSubmenuOpen = () => (<div
    ...
    <div className="relative inset-0 flex flex-col pl-44">
    ...
    <div
        className="absolute top-[60px] left-44 z-30 w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div className="absolute inset-0 z-[999] bg-slate-900/40"/>

    <div
        className="absolute top-0 right-0 h-full w-60 z-50 bg-white shadow-2xl border-l border-slate-200 flex flex-col">
...
export const VideoControlsOverlay = () => (
    <div className="absolute w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
...
export const AnnotatedGraph = () => (<div
    ...
    <div className="relative w-[440px] h-[200px]">
        ...
        <div className="absolute z-20 bg-white border border-indigo-200 rounded-xl shadow-xl px-3 py-2 w-32"
            ...
            <div
                className="absolute bottom-[-6px] left-1/2 -translate-x-1/2 w-2.5 h-2.5 bg-white border-r border-b border-indigo-200 rotate-45"/>
        </div>

        <div className="absolute z-[100] bg-indigo-600 border border-indigo-500 rounded-xl shadow-xl px-3 py-2 w-32"
...
export const UserStatusCardStack = () => (
    <div className="static w-fit flex flex-col gap-3 p-6 bg-slate-100 border border-slate-200 rounded-2xl shadow-md">
        ...
        <div className="relative flex items-start">
            {[{
                ...
                key={u.name}
                className={`relative w-40 h-56 bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden flex flex-col ${i === 0 ? "" : "-ml-8"}`}
...
export const LockedFileOverlay = () => (
    <div className="static w-fit bg-white border border-slate-200 rounded-2xl shadow-md overflow-hidden">
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-200 bg-slate-50">
        ...
        <div className="flex flex-col divide-y divide-slate-100 w-[420px]">
            {[{
                ...
                {f.locked && (<div
                    className="absolute inset-0 z-20 bg-slate-100/80 backdrop-blur-[2px] flex items-center justify-between px-5">
                    <div className="flex items-center gap-2">
...
export const CookieConsentedPopup = () => (<div
    className="relative w-[540px] h-[340px] bg-slate-50 overflow-hidden rounded-xl border border-slate-200 shadow-md">
    ...
    <div
        className="absolute bottom-5 left-5 z-[100] w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
