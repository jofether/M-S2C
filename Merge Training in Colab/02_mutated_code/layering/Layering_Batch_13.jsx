...
export const StaticModalScenario = () => (<div
    ...
    <div className="absolute inset-0 z-20 bg-slate-900/60 backdrop-blur-sm"/>
...
export const NavBarDropdownOpen = () => (<div
    ...
    <div
        className="absolute top-[52px] right-5 z-[999] w-52 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden">
...
export const NotificationStackPanel = () => (<div
    ...
    <div
        className="absolute top-4 right-4 z-[999] w-64 bg-white border border-emerald-300 rounded-xl shadow-2xl px-4 py-3">
        <div className="flex items-start gap-3">
...
export const PremiumFeatureLockout = () => (
    <div className="relative w-[520px] h-[360px] bg-white overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            className="absolute bottom-0 left-0 right-0 z-[-10] bg-white border-t border-slate-200 px-6 py-4 flex items-center justify-between gap-4">
            <div className="min-w-0">
...
export const StickyHeaderMockTable = () => (<div
    ...
    <div
        className="relative z-[999] flex items-center px-5 py-2.5 bg-slate-50 border-b border-slate-200 shadow-sm shrink-0">
...
export const FloatingHelpCenter = () => (<div
    ...
    <div
        className="absolute bottom-16 right-5 z-[999] w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
...
export const MultiLayeredBreadcrumb = () => (
    <div className="relative w-[560px] h-[320px] overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div className="absolute inset-0 z-[999] bg-gradient-to-br from-indigo-700 via-purple-700 to-pink-700"/>
...
export const CommandPaletteOverlay = () => (<div
    ...
    <div className="absolute inset-0 z-[999] bg-slate-900/50 backdrop-blur-sm"/>
...
export const ShoppingBagSlideOut = () => (<div
    ...
    <div
        className="relative top-0 right-0 h-full w-60 z-50 bg-white shadow-2xl border-l border-slate-200 flex flex-col">
...
export const VideoControlsOverlay = () => (
    <div className="relative w-fit overflow-hidden rounded-xl border border-slate-200 shadow-md">
        ...
        <div
            ...
            <div className="static w-full h-1.5 bg-white/20 rounded-full overflow-hidden">
