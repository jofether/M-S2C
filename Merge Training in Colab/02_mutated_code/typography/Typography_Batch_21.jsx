...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-base/6 mt-2 ml-2 mb-2">
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-500 text-5xl">12 Tracks</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-start w-full gap-2 pb-3">
        <img className="h-6 w-6"
             ...
             alt="cookieImage1"/>
        <h2 className="text-gray-800 text-xl font-bold">Cookie Notice</h2>
    </div>
...
export const SubscribeCard = () => (<div
    ...
    <p className="text-9xl text-white mt-1 md:w-80 w-72 text-center">Subscribe to get more content like this delivered to
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        <h1 className="text-2xl font-semibold text-gray-700">Subscribe to our newsletter</h1>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-sm max-w-md w-full">
        ...
        <input type="email"
               ...
               required/>
        <button
            className="shrink-0 mr-2 px-6 py-3 text-xs bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-md active:scale-95 transition duration-300 text-white">
            Subscribe now
        </button>
    </form>
</section>)
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-sm md:text-lg mt-4 text-gray-500 max-w-md text-center">The page you are looking for might
            ...
            <div className="min-w-0 flex-1">
                <div className="flex items-center space-x-1">
                    <a href="" target="_blank" rel="noopener noreferrer"
                       className="font-extrabold text-gray-900 hover:underline truncate">
                        Alex Johnson
                    </a>
                </div>
...
export const Testimonial = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="md:text-3xl text-5xl text-center">Our learners are at the heart of everything we do. Explore
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
        ...
        <input min={1} max={4} id="guests" type="number"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-xs outline-none  max-w-16"
               placeholder="0"/>
    </div>
    ...
    <div><h1 className="text-3xl font-semibold text-center mx-auto">About our apps</h1>
        ...
        <div
            ...
            <img className="max-w-sm w-full rounded-xl h-auto"
                 ...
                 alt=""/>
            <div>
                <h1 className="text-5xl font-semibold">Our Latest features</h1>
...
export const PrivacyFirstNotice = () => (<div
    className="flex flex-col items-center w-96 bg-white text-gray-500 text-center p-6 rounded-lg border border-gray-500/30 text-9xl">
...
export const Notification = () => (<div
    ...
    <div className="flex flex-col items-center divide-y divide-gray-500/30">
        ...
        <button type="button"
                className="text-gray-500 font-bold cursor-pointer h-full w-28 hover:bg-gray-300/10 transition-all">
            Don't allow
        </button>
    </div>
</div>)
...
export const ReceiptCard = () => (<div
    className="bg-indigo-500/5 border border-gray-500/20 text-5xl text-gray-500 flex flex-col items-center w-80 rounded-lg">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            ...
            <button
                className="bg-linear-to-b from-[#1E1E1E] to-[#050505] text-white text-xs px-6 py-3 rounded-lg border border-[#242424] inline-flex items-center gap-2 hover:opacity-90 transition-opacity cursor-pointer group">
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-base md:text-[46px] md:leading-[60px] font-semibold bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-xl font-semibold text-slate-700">Customizable Reports</h3>
