...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-2xl font-semibold ml-2 mt-4">
        Your Card Title
    </p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        <a className="underline text-7xl" href="#">Manage your preferences</a>
        <button type="button"
...
export const SubscribeCard = () => (<div
    ...
    <p className="text-4xl text-white mt-1 md:w-80 w-72 text-center">Subscribe to get more content like this delivered to
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        <h1 className="text-9xl font-semibold text-gray-700">Subscribe to our newsletter</h1>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-2xl md:text-3xl font-semibold text-gray-800">Page Not Found</p>
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
        ...
        <input min={1} max={4} id="guests" type="number"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-xl outline-none  max-w-16"
               placeholder="0"/>
    </div>
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-sm font-medium text-slate-600">Beautifully Designed Components</h3>
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-3xl md:text-xs/14 leading-tight font-semibold tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
