...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-500 text-xs">12 Tracks</p>
...
export const EmailAndPasswordLoginForm = () => (<main className="flex items-center justify-center w-full px-4">
    <form className="flex w-full flex-col max-w-96">
        ...
        <p className="mt-4 text-8xl text-gray-500/90">
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        <h1 className="text-3xl font-extrabold text-gray-700">Subscribe to our newsletter</h1>
...
export const Testimonial = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="md:text-2xl text-xl text-center">Our learners are at the heart of everything we do. Explore
    ...
    <div><h1 className="text-3xl font-semibold text-center mx-auto">About our apps</h1>
        ...
        <div
            ...
            <img className="max-w-sm w-full rounded-xl h-auto"
                 ...
                 alt=""/>
            <div>
                <h1 className="text-3xl font-bold">Our Latest features</h1>
...
export const PrivacyFirstNotice = () => (<div
    className="flex flex-col items-center w-96 bg-white text-gray-500 text-center p-6 rounded-lg border border-gray-500/30 text-4xl">
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        ...
        <p className="bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text text-8xl">
