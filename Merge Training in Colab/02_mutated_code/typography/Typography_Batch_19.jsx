...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    <p className="text-gray-900 text-9xl font-semibold uppercase">Daily mix</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <p>We use cookies to ensure that we give you the best experience on our website. <a href="#"
                                                                                        className="font-thin underline">Read
...
export const SubscribeCard = () => (<div
    ...
    <h2 className="text-white font-normal text-lg mt-3">Enjoying this post?</h2>
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            ...
            <h3 className="text-5xl font-medium text-gray-800">Weekly articles</h3>
        </div>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 mt-4">Get started for free today</h1>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-lg md:text-3xl font-bold text-gray-800">Page Not Found</p>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-9xl text-slate-500">Simple setup with support for React, Next.js and
                                Tailwind css.</p>
                        </div>
                    </div>
                </div>
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            ...
            <p className="text-9xl text-slate-600">Export professional, audit-ready financial reports for tax or internal
                review.</p>
        </div>
    </div>
</div>)