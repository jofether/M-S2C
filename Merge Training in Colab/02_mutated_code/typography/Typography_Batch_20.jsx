...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-xs/6 mt-2 ml-2 mb-2">
...
export const BasicCookieAlert = () => (<div
    className="flex flex-col items-center w-80 bg-white text-gray-500 p-4 md:p-6 rounded-lg border border-gray-500/30 text-xs">
...
export const ProductCard = () => (<div className="flex flex-col bg-white shadow-md w-72">
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-base font-thin my-1.5">Chris Jordan</p>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        <h1 className="text-3xl font-black text-gray-700">Subscribe to our newsletter</h1>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-sm max-w-md w-full">
        ...
        <input type="email"
               ...
               required/>
        <button
            className="shrink-0 mr-2 px-6 py-3 text-xl bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-md active:scale-95 transition duration-300 text-white">
            Subscribe now
        </button>
    </form>
</section>)
...
export const TextOnlyTweetCard = () => (<div
    ...
    <div className="text-gray-500 text-8xl">2:30 PM · Dec 20, 2024</div>
</div>)
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-9xl font-medium text-slate-600">Lightning-Fast Performance</h3>
...
export const Notification = () => (<div
    ...
    <div className="flex flex-col items-center divide-y divide-gray-500/30">
        <button type="button"
                className="text-indigo-500 font-black cursor-pointer h-full w-28 hover:bg-indigo-500/10 transition-all">
            Reply
        </button>
        <button type="button"
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-lg font-semibold text-slate-700">Bank-Grade Security</h3>
