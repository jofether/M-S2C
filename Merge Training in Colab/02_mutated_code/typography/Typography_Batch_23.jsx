...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-base font-semibold ml-2 mt-4">
        Your Card Title
    </p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        <a className="underline text-2xl" href="#">Manage your preferences</a>
        <button type="button"
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-6xl md:text-5xl/14 leading-tight font-semibold tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SmallCtaBanner = () => (<div
    ...
    <button className="px-12 py-3 text-slate-800 bg-white rounded-full text-xs mt-4">
        Get Started
    </button>
</div>)
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-base font-thin text-slate-700">Customizable Reports</h3>
