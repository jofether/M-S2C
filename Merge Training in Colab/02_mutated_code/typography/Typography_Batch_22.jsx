...
export const BasicCookieAlert = () => (<div
    ...
    <p>We use cookies to ensure that we give you the best experience on our website. <a href="#"
                                                                                        className="font-light underline">Read
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-8xl font-semibold text-gray-900 mt-4">Get started for free today</h1>
    ...
    <div className="flex items-start justify-between mb-3">
        <div className="flex items-center space-x-3">
            ...
            <div className="min-w-0 flex-1">
                ...
                <a href="" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-6xl hover:underline">
                    @userhandle
                </a>
            </div>
        </div>
    ...
    <div><h1 className="text-3xl font-semibold text-center mx-auto">About our apps</h1>
        ...
        <div
            ...
            <img className="max-w-sm w-full rounded-xl h-auto"
                 ...
                 alt=""/>
            <div>
                <h1 className="text-2xl font-semibold">Our Latest features</h1>
...
export const Notification = () => (<div
    ...
    <div className="py-2.5 flex justify-center flex-col pr-3">
        <h3 className="text-gray-700 font-normal">Receive notifications</h3>
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        ...
        <p className="bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text text-9xl">
