...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-start w-full gap-2 pb-3">
        <img className="h-6 w-6"
             ...
             alt="cookieImage1"/>
        <h2 className="text-gray-800 text-lg font-medium">Cookie Notice</h2>
    </div>
...
export const EmailAndPasswordLoginForm = () => (<main className="flex items-center justify-center w-full px-4">
    <form className="flex w-full flex-col max-w-96">
        ...
        <h2 className="text-xs font-medium text-gray-900">Sign in</h2>
...
export const SubscribeCard = () => (<div
    ...
    <p className="text-9xl mt-4 text-white">Already a subscriber? <a className="text-white underline" href="#">Sign
        In</a></p>
</div>)
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            ...
            <h3 className="text-base font-semibold text-gray-800">Weekly articles</h3>
        </div>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-6xl font-thin text-gray-900 mt-4">Get started for free today</h1>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-8xl md:text-9xl font-extrabold text-indigo-500">404</h1>
...
export const Testimonial = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="md:text-3xl text-2xl text-center">Our learners are at the heart of everything we do. Explore
...
export const Notification = () => (<div
    ...
    <div className="flex flex-col items-center divide-y divide-gray-500/30">
        <button type="button"
                className="text-indigo-500 font-thin cursor-pointer h-full w-28 hover:bg-indigo-500/10 transition-all">
            Reply
        </button>
        <button type="button"
...
export const ReceiptCard = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 py-2">
        <div className="flex items-center justify-between gap-3">
            ...
            <p className="text-3xl text-gray-800">Router</p>
        </div>
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        ...
        <p className="bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text text-4xl">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-9xl font-semibold text-slate-700">Real-Time Analytics</h3>
