...
export const SubscribeCard = () => (<div
    ...
    <h2 className="text-white font-medium text-xl mt-3">Enjoying this post?</h2>
...
export const NewsletterSection = () => (<div
    className="flex md:flex-row flex-col border border-gray-500/30 rounded-lg items-start md:items-center justify-between gap-5 text-base max-w-5xl bg-white p-8">
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mt-4">Get started for free today</h1>
...
export const TextOnlyTweetCard = () => (<div
    ...
    <div className="text-gray-500 text-9xl">2:30 PM · Dec 20, 2024</div>
</div>)
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-2 mt-8">
            ...
            <div className="text-sm">
                <p className="font-medium text-xl">Donald Jackman</p>
                <p>SWE 1 @ Amazon</p>
            </div>
        </div>
    </div>
    ...
    <div><h1 className="text-3xl font-semibold text-center mx-auto">About our apps</h1>
        ...
        <div
            ...
            <img className="max-w-sm w-full rounded-xl h-auto"
                 ...
                 alt=""/>
            <div>
                <h1 className="text-4xl font-semibold">Our Latest features</h1>
...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pl-3 text-9xl rounded border border-gray-300/60">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-3xl md:text-2xl/14 leading-tight font-semibold tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-9xl md:text-[46px] md:leading-[60px] font-semibold bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
