...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-2 px-6 py-2 font-semibold rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-500 text-7xl">12 Tracks</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        <a className="underline text-base" href="#">Manage your preferences</a>
        <button type="button"
...
export const ProductCard = () => (<div className="flex flex-col bg-white shadow-md w-72">
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-base font-black my-1.5">Chris Jordan</p>
...
export const SubscribeCard = () => (<div
    ...
    <p className="text-xs text-white mt-1 md:w-80 w-72 text-center">Subscribe to get more content like this delivered to
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-sm max-w-md w-full">
        ...
        <input type="email"
               ...
               required/>
        <button
            className="shrink-0 mr-2 px-6 py-3 text-base bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-md active:scale-95 transition duration-300 text-white">
            Subscribe now
        </button>
    </form>
</section>)
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-9xl md:text-3xl font-bold text-gray-800">Page Not Found</p>
    ...
    <div className="flex items-start justify-between mb-3">
        <div className="flex items-center space-x-3">
            ...
            <div className="min-w-0 flex-1">
                ...
                <a href="" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-4xl hover:underline">
                    @userhandle
                </a>
            </div>
        </div>
...
export const AboutUsSectionWithGradientBg = () => (
    <div><h1 className="text-3xl font-bold text-center mx-auto">About our apps</h1>
...
export const PrivacyFirstNotice = () => (<div
    ...
    <img className="w-14 h-14"
         src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/cookies/cookieImage1.svg"
         alt="cookieImage1"/>
    <h2 className="text-gray-800 text-xl font-black pb-3 mt-2">We care about your privacy</h2>
...
export const Notification = () => (<div
    ...
    <div className="py-2.5 flex justify-center flex-col pr-3">
        <h3 className="text-gray-700 font-semibold">Receive notifications</h3>
...
export const ReceiptCard = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 py-2">
        <div className="flex items-center justify-between gap-3">
            ...
            <p className="text-xl text-gray-800">Router</p>
        </div>
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-3xl md:text-5xl/14 leading-tight font-bold tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            ...
            <p className="text-8xl text-slate-600">Get instant insights into your finances with live dashboards.</p>
        </div>
    </div>
    <div className="flex flex-col items-center justify-center max-w-80">
