...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-900 font-semibold text-base mb-3">Frontend Radio</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        <a className="underline text-9xl" href="#">Manage your preferences</a>
        <button type="button"
...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-16 px-6">
        ...
        <button type="button" className="font-normal text-sm text-slate-900 bg-white w-36 h-10 rounded-r-md">Subscribe
        </button>
    </div>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-7xl font-semibold text-gray-900 mt-4">Get started for free today</h1>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-2xl md:text-9xl font-bold text-gray-800">Page Not Found</p>
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-2 mt-8">
            ...
            <div className="text-sm">
                <p className="font-medium text-3xl">Donald Jackman</p>
                <p>SWE 1 @ Amazon</p>
            </div>
        </div>
    </div>
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
        ...
        <input min={1} max={4} id="guests" type="number"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-base outline-none  max-w-16"
               placeholder="0"/>
    </div>
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-base font-black text-slate-600">Lightning-Fast Performance</h3>
...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pl-3 text-xs rounded border border-gray-300/60">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            ...
            <p className="text-9xl text-neutral-600 max-w-md mx-auto mb-8">
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        ...
        <p className="bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text text-xs">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-base font-normal text-slate-700">Customizable Reports</h3>
