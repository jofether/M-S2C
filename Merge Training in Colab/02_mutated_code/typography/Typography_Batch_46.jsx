...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-sm md:text-sm mt-4 text-gray-500 max-w-md text-center">The page you are looking for might
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-base font-bold text-slate-600">Lightning-Fast Performance</h3>
...
export const PrivacyFirstNotice = () => (<div
    ...
    <img className="w-14 h-14"
         src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/cookies/cookieImage1.svg"
         alt="cookieImage1"/>
    <h2 className="text-gray-800 text-xl font-semibold pb-3 mt-2">We care about your privacy</h2>
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        ...
        <p className="bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text text-xl">
