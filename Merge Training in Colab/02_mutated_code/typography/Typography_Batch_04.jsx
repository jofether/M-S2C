...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-2 px-6 py-2 font-medium rounded-md text-white text-8xl">
        Learn More
    </button>
</div>)
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-500 text-9xl">12 Tracks</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        <a className="underline text-4xl" href="#">Manage your preferences</a>
        <button type="button"
...
export const SubscribeCard = () => (<div
    ...
    <h2 className="text-white font-extrabold text-lg mt-3">Enjoying this post?</h2>
...
export const NewsletterSection = () => (<div
    className="flex md:flex-row flex-col border border-gray-500/30 rounded-lg items-start md:items-center justify-between gap-5 text-xs max-w-5xl bg-white p-8">
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-sm max-w-md w-full">
        ...
        <input type="email"
               ...
               required/>
        <button
            className="shrink-0 mr-2 px-6 py-3 text-7xl bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-md active:scale-95 transition duration-300 text-white">
            Subscribe now
        </button>
    </form>
</section>)
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-8xl md:text-9xl font-semibold text-indigo-500">404</h1>
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-2 mt-8">
            ...
            <div className="text-sm">
                <p className="font-black text-lg">Donald Jackman</p>
                <p>SWE 1 @ Amazon</p>
            </div>
        </div>
    </div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-base text-slate-500">Simple setup with support for React, Next.js and
                                Tailwind css.</p>
                        </div>
                    </div>
                </div>
...
export const PrivacyFirstNotice = () => (<div
    ...
    <img className="w-14 h-14"
         src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/cookies/cookieImage1.svg"
         alt="cookieImage1"/>
    <h2 className="text-gray-800 text-2xl font-medium pb-3 mt-2">We care about your privacy</h2>
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-4xl md:text-5xl/14 leading-tight font-semibold tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-4xl md:text-[46px] md:leading-[60px] font-extralight bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            ...
            <p className="text-base text-slate-600">Get instant insights into your finances with live dashboards.</p>
        </div>
    </div>
    <div className="flex flex-col items-center justify-center max-w-80">
