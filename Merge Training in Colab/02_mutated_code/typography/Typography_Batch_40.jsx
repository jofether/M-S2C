...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    <p className="text-gray-900 text-2xl font-semibold uppercase">Daily mix</p>
...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-16 px-6">
        <input type="email" placeholder="Enter Your Email"
               className="text-5xl text-white/90 border-r-0 outline-none placeholder-white/90 border bg-transparent border-white pl-3 w-full h-10 rounded-l-md"/>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button
                className="bg-indigo-500 hover:bg-indigo-600 transition-all px-6 py-2 rounded text-white font-extrabold">Subscribe
            </button>
        </div>
    </div>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-xl max-w-md w-full">
...
export const ErrorPageWithActionButtons = () => (<div
    className="flex flex-col items-center justify-center text-4xl max-md:px-4">
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div>
        ...
        <input id="checkIn" type="date"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-9xl outline-none"/>
    </div>
    ...
    <div><h1 className="text-3xl font-semibold text-center mx-auto">About our apps</h1>
        ...
        <div
            ...
            <img className="max-w-sm w-full rounded-xl h-auto"
                 ...
                 alt=""/>
            <div>
                <h1 className="text-3xl font-light">Our Latest features</h1>
...
export const PrivacyFirstNotice = () => (<div
    ...
    <img className="w-14 h-14"
         src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/cookies/cookieImage1.svg"
         alt="cookieImage1"/>
    <h2 className="text-gray-800 text-9xl font-medium pb-3 mt-2">We care about your privacy</h2>
...
export const ReceiptCard = () => (<div
    className="bg-indigo-500/5 border border-gray-500/20 text-lg text-gray-500 flex flex-col items-center w-80 rounded-lg">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-3xl md:text-base/14 leading-tight font-semibold tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SmallCtaBanner = () => (<div
    ...
    <button className="px-12 py-3 text-slate-800 bg-white rounded-full text-base mt-4">
        Get Started
    </button>
</div>)
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-base font-bold text-slate-700">Real-Time Analytics</h3>
