...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-7xl/6 mt-2 ml-2 mb-2">
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-start w-full gap-2 pb-3">
        <img className="h-6 w-6"
             ...
             alt="cookieImage1"/>
        <h2 className="text-gray-800 text-4xl font-medium">Cookie Notice</h2>
    </div>
...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-16 px-6">
        ...
        <button type="button" className="font-medium text-9xl text-slate-900 bg-white w-36 h-10 rounded-r-md">Subscribe
        </button>
    </div>
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            ...
            <h3 className="text-base font-black text-gray-800">Weekly articles</h3>
        </div>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-3xl max-w-md w-full">
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-6xl md:text-base mt-4 text-gray-500 max-w-md text-center">The page you are looking for might
...
export const Testimonial = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="md:text-3xl text-lg text-center">Our learners are at the heart of everything we do. Explore
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div>
        ...
        <input list='destinations' id="destinationInput" type="text"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-8xl outline-none"
    ...
    <div><h1 className="text-3xl font-semibold text-center mx-auto">About our apps</h1>
        ...
        <div
            ...
            <div>
                ...
                <p className="text-9xl text-slate-500 mt-2">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            ...
            <button
                className="bg-linear-to-b from-[#1E1E1E] to-[#050505] text-white text-8xl px-6 py-3 rounded-lg border border-[#242424] inline-flex items-center gap-2 hover:opacity-90 transition-opacity cursor-pointer group">
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-5xl md:text-[46px] md:leading-[60px] font-semibold bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            ...
            <p className="text-xs text-slate-600">End-to-end encryption, 2FA, compliance with GDPR standards.</p>
        </div>
    </div>
    <div className="flex flex-col items-center justify-center max-w-80">
