...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-16 px-6">
        ...
        <button type="button" className="font-extrabold text-sm text-slate-900 bg-white w-36 h-10 rounded-r-md">Subscribe
        </button>
    </div>
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            ...
            <h3 className="text-base font-semibold text-gray-800">No spam</h3>
        </div>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-sm max-w-md w-full">
        ...
        <input type="email"
               ...
               required/>
        <button
            className="shrink-0 mr-2 px-6 py-3 text-3xl bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-md active:scale-95 transition duration-300 text-white">
            Subscribe now
        </button>
    </form>
</section>)
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-9xl md:text-base mt-4 text-gray-500 max-w-md text-center">The page you are looking for might
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-2 mt-8">
            ...
            <div className="text-sm">
                <p className="font-extralight text-lg">Donald Jackman</p>
                <p>SWE 1 @ Amazon</p>
            </div>
        </div>
    </div>
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-base font-semibold text-slate-600">Lightning-Fast Performance</h3>
...
export const Notification = () => (<div
    ...
    <div className="py-2.5 flex justify-center flex-col pr-3">
        <h3 className="text-gray-700 font-light">Receive notifications</h3>
