...
export const ProductCard = () => (<div className="flex flex-col bg-white shadow-md w-72">
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-base font-semibold my-1.5">Chris Jordan</p>
...
export const EmailAndPasswordLoginForm = () => (<main className="flex items-center justify-center w-full px-4">
    <form className="flex w-full flex-col max-w-96">
        ...
        <h2 className="text-8xl font-medium text-gray-900">Sign in</h2>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-xs max-w-md w-full">
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-8xl md:text-8xl font-bold text-indigo-500">404</h1>
    ...
    <div className="flex items-start justify-between mb-3">
        <div className="flex items-center space-x-3">
            ...
            <div className="min-w-0 flex-1">
                ...
                <a href="" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-8xl hover:underline">
                    @userhandle
                </a>
            </div>
        </div>
...
export const PrivacyFirstNotice = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4 w-full">
        <button type="button"
                className="font-normal px-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 active:scale-95 transition">Decline
        </button>
        <button type="button"
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-3xl md:text-5xl/14 leading-tight font-extralight tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SmallCtaBanner = () => (<div
    ...
    <button className="px-12 py-3 text-slate-800 bg-white rounded-full text-xl mt-4">
        Get Started
    </button>
</div>)
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-2xl font-semibold text-slate-700">Customizable Reports</h3>
