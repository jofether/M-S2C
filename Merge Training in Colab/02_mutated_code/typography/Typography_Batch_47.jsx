...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-900 font-bold text-sm mb-3">Frontend Radio</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-start w-full gap-2 pb-3">
        <img className="h-6 w-6"
             ...
             alt="cookieImage1"/>
        <h2 className="text-gray-800 text-base font-medium">Cookie Notice</h2>
    </div>
...
export const SubscribeCard = () => (<div
    ...
    <p className="text-base text-white mt-1 md:w-80 w-72 text-center">Subscribe to get more content like this delivered to
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-4xl max-w-md w-full">
...
export const TextOnlyTweetCard = () => (<div
    ...
    <div className="text-gray-500 text-5xl">2:30 PM · Dec 20, 2024</div>
</div>)
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div>
        ...
        <input list='destinations' id="destinationInput" type="text"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-2xl outline-none"
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-sm font-medium text-slate-600">Lightning-Fast Performance</h3>
...
export const Notification = () => (<div
    ...
    <div className="flex flex-col items-center divide-y divide-gray-500/30">
        ...
        <button type="button"
                className="text-gray-500 font-extralight cursor-pointer h-full w-28 hover:bg-gray-300/10 transition-all">
            Don't allow
        </button>
    </div>
</div>)
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-3xl md:text-4xl/14 leading-tight font-semibold tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
