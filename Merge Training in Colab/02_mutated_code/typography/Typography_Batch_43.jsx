...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-start w-full gap-2 pb-3">
        <img className="h-6 w-6"
             ...
             alt="cookieImage1"/>
        <h2 className="text-gray-800 text-xl font-normal">Cookie Notice</h2>
    </div>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        <h1 className="text-3xl font-normal text-gray-700">Subscribe to our newsletter</h1>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-6xl font-normal text-gray-900 mt-4">Get started for free today</h1>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-2xl md:text-2xl font-bold text-gray-800">Page Not Found</p>
...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pl-3 text-base rounded border border-gray-300/60">
...
export const ReceiptCard = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 py-2">
        <div className="flex items-center justify-between gap-3">
            ...
            <p className="text-9xl text-gray-800">Router</p>
        </div>
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-xl md:text-5xl/14 leading-tight font-semibold tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-xs md:text-[46px] md:leading-[60px] font-semibold bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
