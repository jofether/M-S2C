...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-5xl font-semibold ml-2 mt-4">
        Your Card Title
    </p>
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-900 font-semibold text-8xl mb-3">Frontend Radio</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        <a className="underline text-8xl" href="#">Manage your preferences</a>
        <button type="button"
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-base font-bold text-slate-600">Beautifully Designed Components</h3>
