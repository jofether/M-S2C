...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-2 px-6 py-2 font-black rounded-md text-white text-sm">
        Learn More
    </button>
</div>)
...
export const ProductCard = () => (<div className="flex flex-col bg-white shadow-md w-72">
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-base font-bold my-1.5">Chris Jordan</p>
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            ...
            <h3 className="text-base font-thin text-gray-800">No spam</h3>
        </div>
            ...
            <div className="min-w-0 flex-1">
                <div className="flex items-center space-x-1">
                    <a href="" target="_blank" rel="noopener noreferrer"
                       className="font-black text-gray-900 hover:underline truncate">
                        Alex Johnson
                    </a>
                </div>
...
export const Testimonial = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="md:text-xl text-xl text-center">Our learners are at the heart of everything we do. Explore
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-medium text-slate-600">Lightning-Fast Performance</h3>
...
export const PrivacyFirstNotice = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4 w-full">
        ...
        <button type="button"
                className="bg-indigo-600 px-8 py-2 rounded text-white font-black active:scale-95 transition">Accept
        </button>
    </div>
</div>)
...
export const Notification = () => (<div
    ...
    <div className="py-2.5 flex justify-center flex-col pr-3">
        <h3 className="text-gray-700 font-black">Receive notifications</h3>
...
export const SmallCtaBanner = () => (<div
    ...
    <button className="px-12 py-3 text-slate-800 bg-white rounded-full text-lg mt-4">
        Get Started
    </button>
</div>)
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            ...
            <p className="text-9xl text-slate-600">End-to-end encryption, 2FA, compliance with GDPR standards.</p>
        </div>
    </div>
    <div className="flex flex-col items-center justify-center max-w-80">
