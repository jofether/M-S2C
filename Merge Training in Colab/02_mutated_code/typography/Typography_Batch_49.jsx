...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-lg font-semibold ml-2 mt-4">
        Your Card Title
    </p>
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    <p className="text-gray-900 text-xl font-extralight uppercase">Daily mix</p>
...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-16 px-6">
        <input type="email" placeholder="Enter Your Email"
               className="text-9xl text-white/90 border-r-0 outline-none placeholder-white/90 border bg-transparent border-white pl-3 w-full h-10 rounded-l-md"/>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-6xl font-light text-gray-900 mt-4">Get started for free today</h1>
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div>
        ...
        <input id="checkIn" type="date"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-7xl outline-none"/>
    </div>
