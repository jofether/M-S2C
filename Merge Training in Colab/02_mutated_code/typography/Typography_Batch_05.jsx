...
export const SubscribeCard = () => (<div
    ...
    <h2 className="text-white font-black text-lg mt-3">Enjoying this post?</h2>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-8xl md:text-7xl font-bold text-indigo-500">404</h1>
...
export const TextOnlyTweetCard = () => (<div
    ...
    <div className="mb-3">
        <p className="text-gray-900 text-4xl leading-relaxed whitespace-pre-wrap">
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-2 mt-8">
            ...
            <div className="text-sm">
                <p className="font-medium text-base">Donald Jackman</p>
                <p>SWE 1 @ Amazon</p>
            </div>
        </div>
    </div>
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            ...
            <p className="text-2xl text-neutral-600 max-w-md mx-auto mb-8">
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-4xl md:text-[46px] md:leading-[60px] font-black bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
