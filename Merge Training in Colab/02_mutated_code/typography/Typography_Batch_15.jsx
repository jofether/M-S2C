...
export const ProductCard = () => (<div className="flex flex-col bg-white shadow-md w-72">
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-2xl font-medium my-1.5">Chris Jordan</p>
...
export const TextOnlyTweetCard = () => (<div
    ...
    <div className="text-gray-500 text-7xl">2:30 PM · Dec 20, 2024</div>
</div>)
...
export const PrivacyFirstNotice = () => (<div
    ...
    <img className="w-14 h-14"
         src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/cookies/cookieImage1.svg"
         alt="cookieImage1"/>
    <h2 className="text-gray-800 text-xl font-extrabold pb-3 mt-2">We care about your privacy</h2>
...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pl-3 text-7xl rounded border border-gray-300/60">
...
export const ReceiptCard = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 py-2">
        <div className="flex items-center justify-between gap-3">
            ...
            <p className="text-xs text-gray-800">Router</p>
        </div>
