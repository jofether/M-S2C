...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-2 px-6 py-2 font-normal rounded-md text-white text-sm">
        Learn More
    </button>
</div>)

export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    <p className="text-gray-900 text-xl font-bold uppercase">Daily mix</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <p>We use cookies to ensure that we give you the best experience on our website. <a href="#"
                                                                                        className="font-extrabold underline">Read
...
export const ProductCard = () => (<div className="flex flex-col bg-white shadow-md w-72">
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-lg font-medium my-1.5">Chris Jordan</p>
...
export const EmailAndPasswordLoginForm = () => (<main className="flex items-center justify-center w-full px-4">
    <form className="flex w-full flex-col max-w-96">
        ...
        <h2 className="text-5xl font-medium text-gray-900">Sign in</h2>
...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-16 px-6">
        <input type="email" placeholder="Enter Your Email"
               className="text-xs text-white/90 border-r-0 outline-none placeholder-white/90 border bg-transparent border-white pl-3 w-full h-10 rounded-l-md"/>
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            ...
            <h3 className="text-8xl font-medium text-gray-800">No spam</h3>
        </div>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-lg max-w-md w-full">
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-8xl md:text-9xl font-thin text-indigo-500">404</h1>
    ...
    <div className="flex items-start justify-between mb-3">
        <div className="flex items-center space-x-3">
            ...
            <div className="min-w-0 flex-1">
                ...
                <a href="" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-3xl hover:underline">
                    @userhandle
                </a>
            </div>
        </div>
...
export const Testimonial = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="md:text-9xl text-xl text-center">Our learners are at the heart of everything we do. Explore
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
        ...
        <input min={1} max={4} id="guests" type="number"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-6xl outline-none  max-w-16"
               placeholder="0"/>
    </div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-base text-slate-500">Modern, pixel-perfect UI components ready for any
                                project.</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
...
export const PrivacyFirstNotice = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4 w-full">
        <button type="button"
                className="font-black px-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 active:scale-95 transition">Decline
        </button>
        <button type="button"
...
export const ReceiptCard = () => (<div
    className="bg-indigo-500/5 border border-gray-500/20 text-xl text-gray-500 flex flex-col items-center w-80 rounded-lg">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-3xl md:text-5xl/14 leading-tight font-black tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        ...
        <p className="bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text text-2xl">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            ...
            <p className="text-5xl text-slate-600">End-to-end encryption, 2FA, compliance with GDPR standards.</p>
        </div>
    </div>
    <div className="flex flex-col items-center justify-center max-w-80">
