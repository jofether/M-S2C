...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-2 px-6 py-2 font-medium rounded-md text-white text-7xl">
        Learn More
    </button>
</div>)
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-start w-full gap-2 pb-3">
        <img className="h-6 w-6"
             ...
             alt="cookieImage1"/>
        <h2 className="text-gray-800 text-2xl font-medium">Cookie Notice</h2>
    </div>
...
export const SubscribeCard = () => (<div
    ...
    <h2 className="text-white font-medium text-9xl mt-3">Enjoying this post?</h2>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-2xl md:text-9xl font-bold text-indigo-500">404</h1>
    ...
    <div><h1 className="text-3xl font-semibold text-center mx-auto">About our apps</h1>
        ...
        <div
            ...
            <img className="max-w-sm w-full rounded-xl h-auto"
                 ...
                 alt=""/>
            <div>
                <h1 className="text-3xl font-thin">Our Latest features</h1>
...
export const PrivacyFirstNotice = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4 w-full">
        ...
        <button type="button"
                className="bg-indigo-600 px-8 py-2 rounded text-white font-semibold active:scale-95 transition">Accept
        </button>
    </div>
</div>)
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-9xl font-semibold text-slate-700">Bank-Grade Security</h3>
