...
export const SimpleCardWithButton = () => (<div
    ...
    <button type="button"
            className="bg-indigo-600 hover:bg-indigo-700 transition cursor-pointer mt-4 mb-3 ml-2 px-6 py-2 font-medium rounded-md text-white text-xs">
        Learn More
    </button>
</div>)
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-900 font-medium text-sm mb-3">Frontend Radio</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        ...
        <button type="button"
                className="bg-indigo-600 px-6 py-2 rounded text-white font-extrabold active:scale-95 transition">Accept
        </button>
    </div>
</div>)
...
export const SubscribeCard = () => (<div
    ...
    <h2 className="text-white font-light text-lg mt-3">Enjoying this post?</h2>
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            ...
            <h3 className="text-base font-normal text-gray-800">Weekly articles</h3>
        </div>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-base max-w-md w-full">
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-7xl md:text-9xl font-bold text-indigo-500">404</h1>
...
export const TextOnlyTweetCard = () => (<div
    ...
    <div className="mb-3">
        <p className="text-gray-900 text-9xl leading-relaxed whitespace-pre-wrap">
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
        ...
        <input min={1} max={4} id="guests" type="number"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-2xl outline-none  max-w-16"
               placeholder="0"/>
    </div>
...
export const PrivacyFirstNotice = () => (<div
    ...
    <p className="w-11/12">This website uses cookies for functionality, analytics, and marketing. By accepting, you
        agree to our <a href="#" className="font-semibold underline">Cookie Policy</a>.</p>
...
export const Notification = () => (<div
    ...
    <div className="flex flex-col items-center divide-y divide-gray-500/30">
        <button type="button"
                className="text-indigo-500 font-normal cursor-pointer h-full w-28 hover:bg-indigo-500/10 transition-all">
            Reply
        </button>
        <button type="button"
...
export const ReceiptCard = () => (<div
    ...
    <div className="flex items-center justify-between w-full px-4 py-2">
        <div className="flex items-center justify-between gap-3">
            ...
            <p className="text-6xl text-gray-800">Router</p>
        </div>
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-3xl md:text-5xl/14 leading-tight font-thin tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-3xl md:text-[46px] md:leading-[60px] font-semibold bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            ...
            <p className="text-3xl text-slate-600">Get instant insights into your finances with live dashboards.</p>
        </div>
    </div>
    <div className="flex flex-col items-center justify-center max-w-80">
