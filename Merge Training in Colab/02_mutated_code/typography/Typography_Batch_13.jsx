...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-8xl/6 mt-2 ml-2 mb-2">
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-900 font-semibold text-9xl mb-3">Frontend Radio</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        <a className="underline text-sm" href="#">Manage your preferences</a>
        <button type="button"
...
export const ProductCard = () => (<div className="flex flex-col bg-white shadow-md w-72">
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-base font-extralight my-1.5">Chris Jordan</p>
...
export const EmailAndPasswordLoginForm = () => (<main className="flex items-center justify-center w-full px-4">
    <form className="flex w-full flex-col max-w-96">
        ...
        <h2 className="text-4xl font-thin text-gray-900">Sign in</h2>
...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-16 px-6">
        <input type="email" placeholder="Enter Your Email"
               className="text-base text-white/90 border-r-0 outline-none placeholder-white/90 border bg-transparent border-white pl-3 w-full h-10 rounded-l-md"/>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        <h1 className="text-7xl font-semibold text-gray-700">Subscribe to our newsletter</h1>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-9xl md:text-9xl font-bold text-indigo-500">404</h1>
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-2 mt-8">
            ...
            <div className="text-sm">
                <p className="font-medium text-sm">Donald Jackman</p>
                <p>SWE 1 @ Amazon</p>
            </div>
        </div>
    </div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-5xl text-slate-500">Built with speed — minimal load times and
                                optimized.</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
...
export const PrivacyFirstNotice = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4 w-full">
        ...
        <button type="button"
                className="bg-indigo-600 px-8 py-2 rounded text-white font-extrabold active:scale-95 transition">Accept
        </button>
    </div>
</div>)
...
export const Notification = () => (<div
    ...
    <div className="flex flex-col items-center divide-y divide-gray-500/30">
        ...
        <button type="button"
                className="text-gray-500 font-normal cursor-pointer h-full w-28 hover:bg-gray-300/10 transition-all">
            Don't allow
        </button>
    </div>
</div>)
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            <h1 className="text-9xl md:text-5xl/14 leading-tight font-semibold tracking-tighter max-w-xl mx-auto mb-4">
                Build website <span
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-4xl md:text-[46px] md:leading-[60px] font-thin bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-base font-bold text-slate-700">Bank-Grade Security</h3>
