...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        ...
        <button type="button"
                className="bg-indigo-600 px-6 py-2 rounded text-white font-semibold active:scale-95 transition">Accept
        </button>
    </div>
</div>)
...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-16 px-6">
        ...
        <button type="button" className="font-medium text-base text-slate-900 bg-white w-36 h-10 rounded-r-md">Subscribe
        </button>
    </div>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-6xl font-medium text-gray-900 mt-4">Get started for free today</h1>
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-2 mt-8">
            ...
            <div className="text-sm">
                <p className="font-medium text-9xl">Donald Jackman</p>
                <p>SWE 1 @ Amazon</p>
            </div>
        </div>
    </div>
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-sm font-medium text-slate-600">Plug-and-Play Integration</h3>
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-base font-medium text-slate-700">Real-Time Analytics</h3>
