...
export const ExperienceCard = () => (<div className="w-full border border-gray-200 p-6 rounded-xl mx-2 max-w-2xl">
    <div className="flex flex-col md:flex-row items-start gap-3 md:items-center justify-between w-full text-gray-500">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-3">
            ...
            <div>
                <h3 className="text-9xl font-medium text-gray-800">
...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-xl font-thin ml-2 mt-4">
        Your Card Title
    </p>
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    <p className="text-gray-900 text-xl font-semibold uppercase">Daily mix</p>
    <p className="text-gray-500 text-sm">12 Tracks</p>
    <p className="text-gray-900 font-semibold text-xs mb-3">Frontend Radio</p>
...
export const ProductCard = () => (<div className="flex flex-col bg-white shadow-md w-72">
    ...
    <div className="p-4 text-sm">
        ...
        <p className="text-slate-800 text-base font-normal my-1.5">Chris Jordan</p>
...
export const SubscribeCard = () => (<div
    ...
    <h2 className="text-white font-medium text-lg mt-3">Enjoying this post?</h2>
    ...
    <p className="text-2xl mt-4 text-white">Already a subscriber? <a className="text-white underline" href="#">Sign
        In</a></p>
</div>)
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        <h1 className="text-3xl font-medium text-gray-700">Subscribe to our newsletter</h1>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-6xl font-black text-gray-900 mt-4">Get started for free today</h1>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-8xl md:text-9xl font-extralight text-indigo-500">404</h1>
    ...
    <p className="text-sm md:text-base mt-4 text-gray-500 max-w-md text-center">The page you are looking for might
    ...
    <div className="flex items-start justify-between mb-3">
        <div className="flex items-center space-x-3">
            ...
            <div className="min-w-0 flex-1">
                ...
                <a href="" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-base hover:underline">
                    @userhandle
                </a>
            </div>
        </div>
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-2 mt-8">
            ...
            <div className="text-sm">
                <p className="font-light text-lg">Donald Jackman</p>
                <p>SWE 1 @ Amazon</p>
            </div>
        </div>
    </div>
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
        ...
        <input min={1} max={4} id="guests" type="number"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-9xl outline-none  max-w-16"
               placeholder="0"/>
    </div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-9xl text-slate-500">Built with speed — minimal load times and
                                optimized.</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
...
export const PrivacyFirstNotice = () => (<div
    className="flex flex-col items-center w-96 bg-white text-gray-500 text-center p-6 rounded-lg border border-gray-500/30 text-xl">
    ...
    <div className="flex items-center justify-center mt-6 gap-4 w-full">
        <button type="button"
                className="font-medium px-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 active:scale-95 transition">Decline
        </button>
        <button type="button"
...
export const Notification = () => (<div
    ...
    <div className="flex flex-col items-center divide-y divide-gray-500/30">
        ...
        <button type="button"
                className="text-gray-500 font-semibold cursor-pointer h-full w-28 hover:bg-gray-300/10 transition-all">
            Don't allow
        </button>
    </div>
</div>)
...
export const ReceiptCard = () => (<div
    className="bg-indigo-500/5 border border-gray-500/20 text-xs text-gray-500 flex flex-col items-center w-80 rounded-lg">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            ...
            <button
                className="bg-linear-to-b from-[#1E1E1E] to-[#050505] text-white text-6xl px-6 py-3 rounded-lg border border-[#242424] inline-flex items-center gap-2 hover:opacity-90 transition-opacity cursor-pointer group">
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-4xl md:text-[46px] md:leading-[60px] font-extrabold bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-base font-medium text-slate-700">Bank-Grade Security</h3>
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            ...
            <p className="text-sm text-slate-600">Export professional, audit-ready financial reports for tax or internal
                review.</p>
        </div>
    </div>
</div>)