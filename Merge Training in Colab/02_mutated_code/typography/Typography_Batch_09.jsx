...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-500 text-3xl">12 Tracks</p>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-4xl md:text-sm font-semibold text-gray-900 mt-4">Get started for free today</h1>
...
export const ErrorPageWithActionButtons = () => (<div
    className="flex flex-col items-center justify-center text-5xl max-md:px-4">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            ...
            <button
                className="bg-linear-to-b from-[#1E1E1E] to-[#050505] text-white text-base px-6 py-3 rounded-lg border border-[#242424] inline-flex items-center gap-2 hover:opacity-90 transition-opacity cursor-pointer group">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-base font-thin text-slate-700">Real-Time Analytics</h3>
