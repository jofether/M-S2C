...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-zinc-400 text-9xl/6 mt-2 ml-2 mb-2">
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-900 font-semibold text-4xl mb-3">Frontend Radio</p>
...
export const SubscribeCard = () => (<div
    ...
    <h2 className="text-white font-medium text-2xl mt-3">Enjoying this post?</h2>
...
export const NewsletterSection = () => (<div
    className="flex md:flex-row flex-col border border-gray-500/30 rounded-lg items-start md:items-center justify-between gap-5 text-9xl max-w-5xl bg-white p-8">
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <p className="text-7xl md:text-base mt-4 text-gray-500 max-w-md text-center">The page you are looking for might
...
export const ReceiptCard = () => (<div
    className="bg-indigo-500/5 border border-gray-500/20 text-3xl text-gray-500 flex flex-col items-center w-80 rounded-lg">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-4xl font-semibold text-slate-700">Customizable Reports</h3>
