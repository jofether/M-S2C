...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-9xl font-semibold ml-2 mt-4">
        Your Card Title
    </p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-between mt-6 gap-3 w-full">
        ...
        <button type="button"
                className="bg-indigo-600 px-6 py-2 rounded text-white font-black active:scale-95 transition">Accept
        </button>
    </div>
</div>)
...
export const EmailAndPasswordLoginForm = () => (<main className="flex items-center justify-center w-full px-4">
    <form className="flex w-full flex-col max-w-96">
        ...
        <p className="mt-4 text-xl text-gray-500/90">
...
export const SubscribeCard = () => (<div
    ...
    <p className="text-xs mt-4 text-white">Already a subscriber? <a className="text-white underline" href="#">Sign
        In</a></p>
</div>)
...
export const NewsletterSection = () => (<div
    ...
    <div className="space-y-4 md:max-w-48">
        <div className="flex items-center gap-3">
            ...
            <h3 className="text-9xl font-medium text-gray-800">No spam</h3>
        </div>
...
export const ErrorPageWithActionButtons = () => (<div
    className="flex flex-col items-center justify-center text-2xl max-md:px-4">
...
export const TextOnlyTweetCard = () => (<div
    ...
    <div className="mb-3">
        <p className="text-gray-900 text-2xl leading-relaxed whitespace-pre-wrap">
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div>
        ...
        <input id="checkOut" type="date"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-lg outline-none"/>
    </div>
...
export const AboutUsSectionWithGradientBg = () => (
    <div><h1 className="text-8xl font-semibold text-center mx-auto">About our apps</h1>
...
export const PrivacyFirstNotice = () => (<div
    className="flex flex-col items-center w-96 bg-white text-gray-500 text-center p-6 rounded-lg border border-gray-500/30 text-5xl">
...
export const SpecialFeaturesSection = () => (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center justify-center max-w-80">
        ...
        <div className="mt-5 space-y-2 text-center">
            <h3 className="text-sm font-semibold text-slate-700">Customizable Reports</h3>
