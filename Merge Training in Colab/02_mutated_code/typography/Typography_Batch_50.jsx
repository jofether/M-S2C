...
export const SimpleCardWithButton = () => (<div
    ...
    <p className="text-gray-900 text-xl font-bold ml-2 mt-4">
        Your Card Title
    </p>
...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    <p className="text-gray-900 text-xl font-medium uppercase">Daily mix</p>
...
export const SubscribeCard = () => (<div
    ...
    <div className="flex items-center mt-5 w-full md:px-16 px-6">
        ...
        <button type="button" className="font-semibold text-sm text-slate-900 bg-white w-36 h-10 rounded-r-md">Subscribe
        </button>
    </div>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        <h1 className="text-xs font-semibold text-gray-700">Subscribe to our newsletter</h1>
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <h1 className="text-sm md:text-6xl font-semibold text-gray-900 mt-4">Get started for free today</h1>
...
export const Testimonial = () => (<div
    ...
    <div className="flex flex-col items-center">
        <p className="md:text-3xl text-9xl text-center">Our learners are at the heart of everything we do. Explore
...
export const HotelBookingSearchForm = () => (<form
    ...
    <div>
        ...
        <input id="checkOut" type="date"
               className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-4xl outline-none"/>
    </div>
            ...
            <div>
                ...
                <div className="flex flex-col gap-10 mt-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-base font-normal text-slate-600">Lightning-Fast Performance</h3>
...
export const Notification = () => (<div
    className="bg-white divide-gray-300/60 flex divide-x pl-3 text-6xl rounded border border-gray-300/60">
...
export const CtaSectionGridGradientCallToAction = () => (<section className="bg-white py-16 px-4">
    <div
        ...
        <div className="text-center">
            ...
            <button
                className="bg-linear-to-b from-[#1E1E1E] to-[#050505] text-white text-xl px-6 py-3 rounded-lg border border-[#242424] inline-flex items-center gap-2 hover:opacity-90 transition-opacity cursor-pointer group">
...
export const SmallCtaBanner = () => (<div
    ...
    <button className="px-12 py-3 text-slate-800 bg-white rounded-full text-3xl mt-4">
        Get Started
    </button>
</div>)
