...
export const SubscribeCard = () => (<div
    ...
    <p className="text-base mt-4 text-white">Already a subscriber? <a className="text-white underline" href="#">Sign
        In</a></p>
</div>)
...
export const NewsletterSection2 = () => (<section className="flex flex-col items-center justify-center">
    ...
    <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-6xl max-w-md w-full">
...
export const TextOnlyTweetCard = () => (<div
    ...
    <div className="text-gray-500 text-2xl">2:30 PM · Dec 20, 2024</div>
</div>)
...
export const AboutUsSectionWithGradientBg = () => (
    <div><h1 className="text-xl font-semibold text-center mx-auto">About our apps</h1>
...
export const PrivacyFirstNotice = () => (<div
    ...
    <div className="flex items-center justify-center mt-6 gap-4 w-full">
        <button type="button"
                className="font-extrabold px-8 border border-gray-500/30 py-2 rounded hover:bg-blue-500/10 active:scale-95 transition">Decline
        </button>
        <button type="button"
...
export const SmallCtaBanner = () => (<div
    ...
    <div>
        <h1
            className="text-4xl md:text-[46px] md:leading-[60px] font-medium bg-gradient-to-r from-white to-[#CAABFF] text-transparent bg-clip-text">
