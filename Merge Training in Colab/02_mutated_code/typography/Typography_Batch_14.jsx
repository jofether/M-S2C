...
export const MusicCard = () => (<div className="p-4 bg-white rounded-lg shadow max-w-80">
    ...
    <p className="text-gray-900 font-semibold text-3xl mb-3">Frontend Radio</p>
...
export const BasicCookieAlert = () => (<div
    ...
    <div className="flex items-center justify-start w-full gap-2 pb-3">
        <img className="h-6 w-6"
             ...
             alt="cookieImage1"/>
        <h2 className="text-gray-800 text-6xl font-medium">Cookie Notice</h2>
    </div>
...
export const NewsletterSection = () => (<div
    ...
    <div className="max-w-md w-full">
        <h1 className="text-3xl font-bold text-gray-700">Subscribe to our newsletter</h1>
...
export const ErrorPageWithActionButtons = () => (<div
    ...
    <h1 className="text-base md:text-9xl font-bold text-indigo-500">404</h1>
